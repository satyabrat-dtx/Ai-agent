...
- **Source**: `DB2ADMIN_DDL.sql` line 208526
...
|---|---|---|---|---|---|
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COMPANYBRAND.OWNINGCOMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `COMPANYBRAND_BRAND` | [`DEVELOPMENTREQUEST`](../OTHER/DEVELOPMENTREQUEST.md) | `BRANDCOMPANYCODE`, `BRANDCODE` | `DEVELOPMENTREQUEST.BRANDCOMPANYCODE = COMPANYBRAND.COMPANYCODE AND DEVELOPMENTREQUEST.BRANDCODE = COMPANYBRAND.CODE` |

## Indexes

- `COMPANYBRANDUID` (ABSUNIQUEID)
