# DB2ADMIN.COUNTERSUBSERIES

- **Module**: `CORE_MASTER` (high confidence — table name starts with 'COUNTER')
- **Roles**: `business_data`
- **Columns**: 15
- **Primary key**: `COUNTERCOMPANYCODE`, `COUNTERCODE`, `CODE`
- **FK degree**: referenced by 0 constraint(s), references 2 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 23306

## Columns

| # | Column | Type | Null | Key | Tags | Meaning |
|---|--------|------|------|-----|------|---------|
| 0 | `COUNTERCOMPANYCODE` | CHAR(3) | NOT NULL | PK FK | primary_key foreign_key |  |
...
|---|---|---|---|---|---|
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COUNTERSUBSERIES.OWNINGCOMPANYCODE = COMPANY.CODE` |
| `COUNTER_SUBSERIES` | `COUNTERCOMPANYCODE`, `COUNTERCODE` | [`COUNTER`](../CORE_MASTER/COUNTER.md) | `COMPANYCODE`, `CODE` | RESTRICT | `COUNTERSUBSERIES.COUNTERCOMPANYCODE = COUNTER.COMPANYCODE AND COUNTERSUBSERIES.COUNTERCODE = COUNTER.CODE` |
...
- `COUNTERSUBSERIESUID` (ABSUNIQUEID)

## Starter query

```sql
SELECT t.COUNTERCOMPANYCODE,
       t.COUNTERCODE,
       t.CODE,
       t.LONGDESCRIPTION,
       t.SHORTDESCRIPTION,
       ...
       t.LASTUPDATEUSER,
       t.OWNINGCOMPANYCODE
FROM   DB2ADMIN.COUNTERSUBSERIES t
