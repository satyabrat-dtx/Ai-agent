# DB2ADMIN.ITEMTYPEWAREHOUSELINK
...
- **Source**: `DB2ADMIN_DDL.sql` line 122506
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `ITEMTYPEWAREHOUSELINK.COMPANYCODE = COMPANY.CODE` |
| `ITEMTYPE_ITEMTYPE` | `ITEMTYPECOMPANYCODE`, `ITEMTYPECODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `ITEMTYPEWAREHOUSELINK.ITEMTYPECOMPANYCODE = ITEMTYPE.COMPANYCODE AND ITEMTYPEWAREHOUSELINK.ITEMTYPECODE = ITEMTYPE.CODE` |
| `LOGICALWAREHOUSE_LOGICALWAREHOUSE` | `LOGICALWAREHOUSECOMPANYCODE`, `LOGICALWAREHOUSECODE` | [`LOGICALWAREHOUSE`](../WAREHOUSE/LOGICALWAREHOUSE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `ITEMTYPEWAREHOUSELINK.LOGICALWAREHOUSECOMPANYCODE = LOGICALWAREHOUSE.COMPANYCODE AND ITEMTYPEWAREHOUSELINK.LOGICALWAREHOUSECODE = LOGICALWAREHOUSE.CODE` |
...
- `ITEMTYPEWAREHOUSELINKUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.ITEMTYPEWAREHOUSELINK t
