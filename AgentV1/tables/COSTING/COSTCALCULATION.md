...
- **Source**: `DB2ADMIN_DDL.sql` line 70920
...
| 1 | `ITEMTYPECODE` | CHAR(3) |  |  |  |  |
| 2 | `BOMCOMPONENTPOLICYCODE` | CHAR(20) |  |  |  |  |
| 3 | `PLYBOMCALCULATEQTYNAME` | CHAR(100) |  |  |  |  |
...
- `COSTCALCULATIONUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       t.ITEMTYPECODE,
       t.BOMCOMPONENTPOLICYCODE,
       t.PLYBOMCALCULATEQTYNAME,
       t.ABSUNIQUEID
FROM   DB2ADMIN.COSTCALCULATION t
