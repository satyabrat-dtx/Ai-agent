...
- **Source**: `DB2ADMIN_DDL.sql` line 3177
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COSTELEMENTGROUP.COMPANYCODE = COMPANY.CODE` |
...
- `COSTELEMENTGROUPUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.COSTELEMENTGROUP t
