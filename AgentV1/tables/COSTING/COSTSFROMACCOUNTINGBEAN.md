# DB2ADMIN.COSTSFROMACCOUNTINGBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 86728
...
| 2 | `ELEMENTITEMTYPECODE` | CHAR(3) |  |  |  |  |
| 3 | `ELEMENTSUBCODE01` | CHAR(20) |  |  |  |  |
| 4 | `PERIODYEAR` | DECIMAL(4,0) |  |  |  |  |
| 5 | `PERIODCODE` | DECIMAL(3,0) |  |  |  |  |
| 6 | `ACCOUNTINGCOSTLEVEL` | CHAR(1) |  |  |  |  |
| 7 | `COMPANYACCOUNTINGLEVELCOST` | DECIMAL(15,5) |  |  |  |  |
...
| 19 | `COMPANYACCLEVELCOSTSNDCUR` | DECIMAL(15,5) |  |  |  |  |
...
- `COSTSFROMACCOUNTINGBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.IMPORTAUTOCOUNTER,
       ...
       t.IMPCREATIONUSER
FROM   DB2ADMIN.COSTSFROMACCOUNTINGBEAN t
