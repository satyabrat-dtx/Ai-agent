...
- **Source**: `DB2ADMIN_DDL.sql` line 236023
...
|---|---|---|---|
| `EIPAYMENTTYPE_EIPAYMENTTYPE` | [`PAYMENTMETHOD`](../CORE_MASTER/PAYMENTMETHOD.md) | `EIPAYMENTTYPECODE` | `PAYMENTMETHOD.EIPAYMENTTYPECODE = EIPAYMENTTYPE.CODE` |
| `EIPAYMENTTYPE_EIPAYMENTTYPE` | [`EINVOICEPAYMENTDETAIL`](../EINVOICING/EINVOICEPAYMENTDETAIL.md) | `EIPAYMENTTYPECODE` | `EINVOICEPAYMENTDETAIL.EIPAYMENTTYPECODE = EIPAYMENTTYPE.CODE` |

## Indexes

- `EIPAYMENTTYPEUID` (ABSUNIQUEID)
