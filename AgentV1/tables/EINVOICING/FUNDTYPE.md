...
- **Source**: `DB2ADMIN_DDL.sql` line 237523
...
|---|---|---|---|
| `FUNDTYPE_TYPE` | [`EINVOICEWALFAREFUNDDATA`](../EINVOICING/EINVOICEWALFAREFUNDDATA.md) | `TYPECODE` | `EINVOICEWALFAREFUNDDATA.TYPECODE = FUNDTYPE.CODE` |

## Indexes

- `FUNDTYPEUID` (ABSUNIQUEID)
