...
- **Source**: `DB2ADMIN_DDL.sql` line 236129
...
|---|---|---|---|
| `INCOTERM_INCOTERM` | [`TERMSOFDELIVERY`](../CORE_MASTER/TERMSOFDELIVERY.md) | `INCOTERMCODE` | `TERMSOFDELIVERY.INCOTERMCODE = INCOTERM.CODE` |
| `INCOTERM_INCOTERM` | [`EINVOICEBODY`](../EINVOICING/EINVOICEBODY.md) | `INCOTERMCODE` | `EINVOICEBODY.INCOTERMCODE = INCOTERM.CODE` |

## Indexes

- `INCOTERMUID` (ABSUNIQUEID)
