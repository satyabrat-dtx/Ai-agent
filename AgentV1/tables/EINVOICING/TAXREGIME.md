...
- **Source**: `DB2ADMIN_DDL.sql` line 237644
...
|---|---|---|---|
| `TAXREGIME_TAXREGIME` | [`ORDERPARTNER`](../CORE_MASTER/ORDERPARTNER.md) | `TAXREGIMECODE` | `ORDERPARTNER.TAXREGIMECODE = TAXREGIME.CODE` |
| `TAXREGIME_TAXREGIME` | [`EINVOICECUSTOMIZEDOPTIONS`](../EINVOICING/EINVOICECUSTOMIZEDOPTIONS.md) | `TAXREGIMECODE` | `EINVOICECUSTOMIZEDOPTIONS.TAXREGIMECODE = TAXREGIME.CODE` |
| `TAXREGIME_SENDERTAXREGIME` | [`EINVOICEHEADER`](../EINVOICING/EINVOICEHEADER.md) | `SENDERTAXREGIMECODE` | `EINVOICEHEADER.SENDERTAXREGIMECODE = TAXREGIME.CODE` |

## Indexes

- `TAXREGIMEUID` (ABSUNIQUEID)
