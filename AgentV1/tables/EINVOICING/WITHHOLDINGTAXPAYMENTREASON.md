# DB2ADMIN.WITHHOLDINGTAXPAYMENTREASON
...
- **Source**: `DB2ADMIN_DDL.sql` line 237684
...
|---|---|---|---|
| `WITHHOLDINGTAXPAYMENTREASON_PAYMENTREASON` | [`EINVOICEWITHHOLDINGTAX`](../EINVOICING/EINVOICEWITHHOLDINGTAX.md) | `PAYMENTREASONCODE` | `EINVOICEWITHHOLDINGTAX.PAYMENTREASONCODE = WITHHOLDINGTAXPAYMENTREASON.CODE` |

## Indexes

- `WITHHOLDINGTAXPAYMENTREAUID` (ABSUNIQUEID)
...
SELECT t.CODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.WITHHOLDINGTAXPAYMENTREASON t
