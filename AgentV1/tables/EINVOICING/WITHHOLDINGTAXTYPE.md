...
- **Source**: `DB2ADMIN_DDL.sql` line 237724
...
|---|---|---|---|
| `WITHHOLDINGTAXTYPE_TYPE` | [`EINVOICEWITHHOLDINGTAX`](../EINVOICING/EINVOICEWITHHOLDINGTAX.md) | `TYPECODE` | `EINVOICEWITHHOLDINGTAX.TYPECODE = WITHHOLDINGTAXTYPE.CODE` |

## Indexes

- `WITHHOLDINGTAXTYPEUID` (ABSUNIQUEID)
...
SELECT t.CODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.WITHHOLDINGTAXTYPE t
