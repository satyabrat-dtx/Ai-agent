...
- **Source**: `DB2ADMIN_DDL.sql` line 101249
...
|---|---|---|---|
| `FINALLOCTEMPLATE_ALLOCATIONTEMPLATE` | [`FINALLOCATION`](../FINANCE/FINALLOCATION.md) | `ALLOCATIONTEMPLATECODE` | `FINALLOCATION.ALLOCATIONTEMPLATECODE = FINALLOCTEMPLATE.CODE` |

## Indexes

- `FINALLOCTEMPLATEUID` (ABSUNIQUEID)
...
SELECT t.CODE,
       ...
       t.LASTUPDATEUSER,
       t.ABSUNIQUEID
FROM   DB2ADMIN.FINALLOCTEMPLATE t
