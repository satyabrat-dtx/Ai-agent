# DB2ADMIN.FINANCIALACCOUNTINGTYPE
...
- **Source**: `DB2ADMIN_DDL.sql` line 16414
...
| 4 | `ACCOUNTINGCODEPOLICYCODE` | CHAR(20) |  |  |  |  |
| 5 | `ACCOUNTTRANSACTIONPOLICYCODE` | CHAR(20) |  |  |  |  |
...
| 13 | `VATPLAFONDDECLARATIONPOLICYCOD` | CHAR(20) |  |  |  |  |
...
|---|---|---|---|
| `FINANCIALACCOUNTINGTYPE_FINANCIALACCOUNTINGTYPE` | [`BASECUSTOMIZEDOPTIONS`](../FINANCE/BASECUSTOMIZEDOPTIONS.md) | `FINANCIALACCOUNTINGTYPECODE` | `BASECUSTOMIZEDOPTIONS.FINANCIALACCOUNTINGTYPECODE = FINANCIALACCOUNTINGTYPE.CODE` |

## Indexes

- `FINANCIALACCOUNTINGTYPEUID` (ABSUNIQUEID)
...
SELECT t.CODE,
       ...
       t.SHORTDESCRIPTION,
       t.SEARCHDESCRIPTION,
       t.ACCOUNTINGCODEPOLICYCODE,
       t.ACCOUNTTRANSACTIONPOLICYCODE,
       t.CREATIONDATETIME,
       t.CREATIONUSER,
...
FROM   DB2ADMIN.FINANCIALACCOUNTINGTYPE t
