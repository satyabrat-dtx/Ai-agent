# DB2ADMIN.FINBANKCHARGES

- **Module**: `FINANCE` (high confidence — table name starts with 'FIN')
- **Roles**: `business_data`
- **Columns**: 74
- **Primary key**: `COMPANYCODE`, `TYPE`, `BANKCODECODE`, `FROMDATE`
- **FK degree**: referenced by 0 constraint(s), references 4 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 177926
...
| 2 | `BANKCODECOMPANYCODE` | CHAR(3) | NOT NULL | FK | foreign_key |  |
| 3 | `BANKCODECODE` | CHAR(20) | NOT NULL | PK FK | primary_key foreign_key |  |
...
| 28 | `NEGBANKCOMPANYCODE` | CHAR(3) |  | FK | foreign_key |  |
| 29 | `NEGBANKCODE` | CHAR(20) |  | FK | foreign_key |  |
...
| 57 | `COLBANKCODECOMPANYCODE` | CHAR(3) |  | FK | foreign_key |  |
| 58 | `COLBANKCODECODE` | CHAR(20) |  | FK | foreign_key |  |
| 59 | `COLFROMDATE` | DATE |  |  |  |  |
| 60 | `COLTODATE` | DATE |  |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `FINBANKCHARGES.COMPANYCODE = COMPANY.CODE` |
| `GLMASTER_BANKCODE` | `BANKCODECOMPANYCODE`, `BANKCODECODE` | [`GLMASTER`](../CORE_MASTER/GLMASTER.md) | `COMPANYCODE`, `CODE` | RESTRICT | `FINBANKCHARGES.BANKCODECOMPANYCODE = GLMASTER.COMPANYCODE AND FINBANKCHARGES.BANKCODECODE = GLMASTER.CODE` |
| `GLMASTER_COLBANKCODE` | `COLBANKCODECOMPANYCODE`, `COLBANKCODECODE` | [`GLMASTER`](../CORE_MASTER/GLMASTER.md) | `COMPANYCODE`, `CODE` | RESTRICT | `FINBANKCHARGES.COLBANKCODECOMPANYCODE = GLMASTER.COMPANYCODE AND FINBANKCHARGES.COLBANKCODECODE = GLMASTER.CODE` |
| `GLMASTER_NEGBANK` | `NEGBANKCOMPANYCODE`, `NEGBANKCODE` | [`GLMASTER`](../CORE_MASTER/GLMASTER.md) | `COMPANYCODE`, `CODE` | RESTRICT | `FINBANKCHARGES.NEGBANKCOMPANYCODE = GLMASTER.COMPANYCODE AND FINBANKCHARGES.NEGBANKCODE = GLMASTER.CODE` |
...
SELECT t.COMPANYCODE,
       ...
       t.IMPOTHERCHARGES
FROM   DB2ADMIN.FINBANKCHARGES t
