...
- **Source**: `DB2ADMIN_DDL.sql` line 222957
...
| 1 | `UNIQUEID` | DECIMAL(10,0) | NOT NULL |  |  |  |
...
- `FINCUSTOMCOUNTERUID` (ABSUNIQUEID)
...
SELECT t.COUNTERKEY,
       t.UNIQUEID,
       t.ABSUNIQUEID
FROM   DB2ADMIN.FINCUSTOMCOUNTER t
