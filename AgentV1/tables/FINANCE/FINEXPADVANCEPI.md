# DB2ADMIN.FINEXPADVANCEPI

- **Module**: `FINANCE` (high confidence — table name starts with 'FIN')
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `FINEXPADVANCECOMPANYCODE`, `FINEXPADVANCECODE`, `PIPROVISIONALCOUNTERCODE`, `PIPROVISIONALCODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 201637
...
| 2 | `PIPROVISIONALCOUNTERCODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
| 3 | `PIPROVISIONALCODE` | CHAR(15) | NOT NULL | PK | primary_key |  |
...
|---|---|---|---|---|---|
| `FINEXPADVANCE_LINE` | `FINEXPADVANCECOMPANYCODE`, `FINEXPADVANCECODE` | [`FINEXPADVANCE`](../FINANCE/FINEXPADVANCE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `FINEXPADVANCEPI.FINEXPADVANCECOMPANYCODE = FINEXPADVANCE.COMPANYCODE AND FINEXPADVANCEPI.FINEXPADVANCECODE = FINEXPADVANCE.CODE` |
...
- `FINEXPADVANCEPIUID` (ABSUNIQUEID)
...
SELECT t.FINEXPADVANCECOMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.FINEXPADVANCEPI t
