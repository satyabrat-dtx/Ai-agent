# DB2ADMIN.FINEXPREALISATIONPCDETAIL

- **Module**: `FINANCE` (high confidence — table name starts with 'FIN')
- **Roles**: `business_data`
- **Columns**: 12
- **Primary key**: `FINEXPREALISATIONCOMPANYCODE`, `FINEXPREALISATIONCODE`, `PACKINGCREDITLETTERNO`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 223623
...
| 2 | `PACKINGCREDITLETTERNO` | CHAR(5) | NOT NULL | PK | primary_key |  |
...
|---|---|---|---|---|---|
| `FINEXPREALISATION_FINEXPREALISATIONPCDETAIL` | `FINEXPREALISATIONCOMPANYCODE`, `FINEXPREALISATIONCODE` | [`FINEXPREALISATION`](../FINANCE/FINEXPREALISATION.md) | `COMPANYCODE`, `CODE` | RESTRICT | `FINEXPREALISATIONPCDETAIL.FINEXPREALISATIONCOMPANYCODE = FINEXPREALISATION.COMPANYCODE AND FINEXPREALISATIONPCDETAIL.FINEXPREALISATIONCODE = FINEXPREALISATION.CODE` |
...
- `FINEXPREALISATIONPCDETAILUID` (ABSUNIQUEID)
...
SELECT t.FINEXPREALISATIONCOMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.FINEXPREALISATIONPCDETAIL t
