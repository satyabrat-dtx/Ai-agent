...
- **Source**: `DB2ADMIN_DDL.sql` line 175523
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `FINITFINANCIALYEAR.COMPANYCODE = COMPANY.CODE` |
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `FINITFINANCIALYEAR.OWNINGCOMPANYCODE = COMPANY.CODE` |
...
- `FINITFINANCIALYEARUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.LASTUPDATEUSER
FROM   DB2ADMIN.FINITFINANCIALYEAR t
