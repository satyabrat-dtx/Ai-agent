# DB2ADMIN.FINPREMIUMRATEMASTER

- **Module**: `FINANCE` (high confidence — table name starts with 'FIN')
- **Roles**: `business_data`
- **Columns**: 16
- **Primary key**: `COMPANYCODE`, `EMPLOYEETYPE`, `RISKTYPE`, `TABLETYPE`, `FROMDATE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 229455
...
| 1 | `EMPLOYEETYPE` | CHAR(6) | NOT NULL | PK | primary_key |  |
| 2 | `RISKTYPE` | CHAR(3) | NOT NULL | PK | primary_key |  |
| 3 | `TABLETYPE` | CHAR(3) | NOT NULL | PK | primary_key |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `FINPREMIUMRATEMASTER.COMPANYCODE = COMPANY.CODE` |
...
- `FINPREMIUMRATEMASTERUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.FINPREMIUMRATEMASTER t
