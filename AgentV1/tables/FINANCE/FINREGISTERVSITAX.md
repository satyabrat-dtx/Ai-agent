# DB2ADMIN.FINREGISTERVSITAX

- **Module**: `FINANCE` (high confidence — table name starts with 'FIN')
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `COMPANYCODE`, `REPORTNAME`, `ITAXCODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 178032
...
| 1 | `REPORTNAME` | CHAR(2) | NOT NULL | PK | primary_key |  |
| 2 | `SEQUENCENUMBER` | DECIMAL(3,0) |  |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `FINREGISTERVSITAX.COMPANYCODE = COMPANY.CODE` |
...
- `FINREGISTERVSITAXUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.FINREGISTERVSITAX t
