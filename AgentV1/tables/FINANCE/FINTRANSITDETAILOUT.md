...
- **Source**: `DB2ADMIN_DDL.sql` line 225892
...
- `FINTRANSITDETAILOUTUID` (ABSUNIQUEID)
...
SELECT t.FINPOLICYMASTERCOMPANYCODE,
       ...
       t.TODATE,
       t.AMOUNT
FROM   DB2ADMIN.FINTRANSITDETAILOUT t
