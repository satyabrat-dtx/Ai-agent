# DB2ADMIN.FINTRANSLATIONEXCHANGERATE
...
- **Source**: `DB2ADMIN_DDL.sql` line 175665
...
|---|---|---|---|---|---|
| `CURRENCY_CURRENCY` | `CURRENCYCODE` | [`CURRENCY`](../CORE_MASTER/CURRENCY.md) | `CODE` | RESTRICT | `FINTRANSLATIONEXCHANGERATE.CURRENCYCODE = CURRENCY.CODE` |
| `CURRENCY_REFERENCEDCURRENCY` | `REFERENCEDCURRENCYCODE` | [`CURRENCY`](../CORE_MASTER/CURRENCY.md) | `CODE` | RESTRICT | `FINTRANSLATIONEXCHANGERATE.REFERENCEDCURRENCYCODE = CURRENCY.CODE` |
...
- `FINTRANSLATIONEXCHANGERATEUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.FINTRANSLATIONEXCHANGERATE t
