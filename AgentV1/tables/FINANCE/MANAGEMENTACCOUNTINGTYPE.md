# DB2ADMIN.MANAGEMENTACCOUNTINGTYPE
...
- **Source**: `DB2ADMIN_DDL.sql` line 924
...
|---|---|---|---|
| `MANAGEMENTACCOUNTINGTYPE_MANAGEMENTACCOUNTINGTYPE` | [`BASECUSTOMIZEDOPTIONS`](../FINANCE/BASECUSTOMIZEDOPTIONS.md) | `MANAGEMENTACCOUNTINGTYPECODE` | `BASECUSTOMIZEDOPTIONS.MANAGEMENTACCOUNTINGTYPECODE = MANAGEMENTACCOUNTINGTYPE.CODE` |

## Indexes

- `MANAGEMENTACCOUNTINGTYPEUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.MANAGEMENTACCOUNTINGTYPE t
