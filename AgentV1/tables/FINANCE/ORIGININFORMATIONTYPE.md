# DB2ADMIN.ORIGININFORMATIONTYPE
...
- **Source**: `DB2ADMIN_DDL.sql` line 20647
...
|---|---|---|---|
| `ORIGININFORMATIONTYPE_ORIGININFORMATIONTYPE` | [`BUSINESSPARTNER`](../FINANCE/BUSINESSPARTNER.md) | `ORIGININFORMATIONTYPECODE` | `BUSINESSPARTNER.ORIGININFORMATIONTYPECODE = ORIGININFORMATIONTYPE.CODE` |

## Indexes

- `ORIGININFORMATIONTYPEUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.ORIGININFORMATIONTYPE t
