...
- **Source**: `DB2ADMIN_DDL.sql` line 94067
...
|---|---|---|---|
| `SYSTEMTABLE_RECORDS` | [`SYSTEMTABLERECORDS`](../FINANCE/SYSTEMTABLERECORDS.md) | `SYSTEMTABLECODE` | `SYSTEMTABLERECORDS.SYSTEMTABLECODE = SYSTEMTABLE.CODE` |

## Indexes

- `SYSTEMTABLEUID` (ABSUNIQUEID)
