...
- **Source**: `DB2ADMIN_DDL.sql` line 128979
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `ECCTYPE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `ECCTYPE_ECCTYPE` | [`ORDERPARTNERIE`](../HR/ORDERPARTNERIE.md) | `CUSTOMERSUPPLIERCOMPANYCODE`, `ECCTYPECODE` | `ORDERPARTNERIE.CUSTOMERSUPPLIERCOMPANYCODE = ECCTYPE.COMPANYCODE AND ORDERPARTNERIE.ECCTYPECODE = ECCTYPE.CODE` |

## Indexes

- `ECCTYPEUID` (ABSUNIQUEID)
