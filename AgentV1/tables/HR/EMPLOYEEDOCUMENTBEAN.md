...
- **Source**: `DB2ADMIN_DDL.sql` line 172073
...
| 3 | `DOCUMENTTYPEICSTABLECODE` | CHAR(4) |  |  |  |  |
| 4 | `DOCUMENTTYPECODE` | CHAR(6) |  |  |  |  |
| 5 | `DOCUMENTNO` | CHAR(15) |  |  |  |  |
| 6 | `COUNTRYICSTABLECODE` | CHAR(4) |  |  |  |  |
| 7 | `COUNTRYCODE` | CHAR(6) |  |  |  |  |
| 8 | `STATECODE` | CHAR(3) |  |  |  |  |
| 9 | `DISTRICTDISTRICTCODE` | CHAR(3) |  |  |  |  |
| 10 | `DOCUMENTISSUEPLACEICSTABLECODE` | CHAR(4) |  |  |  |  |
| 11 | `DOCUMENTISSUEPLACECODE` | CHAR(6) |  |  |  |  |
| 12 | `DOCUMENTISSUEDATE` | DATE |  |  |  |  |
| 13 | `DOCUMENTEXPIRYDATE` | DATE |  |  |  |  |
| 14 | `DOCUMENTSUBMISSIONDATE` | DATE |  |  |  |  |
...
- `EMPLOYEEDOCUMENTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.EMPLOYEEDOCUMENTBEAN t
