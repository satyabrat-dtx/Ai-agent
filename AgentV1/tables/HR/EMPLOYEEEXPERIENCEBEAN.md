# DB2ADMIN.EMPLOYEEEXPERIENCEBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 172194
...
| 5 | `COUNTRYICSTABLECODE` | CHAR(4) |  |  |  |  |
| 6 | `COUNTRYCODE` | CHAR(6) |  |  |  |  |
| 7 | `STATECODE` | CHAR(3) |  |  |  |  |
| 8 | `DISTRICTDISTRICTCODE` | CHAR(3) |  |  |  |  |
| 9 | `LOCATIONCODE` | CHAR(3) |  |  |  |  |
| 10 | `WORKEDFROM` | DATE |  |  |  |  |
| 11 | `WORKEDUNTIL` | DATE |  |  |  |  |
| 12 | `WORKEDASICSTABLECODE` | CHAR(4) |  |  |  |  |
| 13 | `WORKEDASCODE` | CHAR(6) |  |  |  |  |
| 14 | `CTC` | DECIMAL(11,2) |  |  |  |  |
...
- `EMPLOYEEEXPERIENCEBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.IMPORTAUTOCOUNTER,
       ...
       t.WORKEDFROM,
       t.WORKEDUNTIL
FROM   DB2ADMIN.EMPLOYEEEXPERIENCEBEAN t
