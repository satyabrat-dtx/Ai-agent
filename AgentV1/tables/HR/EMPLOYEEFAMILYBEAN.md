...
- **Source**: `DB2ADMIN_DDL.sql` line 172254
...
| 3 | `RELATIONTYPEICSTABLECODE` | CHAR(4) |  |  |  |  |
| 4 | `RELATIONTYPECODE` | CHAR(6) |  |  |  |  |
| 5 | `RELATIVESLONGNAME` | CHAR(160) |  |  |  |  |
| 6 | `RELATIVESSHORTNAME` | CHAR(160) |  |  |  |  |
| 7 | `RELATIVESDATEOFBIRTH` | DATE |  |  |  |  |
| 8 | `RELATIVESOCCUPATIONICSTBCODE` | CHAR(4) |  |  |  |  |
| 9 | `RELATIVESOCCUPATIONCODE` | CHAR(6) |  |  |  |  |
| 10 | `DEPENDENCY` | INTEGER | NOT NULL |  |  |  |
| 11 | `RELATIVEEMLOYEEIDCODE` | CHAR(9) |  |  |  |  |
...
- `EMPLOYEEFAMILYBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.EMPLOYEEFAMILYBEAN t
