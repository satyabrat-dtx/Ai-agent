...
- **Source**: `DB2ADMIN_DDL.sql` line 152401
...
- `EMPLOYEEFINGERPRINTUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.EMPLOYEEFINGERPRINT t
