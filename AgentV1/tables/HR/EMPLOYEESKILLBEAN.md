...
- **Source**: `DB2ADMIN_DDL.sql` line 172779
...
| 3 | `SKILLIDICSTABLECODE` | CHAR(4) |  |  |  |  |
| 4 | `SKILLIDCODE` | CHAR(6) |  |  |  |  |
| 5 | `FROMDATE` | DATE |  |  |  | Inclusive start of a validity period. |
| 6 | `EXPERIENCEINYEARS` | DECIMAL(5,2) |  |  |  |  |
| 7 | `SKILLLASTUSEDYEAR` | DECIMAL(5,0) |  |  |  |  |
...
- `EMPLOYEESKILLBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.IMPORTAUTOCOUNTER,
       ...
       t.IMPOPERATIONUSER,
       t.IMPORTSTATUS
FROM   DB2ADMIN.EMPLOYEESKILLBEAN t
