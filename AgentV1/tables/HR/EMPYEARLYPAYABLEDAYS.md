# DB2ADMIN.EMPYEARLYPAYABLEDAYS

- **Module**: `HR` (medium confidence — table name starts with 'EMP')
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `COMPANYCODE`, `EMPLOYEECODE`, `ATTENDANCEYEAR`
- **FK degree**: referenced by 0 constraint(s), references 2 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 165970
...
| 2 | `ATTENDANCEYEAR` | CHAR(4) | NOT NULL | PK | primary_key |  |
| 3 | `TOTALPAYABLEDAYS` | DECIMAL(9,5) |  |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `EMPYEARLYPAYABLEDAYS.COMPANYCODE = COMPANY.CODE` |
| `EMPLOYEE_EMPLOYEE` | `COMPANYCODE`, `EMPLOYEECODE` | [`EMPLOYEE`](../HR/EMPLOYEE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `EMPYEARLYPAYABLEDAYS.COMPANYCODE = EMPLOYEE.COMPANYCODE AND EMPYEARLYPAYABLEDAYS.EMPLOYEECODE = EMPLOYEE.CODE` |
...
- `EMPYEARLYPAYABLEDAYSUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.EMPYEARLYPAYABLEDAYS t
