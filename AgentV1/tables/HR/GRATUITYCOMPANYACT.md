...
- **Source**: `DB2ADMIN_DDL.sql` line 166392
...
| 5 | `RETRENCHMENTYEAR` | DECIMAL(5,0) |  |  |  |  |
| 6 | `RETRENCHMENTAMT` | DECIMAL(9,2) |  |  |  |  |
| 7 | `MODEOFPAYMENT` | CHAR(1) |  |  |  |  |
| 8 | `RECORDSTATUS` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `GRATUITYCOMPANYACT.COMPANYCODE = COMPANY.CODE` |
| `EMPLOYEE_EMPLOYEEID` | `COMPANYCODE`, `EMPLOYEEIDCODE` | [`EMPLOYEE`](../HR/EMPLOYEE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `GRATUITYCOMPANYACT.COMPANYCODE = EMPLOYEE.COMPANYCODE AND GRATUITYCOMPANYACT.EMPLOYEEIDCODE = EMPLOYEE.CODE` |
...
- `GRATUITYCOMPANYACTUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.GRATUITYCOMPANYACT t
