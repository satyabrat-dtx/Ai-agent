...
- **Source**: `DB2ADMIN_DDL.sql` line 159660
...
|---|---|---|---|---|---|
| `APPLICANTSDETAILS_APPLNO` | `COMPANYCODE`, `APPLNOCODE` | [`APPLICANTSDETAILS`](../HR/APPLICANTSDETAILS.md) | `COMPANYCODE`, `CODE` | RESTRICT | `RECRUITHRD.COMPANYCODE = APPLICANTSDETAILS.COMPANYCODE AND RECRUITHRD.APPLNOCODE = APPLICANTSDETAILS.CODE` |
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `RECRUITHRD.COMPANYCODE = COMPANY.CODE` |
