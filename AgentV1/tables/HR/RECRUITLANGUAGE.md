# DB2ADMIN.RECRUITLANGUAGE

- **Module**: `HR` (high confidence — table name starts with 'RECRUIT')
- **Roles**: `business_data`
- **Columns**: 15
- **Primary key**: `COMPANYCODE`, `APPLNOCODE`, `LANGUAGEICSTABLECODE`, `LANGUAGECODE`
- **FK degree**: referenced by 0 constraint(s), references 3 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 159755
...
|---|---|---|---|---|---|
| `APPLICANTSDETAILS_APPLNO` | `COMPANYCODE`, `APPLNOCODE` | [`APPLICANTSDETAILS`](../HR/APPLICANTSDETAILS.md) | `COMPANYCODE`, `CODE` | RESTRICT | `RECRUITLANGUAGE.COMPANYCODE = APPLICANTSDETAILS.COMPANYCODE AND RECRUITLANGUAGE.APPLNOCODE = APPLICANTSDETAILS.CODE` |
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `RECRUITLANGUAGE.COMPANYCODE = COMPANY.CODE` |
| `ICSENTITY_LANGUAGE` | `COMPANYCODE`, `LANGUAGEICSTABLECODE`, `LANGUAGECODE` | [`ICSENTITY`](../CORE_MASTER/ICSENTITY.md) | `COMPANYCODE`, `ICSTABLECODE`, `CODE` | RESTRICT | `RECRUITLANGUAGE.COMPANYCODE = ICSENTITY.COMPANYCODE AND RECRUITLANGUAGE.LANGUAGEICSTABLECODE = ICSENTITY.ICSTABLECODE AND RECRUITLANGUAGE.LANGUAGECODE = ICSENTITY.CODE` |
...
- `RECRUITLANGUAGEUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.LASTUPDATEUSER
FROM   DB2ADMIN.RECRUITLANGUAGE t
