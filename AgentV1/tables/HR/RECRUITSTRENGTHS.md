...
- **Source**: `DB2ADMIN_DDL.sql` line 160167
...
|---|---|---|---|---|---|
| `APPLICANTSDETAILS_APPLICANTNO` | `COMPANYCODE`, `APPLICANTNOCODE` | [`APPLICANTSDETAILS`](../HR/APPLICANTSDETAILS.md) | `COMPANYCODE`, `CODE` | RESTRICT | `RECRUITSTRENGTHS.COMPANYCODE = APPLICANTSDETAILS.COMPANYCODE AND RECRUITSTRENGTHS.APPLICANTNOCODE = APPLICANTSDETAILS.CODE` |
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `RECRUITSTRENGTHS.COMPANYCODE = COMPANY.CODE` |
| `ICSENTITY_STR` | `COMPANYCODE`, `STRICSTABLECODE`, `STRCODE` | [`ICSENTITY`](../CORE_MASTER/ICSENTITY.md) | `COMPANYCODE`, `ICSTABLECODE`, `CODE` | RESTRICT | `RECRUITSTRENGTHS.COMPANYCODE = ICSENTITY.COMPANYCODE AND RECRUITSTRENGTHS.STRICSTABLECODE = ICSENTITY.ICSTABLECODE AND RECRUITSTRENGTHS.STRCODE = ICSENTITY.CODE` |
...
- `RECRUITSTRENGTHSUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.RECRUITSTRENGTHS t
