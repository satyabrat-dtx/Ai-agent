...
- **Source**: `DB2ADMIN_DDL.sql` line 160309
...
|---|---|---|---|---|---|
| `APPLICANTSDETAILS_APPLICANTNO` | `COMPANYCODE`, `APPLICANTNOCODE` | [`APPLICANTSDETAILS`](../HR/APPLICANTSDETAILS.md) | `COMPANYCODE`, `CODE` | RESTRICT | `RECRUITTRAININGNEED.COMPANYCODE = APPLICANTSDETAILS.COMPANYCODE AND RECRUITTRAININGNEED.APPLICANTNOCODE = APPLICANTSDETAILS.CODE` |
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `RECRUITTRAININGNEED.COMPANYCODE = COMPANY.CODE` |
| `ICSENTITY_STR` | `COMPANYCODE`, `STRICSTABLECODE`, `STRCODE` | [`ICSENTITY`](../CORE_MASTER/ICSENTITY.md) | `COMPANYCODE`, `ICSTABLECODE`, `CODE` | RESTRICT | `RECRUITTRAININGNEED.COMPANYCODE = ICSENTITY.COMPANYCODE AND RECRUITTRAININGNEED.STRICSTABLECODE = ICSENTITY.ICSTABLECODE AND RECRUITTRAININGNEED.STRCODE = ICSENTITY.CODE` |
...
- `RECRUITTRAININGNEEDUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.RECRUITTRAININGNEED t
