...
- **Source**: `DB2ADMIN_DDL.sql` line 155926
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `REIMBURSEMENTTYPE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `REIMBURSEMENTTYPE_REIMBURSEMENTTYPE` | [`REIMBURSEMENTBALANCE`](../HR/REIMBURSEMENTBALANCE.md) | `COMPANYCODE`, `REIMBURSEMENTTYPECODE` | `REIMBURSEMENTBALANCE.COMPANYCODE = REIMBURSEMENTTYPE.COMPANYCODE AND REIMBURSEMENTBALANCE.REIMBURSEMENTTYPECODE = REIMBURSEMENTTYPE.CODE` |
| `REIMBURSEMENTTYPE_REIMBURSEMENTTYPE` | [`REIMBURSEMENTGRPDETAIL`](../HR/REIMBURSEMENTGRPDETAIL.md) | `REGRPHEADERCOMPANYCODE`, `REIMBURSEMENTTYPECODE` | `REIMBURSEMENTGRPDETAIL.REGRPHEADERCOMPANYCODE = REIMBURSEMENTTYPE.COMPANYCODE AND REIMBURSEMENTGRPDETAIL.REIMBURSEMENTTYPECODE = REIMBURSEMENTTYPE.CODE` |

## Indexes

- `REIMBURSEMENTTYPEUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.REIMBURSEMENTTYPE t
