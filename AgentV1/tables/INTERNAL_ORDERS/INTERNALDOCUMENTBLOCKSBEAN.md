# DB2ADMIN.INTERNALDOCUMENTBLOCKSBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 66858
...
- `FATHERID` → **INTERNALDOCUMENT**.`ABSUNIQUEID` (high confidence — name = 'INTERNALDOCUMENT' + known child suffix 'BLOCKS')
  - JOIN predicate: `INTERNALDOCUMENTBLOCKSBEAN.FATHERID = INTERNALDOCUMENT.ABSUNIQUEID`

## Indexes

- `INTERNALDOCUMENTBLOCKSBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.FATHERID,
       ...
       t.UNBLOCKINGTYPE
FROM   DB2ADMIN.INTERNALDOCUMENTBLOCKSBEAN t
