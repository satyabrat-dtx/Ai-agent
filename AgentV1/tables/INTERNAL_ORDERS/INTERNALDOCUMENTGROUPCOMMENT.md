# DB2ADMIN.INTERNALDOCUMENTGROUPCOMMENT

- **Module**: `INTERNAL_ORDERS` (high confidence — table name starts with 'INTERNAL')
- **Roles**: `business_data`
- **Columns**: 20
- **Primary key**: `INTERNALDOCUMENTCOMPANYCODE`, `INTDOCPROVISIONALCOUNTERCODE`, `INTDOCUMENTPROVISIONALCODE`, `LINEGROUP`, `ORIGIN`, `CODE`, `COUNTERCODE`, `PROVENIENCECODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 19182
...
- `INTDOCUMENTGROUPCOMMENTUID` (ABSUNIQUEID)
...
SELECT t.INTERNALDOCUMENTCOMPANYCODE,
       ...
       t.COMMENTTYPE,
       t.CANCELED
FROM   DB2ADMIN.INTERNALDOCUMENTGROUPCOMMENT t
