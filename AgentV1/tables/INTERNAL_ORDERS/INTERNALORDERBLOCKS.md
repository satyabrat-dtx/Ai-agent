# DB2ADMIN.INTERNALORDERBLOCKS

- **Module**: `INTERNAL_ORDERS` (high confidence — table name starts with 'INTERNAL')
- **Roles**: `business_data`
- **Columns**: 26
- **Primary key**: `INTERNALORDERCOMPANYCODE`, `INTERNALORDERCOUNTERCODE`, `INTERNALORDERCODE`, `BLOCKSORDERTYPE`, `BLOCKSCODE`, `APPLICATIONDOCUMENTTYPE`, `APPLICATIONDOCUMENTACTIONCODE`
- **FK degree**: referenced by 0 constraint(s), references 4 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 1123
...
|---|---|---|---|---|---|
| `BLOCKS_BLOCKS` | `INTERNALORDERCOMPANYCODE`, `BLOCKSORDERTYPE`, `BLOCKSCODE` | [`BLOCKS`](../CORE_MASTER/BLOCKS.md) | `COMPANYCODE`, `ORDERTYPE`, `CODE` | RESTRICT | `INTERNALORDERBLOCKS.INTERNALORDERCOMPANYCODE = BLOCKS.COMPANYCODE AND INTERNALORDERBLOCKS.BLOCKSORDERTYPE = BLOCKS.ORDERTYPE AND INTERNALORDERBLOCKS.BLOCKSCODE = BLOCKS.CODE` |
| `DOCUMENTTYPE_APPLICATIONDOCUMENT` | `BLOCKSORDERTYPE`, `APPLICATIONDOCUMENTTYPE` | [`DOCUMENTTYPE`](../CORE_MASTER/DOCUMENTTYPE.md) | `ORDERTYPE`, `TYPE` | RESTRICT | `INTERNALORDERBLOCKS.BLOCKSORDERTYPE = DOCUMENTTYPE.ORDERTYPE AND INTERNALORDERBLOCKS.APPLICATIONDOCUMENTTYPE = DOCUMENTTYPE.TYPE` |
| `INTERNALORDER_BLOCK` | `INTERNALORDERCOMPANYCODE`, `INTERNALORDERCOUNTERCODE`, `INTERNALORDERCODE` | [`INTERNALORDER`](../INTERNAL_ORDERS/INTERNALORDER.md) | `COMPANYCODE`, `COUNTERCODE`, `CODE` | RESTRICT | `INTERNALORDERBLOCKS.INTERNALORDERCOMPANYCODE = INTERNALORDER.COMPANYCODE AND INTERNALORDERBLOCKS.INTERNALORDERCOUNTERCODE = INTERNALORDER.COUNTERCODE AND INTERNALORDERBLOCKS.INTERNALORDERCODE = INTERNALORDER.CODE` |
| `LOGREASON_LOGREASON` | `INTERNALORDERCOMPANYCODE`, `LOGREASONCODE` | [`LOGREASON`](../LOGISTICS/LOGREASON.md) | `COMPANYCODE`, `CODE` | RESTRICT | `INTERNALORDERBLOCKS.INTERNALORDERCOMPANYCODE = LOGREASON.COMPANYCODE AND INTERNALORDERBLOCKS.LOGREASONCODE = LOGREASON.CODE` |
...
- `INTERNALORDERBLOCKSUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.INTERNALORDERBLOCKS t
