# DB2ADMIN.INTRACOMBNOMENCLATUREEXP

- **Module**: `INTRASTAT` (medium confidence — table name starts with 'INTRACOM')
- **Roles**: `business_data`
- **Columns**: 8
- **Primary key**: `ENVIRONMENTCODE`, `EXPCODE`, `UNIQUEIDPK`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 76737
...
| 1 | `EXPCODE` | CHAR(11) | NOT NULL | PK | primary_key |  |
...
- `INTRACOMBNOMENCLATUREEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.INTRACOMBNOMENCLATUREEXP t
