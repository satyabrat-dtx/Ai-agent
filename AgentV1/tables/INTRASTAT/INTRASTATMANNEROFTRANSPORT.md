# DB2ADMIN.INTRASTATMANNEROFTRANSPORT
...
- **Source**: `DB2ADMIN_DDL.sql` line 7648
...
|---|---|---|---|
| `INTRASTATMANNEROFTRANSPORT_INTRASTATMANNEROFTRANSPORT` | [`TERMSOFSHIPPING`](../CORE_MASTER/TERMSOFSHIPPING.md) | `INTRASTATMANNEROFTRANSPORTCODE` | `TERMSOFSHIPPING.INTRASTATMANNEROFTRANSPORTCODE = INTRASTATMANNEROFTRANSPORT.CODE` |
| `INTRASTATMANNEROFTRANSPORT_TRANSPORTMODEINTRACEE` | [`INTRASTATTRANSACTIONS`](../INTRASTAT/INTRASTATTRANSACTIONS.md) | `TRANSPORTMODEINTRACEECODE` | `INTRASTATTRANSACTIONS.TRANSPORTMODEINTRACEECODE = INTRASTATMANNEROFTRANSPORT.CODE` |
| `INTRASTATMANNEROFTRANSPORT_TRANSPORTMODE` | [`INTRASTATDECLARATIONROW`](../INTRASTAT/INTRASTATDECLARATIONROW.md) | `TRANSPORTMODECODE` | `INTRASTATDECLARATIONROW.TRANSPORTMODECODE = INTRASTATMANNEROFTRANSPORT.CODE` |

## Indexes

- `INTRASTATMANNEROFTRANSPORTUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.INTRASTATMANNEROFTRANSPORT t
