# DB2ADMIN.EXTERNALOPERATIONTEMPLATEIE
...
- **Source**: `DB2ADMIN_DDL.sql` line 182003
...
| 12 | `INTRACOMPANYJOBWORKFLAG` | SMALLINT | NOT NULL |  |  |  |
| 13 | `RECEIVINGSTOCKTRNTMPCMYCODE` | CHAR(3) |  | FK | foreign_key |  |
| 14 | `RECEIVINGSTOCKTRNTEMPLATECODE` | CHAR(3) |  | FK | foreign_key |  |

## References (this table → parent) — 2

| Constraint | Local columns | → Table | → Columns | ON DELETE | JOIN predicate |
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `EXTERNALOPERATIONTEMPLATEIE.COMPANYCODE = COMPANY.CODE` |
| `STOCKTRANSACTIONTEMPLATE_RECEIVINGSTOCKTRANSACTIONTEMPLATE` | `RECEIVINGSTOCKTRNTMPCMYCODE`, `RECEIVINGSTOCKTRNTEMPLATECODE` | [`STOCKTRANSACTIONTEMPLATE`](../INVENTORY/STOCKTRANSACTIONTEMPLATE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `EXTERNALOPERATIONTEMPLATEIE.RECEIVINGSTOCKTRNTMPCMYCODE = STOCKTRANSACTIONTEMPLATE.COMPANYCODE AND EXTERNALOPERATIONTEMPLATEIE.RECEIVINGSTOCKTRNTEMPLATECODE = STOCKTRANSACTIONTEMPLATE.CODE` |
...
- `EXTERNALOPERATIONTMPIEUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.EXTERNALOPERATIONTEMPLATEIE t
