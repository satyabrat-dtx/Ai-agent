# DB2ADMIN.STOCKTAKEBALANCEEXP

- **Module**: `INVENTORY` (high confidence — table name starts with 'STOCK')
- **Roles**: `business_data`
- **Columns**: 10
- **Primary key**: `ENVIRONMENTCODE`, `EXPCOMPANYCODE`, `EXPSTOCKTAKEIDENTIFIER`, `EXPSTOCKTAKEIDENTIFIERLINE`, `UNIQUEIDPK`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 78823
...
| 2 | `EXPSTOCKTAKEIDENTIFIER` | DECIMAL(11,0) | NOT NULL | PK | primary_key |  |
| 3 | `EXPSTOCKTAKEIDENTIFIERLINE` | INTEGER | NOT NULL | PK | primary_key |  |
...
- `STOCKTAKEBALANCEEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       t.EXPCOMPANYCODE,
       t.EXPSTOCKTAKEIDENTIFIER,
       t.EXPSTOCKTAKEIDENTIFIERLINE,
       t.OPERATIONTYPE,
       t.STATUS,
       t.UNIQUEIDPK,
       t.ABSUNIQUEID,
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.STOCKTAKEBALANCEEXP t
