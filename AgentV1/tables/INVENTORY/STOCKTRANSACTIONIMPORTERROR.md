# DB2ADMIN.STOCKTRANSACTIONIMPORTERROR
...
- **Source**: `DB2ADMIN_DDL.sql` line 26691
...
| 2 | `IMPORTLINETRANSACTIONNUMBER` | CHAR(15) |  |  |  |  |
| 3 | `IMPLINETRNDETAILNUMBER` | INTEGER | NOT NULL |  |  |  |
...
- `STIERROR01` (IMPORTLINECOMPANYCODE, IMPORTLINETRANSACTIONNUMBER, IMPLINETRNDETAILNUMBER)
- `STOCKTRNIMPORTERRORUID` (ABSUNIQUEID)
...
SELECT t.ERRORTIMESTAMP,
       ...
       t.IMPORTLINETRANSACTIONNUMBER,
       t.IMPLINETRNDETAILNUMBER,
       t.ABSUNIQUEID
FROM   DB2ADMIN.STOCKTRANSACTIONIMPORTERROR t
