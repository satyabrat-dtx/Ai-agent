...
- **Source**: `DB2ADMIN_DDL.sql` line 198983
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `BOMCOMPONENTTYPE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `BOMCOMPONENTTYPE_BOMCOMPONENTTYPE` | [`ENGINEERINGCHANGEBOM`](../CORE_MASTER/ENGINEERINGCHANGEBOM.md) | `ENGINEERINGCHANGECOMPANYCODE`, `BOMCOMPONENTTYPECODE` | `ENGINEERINGCHANGEBOM.ENGINEERINGCHANGECOMPANYCODE = BOMCOMPONENTTYPE.COMPANYCODE AND ENGINEERINGCHANGEBOM.BOMCOMPONENTTYPECODE = BOMCOMPONENTTYPE.CODE` |
| `BOMCOMPONENTTYPE_BOMCOMPONENTTYPE` | [`BOMCOMPONENT`](../ITEM_MASTER/BOMCOMPONENT.md) | `BILLOFMATERIALCOMPANYCODE`, `BOMCOMPONENTTYPECODE` | `BOMCOMPONENT.BILLOFMATERIALCOMPANYCODE = BOMCOMPONENTTYPE.COMPANYCODE AND BOMCOMPONENT.BOMCOMPONENTTYPECODE = BOMCOMPONENTTYPE.CODE` |

## Indexes

- `BOMCOMPONENTTYPEUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.BOMCOMPONENTTYPE t
