# DB2ADMIN.BOMITEMSUBCODEFORREPORT
...
- **Source**: `DB2ADMIN_DDL.sql` line 15616
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `BOMITEMSUBCODEFORREPORT.COMPANYCODE = COMPANY.CODE` |
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `BOMITEMSUBCODEFORREPORT.OWNINGCOMPANYCODE = COMPANY.CODE` |
| `ITEMTYPE_ITEMTYPE` | `ITEMTYPECOMPANYCODE`, `ITEMTYPECODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `BOMITEMSUBCODEFORREPORT.ITEMTYPECOMPANYCODE = ITEMTYPE.COMPANYCODE AND BOMITEMSUBCODEFORREPORT.ITEMTYPECODE = ITEMTYPE.CODE` |
...
- `BOMITEMSUBCODEFORREPORTUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.BOMITEMSUBCODEFORREPORT t
