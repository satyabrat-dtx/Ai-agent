...
- **Source**: `DB2ADMIN_DDL.sql` line 14512
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `BOMTYPE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `BOMTYPE_BOMTYPE` | [`BILLOFMATERIAL`](../CORE_MASTER/BILLOFMATERIAL.md) | `COMPANYCODE`, `BOMTYPECODE` | `BILLOFMATERIAL.COMPANYCODE = BOMTYPE.COMPANYCODE AND BILLOFMATERIAL.BOMTYPECODE = BOMTYPE.CODE` |
| `BOMTYPE_BOMTYPE` | [`ROUTING`](../PRODUCTION/ROUTING.md) | `COMPANYCODE`, `BOMTYPECODE` | `ROUTING.COMPANYCODE = BOMTYPE.COMPANYCODE AND ROUTING.BOMTYPECODE = BOMTYPE.CODE` |

## Indexes

- `BOMTYPEUID` (ABSUNIQUEID)
