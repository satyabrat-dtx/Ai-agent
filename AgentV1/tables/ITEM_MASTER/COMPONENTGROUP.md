...
- **Source**: `DB2ADMIN_DDL.sql` line 209052
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COMPONENTGROUP.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `COMPONENTGROUP_BOMCOMPONENTGROUP` | [`BOMCOMPONENT`](../ITEM_MASTER/BOMCOMPONENT.md) | `BILLOFMATERIALCOMPANYCODE`, `BOMCOMPONENTGROUPCODE` | `BOMCOMPONENT.BILLOFMATERIALCOMPANYCODE = COMPONENTGROUP.COMPANYCODE AND BOMCOMPONENT.BOMCOMPONENTGROUPCODE = COMPONENTGROUP.CODE` |

## Indexes

- `COMPONENTGROUPUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.SEARCHDESCRIPTION,
       t.ABSUNIQUEID
FROM   DB2ADMIN.COMPONENTGROUP t
