# DB2ADMIN.DIRECTIVETEMPLATEINPUTFIELD
...
- **Source**: `DB2ADMIN_DDL.sql` line 199072
...
| 3 | `OPERATOR` | CHAR(10) | NOT NULL |  |  |  |
| 4 | `RESTRICT` | SMALLINT | NOT NULL |  |  |  |
...
| 12 | `SHOWDECODING` | SMALLINT | NOT NULL |  |  |  |

## References (this table → parent) — 1

| Constraint | Local columns | → Table | → Columns | ON DELETE | JOIN predicate |
|---|---|---|---|---|---|
| `DIRECTIVETEMPLATE_INPUTFIELD` | `DIRECTIVETEMPLATECOMPANYCODE`, `DIRECTIVETEMPLATECODE` | [`DIRECTIVETEMPLATE`](../ITEM_MASTER/DIRECTIVETEMPLATE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `DIRECTIVETEMPLATEINPUTFIELD.DIRECTIVETEMPLATECOMPANYCODE = DIRECTIVETEMPLATE.COMPANYCODE AND DIRECTIVETEMPLATEINPUTFIELD.DIRECTIVETEMPLATECODE = DIRECTIVETEMPLATE.CODE` |
...
- `DIRECTIVETMPINPUTFIELDUID` (ABSUNIQUEID)
...
SELECT t.DIRECTIVETEMPLATECOMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.DIRECTIVETEMPLATEINPUTFIELD t
