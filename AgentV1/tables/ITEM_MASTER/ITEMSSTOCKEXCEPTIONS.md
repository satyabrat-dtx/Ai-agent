...
- **Source**: `DB2ADMIN_DDL.sql` line 188082
...
| 2 | `ITE_NET_GROUP_CODE` | VARCHAR(16) | NOT NULL | PK | primary_key |  |
...
| 7 | `ITE_STOCKDIFFERENCE` | DECIMAL(11,2) |  |  |  |  |
...
FROM   DB2ADMIN.ITEMSSTOCKEXCEPTIONS t
