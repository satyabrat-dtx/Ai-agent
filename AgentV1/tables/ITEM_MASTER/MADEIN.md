...
- **Source**: `DB2ADMIN_DDL.sql` line 4348
...
|---|---|---|---|
| `MADEIN_MADEIN` | [`PRODUCTSPECIALIZEDSIZE`](../ITEM_MASTER/PRODUCTSPECIALIZEDSIZE.md) | `MADEINCODE` | `PRODUCTSPECIALIZEDSIZE.MADEINCODE = MADEIN.CODE` |

## Indexes

- `MADEINUID` (ABSUNIQUEID)
