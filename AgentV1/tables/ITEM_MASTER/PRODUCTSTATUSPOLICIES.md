# DB2ADMIN.PRODUCTSTATUSPOLICIES
...
- **Source**: `DB2ADMIN_DDL.sql` line 190538
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PRODUCTSTATUSPOLICIES.COMPANYCODE = COMPANY.CODE` |
| `ITEMTYPE_ITEMTYPE` | `ITEMTYPECOMPANYCODE`, `ITEMTYPECODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `PRODUCTSTATUSPOLICIES.ITEMTYPECOMPANYCODE = ITEMTYPE.COMPANYCODE AND PRODUCTSTATUSPOLICIES.ITEMTYPECODE = ITEMTYPE.CODE` |
...
- `PRODUCTSTATUSPOLICIESUID` (ABSUNIQUEID)
...
SELECT t.UNIQUEID,
       ...
       t.AUTOMATIC,
       t.ISCONFIGROW
FROM   DB2ADMIN.PRODUCTSTATUSPOLICIES t
