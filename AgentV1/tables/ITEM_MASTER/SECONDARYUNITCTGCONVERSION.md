# DB2ADMIN.SECONDARYUNITCTGCONVERSION
...
- **Source**: `DB2ADMIN_DDL.sql` line 4716
...
- `SECONDARYUNITCTGCVSUID` (ABSUNIQUEID)
...
SELECT t.PRODUCTCOMPANYCODE,
       ...
       t.PRODUCTSUBCODE09,
       t.PRODUCTSUBCODE10
FROM   DB2ADMIN.SECONDARYUNITCTGCONVERSION t
