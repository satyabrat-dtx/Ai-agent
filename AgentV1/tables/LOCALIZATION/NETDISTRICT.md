...
- **Source**: `DB2ADMIN_DDL.sql` line 122780
...
|---|---|---|---|
| `NETDISTRICT_DISTRICT` | [`COUNTRYVSSTATVSDISTVSCITY`](../CORE_MASTER/COUNTRYVSSTATVSDISTVSCITY.md) | `DISTRICTCODE` | `COUNTRYVSSTATVSDISTVSCITY.DISTRICTCODE = NETDISTRICT.CODE` |
| `NETDISTRICT_DISTRICT` | [`STATEVSDISTRICT`](../HR/STATEVSDISTRICT.md) | `DISTRICTCODE` | `STATEVSDISTRICT.DISTRICTCODE = NETDISTRICT.CODE` |

## Indexes

- `NETDISTRICTUID` (ABSUNIQUEID)
