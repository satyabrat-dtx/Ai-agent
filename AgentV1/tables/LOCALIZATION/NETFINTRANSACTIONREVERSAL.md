# DB2ADMIN.NETFINTRANSACTIONREVERSAL

- **Module**: `LOCALIZATION` (low confidence — table name starts with 'NET')
- **Roles**: `business_data`
- **Columns**: 10
- **Primary key**: `COMPANYCODE`, `REFFINDOCCODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 200688
...
| 1 | `REFFINDOCCODE` | CHAR(15) | NOT NULL | PK | primary_key |  |
| 2 | `READFLAG` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `NETFINTRANSACTIONREVERSAL.COMPANYCODE = COMPANY.CODE` |
...
- `NETFINTRANSACTIONREVERSALUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.NETFINTRANSACTIONREVERSAL t
