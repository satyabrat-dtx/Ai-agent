# DB2ADMIN.NETPROJECTWISESTANDARDCOST

- **Module**: `LOCALIZATION` (low confidence — table name starts with 'NET')
- **Roles**: `business_data`
- **Columns**: 19
- **Primary key**: `COMPANYCODE`, `PROJECTCODE`, `FULLITEMCODE`, `SUBCODE01`, `SUBCODE02`, `SUBCODE03`, `SUBCODE04`, `SUBCODE05`, `SUBCODE06`, `SUBCODE07`, `SUBCODE08`, `SUBCODE09`, `SUBCODE10`
- **FK degree**: referenced by 0 constraint(s), references 2 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 200338
...
| 1 | `PROJECTCODE` | CHAR(20) | NOT NULL | PK | primary_key |  |
| 2 | `FULLITEMCOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 3 | `FULLITEMCODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
...
| 14 | `PRICE` | DECIMAL(15,5) |  |  |  |  |
| 15 | `MARGIN` | DECIMAL(15,5) |  |  |  |  |
| 16 | `PRODUCTUOMCODE` | CHAR(3) |  | FK | foreign_key |  |
...
|---|---|---|---|---|---|
| `CURRENCY_CURRENCY` | `CURRENCYCODE` | [`CURRENCY`](../CORE_MASTER/CURRENCY.md) | `CODE` | RESTRICT | `NETPROJECTWISESTANDARDCOST.CURRENCYCODE = CURRENCY.CODE` |
| `UNITOFMEASURE_PRODUCTUOM` | `PRODUCTUOMCODE` | [`UNITOFMEASURE`](../CORE_MASTER/UNITOFMEASURE.md) | `CODE` | RESTRICT | `NETPROJECTWISESTANDARDCOST.PRODUCTUOMCODE = UNITOFMEASURE.CODE` |
...
- `NETPROJECTWISESTANDARDCOSTUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.SUBCODE07,
       t.SUBCODE08
FROM   DB2ADMIN.NETPROJECTWISESTANDARDCOST t
