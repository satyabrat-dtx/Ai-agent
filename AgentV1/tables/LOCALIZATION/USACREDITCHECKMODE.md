...
- **Source**: `DB2ADMIN_DDL.sql` line 88266
...
|---|---|---|---|
| `USACREDITCHECKMODE_CREDITMODE` | [`USAOPENBALANCE`](../LOCALIZATION/USAOPENBALANCE.md) | `CREDITMODECODE` | `USAOPENBALANCE.CREDITMODECODE = USACREDITCHECKMODE.CODE` |

## Indexes

- `USACREDITCHECKMODEUID` (ABSUNIQUEID)
...
SELECT t.CODE,
       ...
       t.LASTUPDATEUSER,
       t.ABSUNIQUEID
FROM   DB2ADMIN.USACREDITCHECKMODE t
