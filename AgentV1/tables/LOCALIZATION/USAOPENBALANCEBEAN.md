...
- **Source**: `DB2ADMIN_DDL.sql` line 86092
...
| 2 | `ORDPRNCUSTOMERSUPPLIERTYPE` | CHAR(1) |  |  |  |  |
| 3 | `ORDPRNCUSTOMERSUPPLIERCODE` | CHAR(8) |  |  |  |  |
| 4 | `OPENBALANCE` | DECIMAL(18,5) |  |  |  |  |
| 5 | `CREDITMODECODE` | CHAR(3) |  |  |  |  |
...
SELECT t.IMPORTAUTOCOUNTER,
       ...
       t.IMPLASTUPDATEUSER
FROM   DB2ADMIN.USAOPENBALANCEBEAN t
