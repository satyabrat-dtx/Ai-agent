# DB2ADMIN.LOGBILLOFEXCHANGECHECKLIST
...
- **Source**: `DB2ADMIN_DDL.sql` line 200904
...
| 3 | `CLCODUSGENGRPTYPECOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 4 | `CLCODEUSERGENERICGROUPTYPECODE` | CHAR(3) | NOT NULL |  |  |  |
| 5 | `CLCODECODE` | CHAR(10) | NOT NULL |  |  |  |
...
- `FATHERID` → **LOGBILLOFEXCHANGE**.`ABSUNIQUEID` (medium confidence — name = 'LOGBILLOFEXCHANGE' + recurring fragment 'CHECKLIST' (seen in 3 tables))
  - JOIN predicate: `LOGBILLOFEXCHANGECHECKLIST.FATHERID = LOGBILLOFEXCHANGE.ABSUNIQUEID`
...
SELECT t.BILLOFEXCHANGECOMPANYCODE,
       ...
       t.LASTUPDATEUSER
FROM   DB2ADMIN.LOGBILLOFEXCHANGECHECKLIST t
