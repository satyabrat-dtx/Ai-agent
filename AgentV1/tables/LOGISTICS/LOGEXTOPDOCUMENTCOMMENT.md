# DB2ADMIN.LOGEXTOPDOCUMENTCOMMENT
...
- **Source**: `DB2ADMIN_DDL.sql` line 214605
...
|---|--------|------|------|-----|------|---------|
| 0 | `EXTOPDOCLINEEXTOPDOCCMYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 1 | `EXTOPDOCLINEEXTOPDOCPROVCNTCOD` | CHAR(8) | NOT NULL |  |  |  |
| 2 | `EXTOPDOCLINEEXTOPDOCPRVCODE` | CHAR(15) | NOT NULL |  |  |  |
| 3 | `EXTOPDOCUMENTLINEORDERLINE` | DECIMAL(7,0) | NOT NULL |  |  |  |
...
- `FATHERID` → **LOGEXTOPDOCUMENT**.`ABSUNIQUEID` (high confidence — name = 'LOGEXTOPDOCUMENT' + known child suffix 'COMMENT')
  - JOIN predicate: `LOGEXTOPDOCUMENTCOMMENT.FATHERID = LOGEXTOPDOCUMENT.ABSUNIQUEID`
...
SELECT t.EXTOPDOCLINEEXTOPDOCCMYCODE,
       ...
       t.TERMSOFLOGCODE
FROM   DB2ADMIN.LOGEXTOPDOCUMENTCOMMENT t
