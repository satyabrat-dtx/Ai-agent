# DB2ADMIN.LOGFINCOSTCENTERDETAIL
...
- **Source**: `DB2ADMIN_DDL.sql` line 230531
...
|---|--------|------|------|-----|------|---------|
| 0 | `FINBUSINESSVSPROFITCOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 1 | `FINBVSPROFITBUSINESSUNITCODE` | CHAR(10) | NOT NULL |  |  |  |
| 2 | `FINBVSPROFITPROFITCENTERCODE` | CHAR(10) | NOT NULL |  |  |  |
| 3 | `COSTCENTERCOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 4 | `COSTCENTERCODE` | CHAR(20) | NOT NULL |  |  |  |
...
- `FATHERID` → **parent not derivable**. FATHERID present but no parent table is derivable from the name. Join as `LOGFINCOSTCENTERDETAIL.FATHERID = <parent>.ABSUNIQUEID`, where `<parent>` must come from the query context.
...
SELECT t.FINBUSINESSVSPROFITCOMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.LOGFINCOSTCENTERDETAIL t
