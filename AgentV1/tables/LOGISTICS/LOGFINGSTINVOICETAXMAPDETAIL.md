# DB2ADMIN.LOGFINGSTINVOICETAXMAPDETAIL
...
- **Source**: `DB2ADMIN_DDL.sql` line 225797
...
|---|--------|------|------|-----|------|---------|
| 0 | `FINGSTINVOICETAXMAPCOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 1 | `FINGSTINVOICETAXMAPDIVISIONCOD` | CHAR(3) | NOT NULL |  |  |  |
| 2 | `FINGSTINVOICETAXMAPPOSITION` | INTEGER | NOT NULL |  |  |  |
| 3 | `FINGSTINVOICETAXMAPREPORTCODE` | CHAR(10) | NOT NULL |  |  |  |
| 4 | `LINENO` | DECIMAL(18,5) | NOT NULL |  |  |  |
| 5 | `ITAXCODE` | CHAR(3) |  |  |  |  |
...
- `FATHERID` → **LOGFINGSTINVOICETAXMAP**.`ABSUNIQUEID` (high confidence — name = 'LOGFINGSTINVOICETAXMAP' + known child suffix 'DETAIL')
  - JOIN predicate: `LOGFINGSTINVOICETAXMAPDETAIL.FATHERID = LOGFINGSTINVOICETAXMAP.ABSUNIQUEID`
...
SELECT t.FINGSTINVOICETAXMAPCOMPANYCODE,
       ...
       t.LASTUPDATEUSER
FROM   DB2ADMIN.LOGFINGSTINVOICETAXMAPDETAIL t
