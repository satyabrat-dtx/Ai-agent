...
- **Source**: `DB2ADMIN_DDL.sql` line 225954
...
|---|--------|------|------|-----|------|---------|
| 0 | `FINLOANCAPITALSRCOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 1 | `FINLCAPSRLTEUGENGROUPTYPECODE` | CHAR(3) | NOT NULL |  |  |  |
| 2 | `FINLOANCAPITALSRLOANTYPECODE` | CHAR(10) | NOT NULL |  |  |  |
| 3 | `FINLOANCAPITALSRCODELOANNO` | CHAR(10) | NOT NULL |  |  |  |
| 4 | `FINLOANCAPITALSRSLNO` | INTEGER | NOT NULL |  |  |  |
| 5 | `SLNO` | INTEGER | NOT NULL |  |  |  |
| 6 | `ASSETSLNO` | INTEGER | NOT NULL |  |  |  |
...
- `FATHERID` → **parent not derivable**. FATHERID present but no parent table is derivable from the name. Join as `LOGFINLOANASSETCS.FATHERID = <parent>.ABSUNIQUEID`, where `<parent>` must come from the query context.
...
SELECT t.FINLOANCAPITALSRCOMPANYCODE,
       ...
       t.CREATIONDATETIME,
       t.CREATIONUSER
FROM   DB2ADMIN.LOGFINLOANASSETCS t
