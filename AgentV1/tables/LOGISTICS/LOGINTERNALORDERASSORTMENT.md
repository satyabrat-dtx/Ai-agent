# DB2ADMIN.LOGINTERNALORDERASSORTMENT
...
- **Source**: `DB2ADMIN_DDL.sql` line 51854
...
- `FATHERID` → **LOGINTERNALORDER**.`ABSUNIQUEID` (high confidence — name = 'LOGINTERNALORDER' + known child suffix 'ASSORTMENT')
  - JOIN predicate: `LOGINTERNALORDERASSORTMENT.FATHERID = LOGINTERNALORDER.ABSUNIQUEID`
...
SELECT t.INTERNALORDERCOMPANYCODE,
       ...
       t.SUBCODE04,
       t.SUBCODE05
FROM   DB2ADMIN.LOGINTERNALORDERASSORTMENT t
