# DB2ADMIN.LOGINTERNALORDERBLOCKS
...
- **Source**: `DB2ADMIN_DDL.sql` line 51927
...
- `FATHERID` → **LOGINTERNALORDER**.`ABSUNIQUEID` (high confidence — name = 'LOGINTERNALORDER' + known child suffix 'BLOCKS')
  - JOIN predicate: `LOGINTERNALORDERBLOCKS.FATHERID = LOGINTERNALORDER.ABSUNIQUEID`
...
FROM   DB2ADMIN.LOGINTERNALORDERBLOCKS t
