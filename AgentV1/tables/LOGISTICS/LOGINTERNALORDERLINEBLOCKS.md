# DB2ADMIN.LOGINTERNALORDERLINEBLOCKS
...
- **Source**: `DB2ADMIN_DDL.sql` line 52270
...
- `FATHERID` → **LOGINTERNALORDERLINE**.`ABSUNIQUEID` (high confidence — name = 'LOGINTERNALORDERLINE' + known child suffix 'BLOCKS')
  - JOIN predicate: `LOGINTERNALORDERLINEBLOCKS.FATHERID = LOGINTERNALORDERLINE.ABSUNIQUEID`
...
SELECT t.INTORDLINEINTORDERCOMPANYCODE,
       ...
       t.APPLYONCREATE,
       t.APPLYONUPDATE
FROM   DB2ADMIN.LOGINTERNALORDERLINEBLOCKS t
