...
- **Source**: `DB2ADMIN_DDL.sql` line 217460
...
| 1 | `COSTCURRENCYCODE` | CHAR(4) |  |  |  |  |
| 2 | `FINANCESYSTEM` | CHAR(2) | NOT NULL |  |  |  |
| 3 | `GLGROUPBYTAX` | SMALLINT | NOT NULL |  |  |  |
| 4 | `POSTINGPOLICYREFERENCECODE` | CHAR(20) |  |  |  |  |
| 5 | `PURCHASEINVOICEREQUIRED` | SMALLINT | NOT NULL |  |  |  |
| 6 | `LOGFORALLENTITIES` | SMALLINT | NOT NULL |  |  |  |
| 7 | `GLMASTERLOGMANAGEMENT` | SMALLINT | NOT NULL |  |  |  |
| 8 | `QCCHECKREQUIRED` | SMALLINT | NOT NULL |  |  |  |
| 9 | `TCSDIVISION` | SMALLINT | NOT NULL |  |  |  |
| 10 | `TCSAPPLICABLE` | SMALLINT | NOT NULL |  |  |  |
| 11 | `TDSEXCEMPTIONCALREQ` | SMALLINT | NOT NULL |  |  |  |
| 12 | `INTERCOMPMRNINPLANTINVOICE` | SMALLINT | NOT NULL |  |  |  |
...
| 20 | `INDIANISATIONREQUIRED` | SMALLINT | NOT NULL |  |  |  |
| 21 | `MRNPOSTINGBEFOREQC` | SMALLINT | NOT NULL |  |  |  |
...
- `FATHERID` → **parent not derivable**. FATHERID present but no parent table is derivable from the name. Join as `LOGNETCOMPANYSETUP.FATHERID = <parent>.ABSUNIQUEID`, where `<parent>` must come from the query context.
...
SELECT t.COMPANYCODE,
       ...
       t.TCSDIVISION,
       t.TCSAPPLICABLE,
       t.TDSEXCEMPTIONCALREQ
FROM   DB2ADMIN.LOGNETCOMPANYSETUP t
