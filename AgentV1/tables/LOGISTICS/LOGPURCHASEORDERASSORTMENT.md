# DB2ADMIN.LOGPURCHASEORDERASSORTMENT
...
- **Source**: `DB2ADMIN_DDL.sql` line 52979
...
- `FATHERID` → **LOGPURCHASEORDER**.`ABSUNIQUEID` (high confidence — name = 'LOGPURCHASEORDER' + known child suffix 'ASSORTMENT')
  - JOIN predicate: `LOGPURCHASEORDERASSORTMENT.FATHERID = LOGPURCHASEORDER.ABSUNIQUEID`
...
SELECT t.PURCHASEORDERCOMPANYCODE,
       ...
       t.SUBCODE04,
       t.SUBCODE05
FROM   DB2ADMIN.LOGPURCHASEORDERASSORTMENT t
