# DB2ADMIN.LOGPURCHASEORDERDISCOUNT
...
- **Source**: `DB2ADMIN_DDL.sql` line 53211
...
- `FATHERID` → **LOGPURCHASEORDER**.`ABSUNIQUEID` (high confidence — name = 'LOGPURCHASEORDER' + known child suffix 'DISCOUNT')
  - JOIN predicate: `LOGPURCHASEORDERDISCOUNT.FATHERID = LOGPURCHASEORDER.ABSUNIQUEID`
...
FROM   DB2ADMIN.LOGPURCHASEORDERDISCOUNT t
