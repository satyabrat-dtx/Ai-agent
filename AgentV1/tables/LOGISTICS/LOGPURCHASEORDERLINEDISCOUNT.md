# DB2ADMIN.LOGPURCHASEORDERLINEDISCOUNT
...
- **Source**: `DB2ADMIN_DDL.sql` line 53369
...
- `FATHERID` → **LOGPURCHASEORDERLINE**.`ABSUNIQUEID` (high confidence — name = 'LOGPURCHASEORDERLINE' + known child suffix 'DISCOUNT')
  - JOIN predicate: `LOGPURCHASEORDERLINEDISCOUNT.FATHERID = LOGPURCHASEORDERLINE.ABSUNIQUEID`
...
FROM   DB2ADMIN.LOGPURCHASEORDERLINEDISCOUNT t
