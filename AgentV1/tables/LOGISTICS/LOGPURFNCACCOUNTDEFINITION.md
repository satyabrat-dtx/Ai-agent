# DB2ADMIN.LOGPURFNCACCOUNTDEFINITION
...
- **Source**: `DB2ADMIN_DDL.sql` line 113342
...
- `FATHERID` → **parent not derivable**. FATHERID present but no parent table is derivable from the name. Join as `LOGPURFNCACCOUNTDEFINITION.FATHERID = <parent>.ABSUNIQUEID`, where `<parent>` must come from the query context.
...
SELECT t.COMPANYCODE,
       ...
       t.DIVISIONCODE
FROM   DB2ADMIN.LOGPURFNCACCOUNTDEFINITION t
