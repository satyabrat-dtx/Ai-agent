...
- **Source**: `DB2ADMIN_DDL.sql` line 213697
...
|---|--------|------|------|-----|------|---------|
| 0 | `QUALITYHEADERCOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 1 | `QUALITYHEADERCODE` | CHAR(20) | NOT NULL |  |  |  |
| 2 | `QUALITYHEADERSUBGROUPCODE` | CHAR(5) | NOT NULL |  |  |  |
| 3 | `QUALITYHEADERNUMBERID` | INTEGER | NOT NULL |  |  |  |
| 4 | `LINE` | INTEGER | NOT NULL |  |  |  |
| 5 | `SEQUENCE` | INTEGER | NOT NULL |  |  |  |
| 6 | `CHARACTERISTICCODE` | CHAR(10) |  |  |  |  |
| 7 | `GROUPCOMPANYCODE` | CHAR(3) |  |  |  |  |
| 8 | `GROUPCODE` | CHAR(3) |  |  |  |  |
| 9 | `STATUSINACTIVE` | SMALLINT | NOT NULL |  |  |  |
| 10 | `INTERNALSPECIFICATIONCODE` | CHAR(10) |  |  |  |  |
| 11 | `ISOSPECIFICATIONCODE` | CHAR(10) |  |  |  |  |
| 12 | `MANDATORY` | SMALLINT | NOT NULL |  |  |  |
| 13 | `SUBCODEMIN` | CHAR(50) |  |  |  |  |
| 14 | `SUBCODEMAX` | CHAR(50) |  |  |  |  |
| 15 | `SUBCODEMEDIOMIN` | CHAR(50) |  |  |  |  |
| 16 | `SUBCODEMEDIOMAX` | CHAR(50) |  |  |  |  |
| 17 | `SUBCODESTANDARD` | CHAR(50) |  |  |  |  |
| 18 | `REPETITIONNUMBER` | INTEGER | NOT NULL |  |  |  |
...
- `FATHERID` → **parent not derivable**. FATHERID present but no parent table is derivable from the name. Join as `LOGQUALITYLINE.FATHERID = <parent>.ABSUNIQUEID`, where `<parent>` must come from the query context.
...
FROM   DB2ADMIN.LOGQUALITYLINE t
