# DB2ADMIN.LOGSALESCLAIMLINEDISCOUNT
...
- **Source**: `DB2ADMIN_DDL.sql` line 106016
...
|---|--------|------|------|-----|------|---------|
| 0 | `SALESCLAIMLINECOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 1 | `SALESCLAIMLINECODE` | CHAR(15) | NOT NULL |  |  |  |
| 2 | `SALESCLAIMLINELINE` | DECIMAL(7,0) | NOT NULL |  |  |  |
...
- `FATHERID` → **LOGSALESCLAIMLINE**.`ABSUNIQUEID` (high confidence — name = 'LOGSALESCLAIMLINE' + known child suffix 'DISCOUNT')
  - JOIN predicate: `LOGSALESCLAIMLINEDISCOUNT.FATHERID = LOGSALESCLAIMLINE.ABSUNIQUEID`
...
FROM   DB2ADMIN.LOGSALESCLAIMLINEDISCOUNT t
