# DB2ADMIN.LOGSALESDOCUMENTBLOCKS
...
- **Source**: `DB2ADMIN_DDL.sql` line 54120
...
- `FATHERID` → **LOGSALESDOCUMENT**.`ABSUNIQUEID` (high confidence — name = 'LOGSALESDOCUMENT' + known child suffix 'BLOCKS')
  - JOIN predicate: `LOGSALESDOCUMENTBLOCKS.FATHERID = LOGSALESDOCUMENT.ABSUNIQUEID`
...
FROM   DB2ADMIN.LOGSALESDOCUMENTBLOCKS t
