...
- **Source**: `DB2ADMIN_DDL.sql` line 54956
...
- `FATHERID` → **LOGSALESORDER**.`ABSUNIQUEID` (high confidence — name = 'LOGSALESORDER' + known child suffix 'BLOCKS')
  - JOIN predicate: `LOGSALESORDERBLOCKS.FATHERID = LOGSALESORDER.ABSUNIQUEID`
...
FROM   DB2ADMIN.LOGSALESORDERBLOCKS t
