...
- **Source**: `DB2ADMIN_DDL.sql` line 55009
...
- `FATHERID` → **LOGSALESORDER**.`ABSUNIQUEID` (high confidence — name = 'LOGSALESORDER' + known child suffix 'CHARGE')
  - JOIN predicate: `LOGSALESORDERCHARGE.FATHERID = LOGSALESORDER.ABSUNIQUEID`
...
SELECT t.SALESORDERCOMPANYCODE,
       ...
       t.SIGN,
       t.CALCULATIONTYPE
FROM   DB2ADMIN.LOGSALESORDERCHARGE t
