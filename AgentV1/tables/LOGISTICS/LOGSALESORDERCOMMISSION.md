# DB2ADMIN.LOGSALESORDERCOMMISSION
...
- **Source**: `DB2ADMIN_DDL.sql` line 55063
...
- `FATHERID` → **LOGSALESORDER**.`ABSUNIQUEID` (medium confidence — name = 'LOGSALESORDER' + recurring fragment 'COMMISSION' (seen in 11 tables))
  - JOIN predicate: `LOGSALESORDERCOMMISSION.FATHERID = LOGSALESORDER.ABSUNIQUEID`
...
FROM   DB2ADMIN.LOGSALESORDERCOMMISSION t
