# DB2ADMIN.LOGSALESRELEASELINEBLOCKS
...
- **Source**: `DB2ADMIN_DDL.sql` line 56051
...
- `FATHERID` → **LOGSALESRELEASELINE**.`ABSUNIQUEID` (high confidence — name = 'LOGSALESRELEASELINE' + known child suffix 'BLOCKS')
  - JOIN predicate: `LOGSALESRELEASELINEBLOCKS.FATHERID = LOGSALESRELEASELINE.ABSUNIQUEID`
...
SELECT t.SALESRELEASELINECOMPANYCODE,
       ...
       t.APPLYONCREATE,
       t.APPLYONUPDATE
FROM   DB2ADMIN.LOGSALESRELEASELINEBLOCKS t
