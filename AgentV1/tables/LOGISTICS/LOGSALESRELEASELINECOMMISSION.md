# DB2ADMIN.LOGSALESRELEASELINECOMMISSION
...
- **Source**: `DB2ADMIN_DDL.sql` line 56162
...
| 10 | `COMMISSIONCURRENCYCODE` | CHAR(4) |  |  |  |  |
...
- `FATHERID` → **LOGSALESRELEASELINE**.`ABSUNIQUEID` (medium confidence — name = 'LOGSALESRELEASELINE' + recurring fragment 'COMMISSION' (seen in 11 tables))
  - JOIN predicate: `LOGSALESRELEASELINECOMMISSION.FATHERID = LOGSALESRELEASELINE.ABSUNIQUEID`
...
SELECT t.SALESRELEASELINECOMPANYCODE,
       ...
       t.COMMISSIONSIGN
FROM   DB2ADMIN.LOGSALESRELEASELINECOMMISSION t
