# DB2ADMIN.LOGSALFNCACCOUNTDEFINITION
...
- **Source**: `DB2ADMIN_DDL.sql` line 113643
...
| 8 | `ELECTINVACCOUNTCODE` | CHAR(20) |  |  |  |  |
| 9 | `ACCOUNTTEMPLATECODE` | CHAR(6) |  |  |  |  |
| 10 | `ELECTINVACCOUNTTEMPLATECODE` | CHAR(6) |  |  |  |  |
| 11 | `DIVISIONCODE` | CHAR(3) |  |  |  | Division within a company; second-level organisational discriminator. |
| 12 | `ORDERTEMPLATECODE` | CHAR(3) |  |  |  |  |
| 13 | `ORDPRNCUSTOMERSUPPLIERCODE` | CHAR(8) |  |  |  |  |
| 14 | `ORDPRNGRPSTDORDGROUPTYPECODE` | CHAR(3) |  |  |  |  |
| 15 | `ORDERPARTNERGROUPCODE` | CHAR(3) |  |  |  |  |
| 16 | `ORDERCATEGORYCODE` | CHAR(3) |  |  |  |  |
| 17 | `COUNTRYCODE` | CHAR(3) |  |  |  |  |
| 18 | `TAXCODE` | CHAR(3) |  |  |  |  |
| 19 | `DISCOUNTGROUPCODE` | CHAR(3) |  |  |  |  |
| 20 | `ORDERLINETEMPLATECODE` | CHAR(3) |  |  |  |  |
| 21 | `ITEMTYPEAFICOMPANYCODE` | CHAR(3) |  |  |  |  |
...
| 33 | `QUALITYLEVELCODE` | DECIMAL(2,0) |  |  |  |  |
| 34 | `ORDITEMGRPSTDORDGROUPTYPECODE` | CHAR(3) |  |  |  |  |
| 35 | `ORDERITEMGROUPCODE` | CHAR(3) |  |  |  |  |
...
| 48 | `CURRENCYCODE` | CHAR(4) |  |  |  |  |
| 49 | `COSTCENTERCOMPANYCODE` | CHAR(3) |  |  |  |  |
| 50 | `COSTCENTERCODE` | CHAR(20) |  |  |  |  |
| 51 | `LOGUPDATEDFIELDS` | CLOB(1000000) |  |  |  |  |
| 52 | `RFPARTNERCUSTOMERSUPPLIERCODE` | CHAR(8) |  |  |  |  |
| 53 | `RFPRNGRPSTDORDERGROUPTYPECODE` | CHAR(3) |  |  |  |  |
| 54 | `REFERENCEPARTNERGROUPCODE` | CHAR(3) |  |  |  |  |
...
- `FATHERID` → **parent not derivable**. FATHERID present but no parent table is derivable from the name. Join as `LOGSALFNCACCOUNTDEFINITION.FATHERID = <parent>.ABSUNIQUEID`, where `<parent>` must come from the query context.
...
SELECT t.COMPANYCODE,
       ...
       t.LINETYPE,
       t.ACCOUNTCODE,
       t.ELECTINVACCOUNTCODE,
       t.ACCOUNTTEMPLATECODE,
       t.ELECTINVACCOUNTTEMPLATECODE,
       t.DIVISIONCODE
FROM   DB2ADMIN.LOGSALFNCACCOUNTDEFINITION t
