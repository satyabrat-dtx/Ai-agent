...
- **Source**: `DB2ADMIN_DDL.sql` line 11542
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `ADPRODUCTSHAREDLINK.COMPANYCODE = COMPANY.CODE` |
| `ITEMTYPE_ITEMTYPE` | `ITEMTYPECOMPANYCODE`, `ITEMTYPECODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `ADPRODUCTSHAREDLINK.ITEMTYPECOMPANYCODE = ITEMTYPE.COMPANYCODE AND ADPRODUCTSHAREDLINK.ITEMTYPECODE = ITEMTYPE.CODE` |
...
- `ADPRODUCTSHAREDLINKUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.SUBCODE09,
       t.SUBCODE10
FROM   DB2ADMIN.ADPRODUCTSHAREDLINK t
