# DB2ADMIN.ADPRODUCTSHAREDLINKEXP

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 19
- **Primary key**: `ENVIRONMENTCODE`, `EXPCOMPANYCODE`, `EXPITEMTYPECODE`, `EXPSUBCODE01`, `EXPSUBCODE02`, `EXPSUBCODE03`, `EXPSUBCODE04`, `EXPSUBCODE05`, `EXPSUBCODE06`, `EXPSUBCODE07`, `EXPSUBCODE08`, `EXPSUBCODE09`, `EXPSUBCODE10`, `UNIQUEIDPK`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 106494
...
| 13 | `OPERATIONTYPE` | INTEGER | NOT NULL |  |  |  |
| 14 | `STATUS` | INTEGER | NOT NULL |  |  |  |
| 15 | `UNIQUEIDPK` | BIGINT | NOT NULL | PK | primary_key |  |
| 16 | `FATHERABSUNIQUEID` | BIGINT | NOT NULL |  |  |  |
| 17 | `EVENTEXPDATETIME` | TIMESTAMP |  |  |  |  |
...
- `ADPRODUCTSHAREDLINKEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.EXPSUBCODE08,
       t.EXPSUBCODE09
FROM   DB2ADMIN.ADPRODUCTSHAREDLINKEXP t
