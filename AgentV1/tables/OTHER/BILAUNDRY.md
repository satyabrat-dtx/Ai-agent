...
- **Source**: `DB2ADMIN_DDL.sql` line 34143
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `BILAUNDRY.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `BILAUNDRY_LAUNDRY` | [`BICUSTOMEMBELLISHMENTS`](../OTHER/BICUSTOMEMBELLISHMENTS.md) | `COMPANYCODE`, `LAUNDRYCODE` | `BICUSTOMEMBELLISHMENTS.COMPANYCODE = BILAUNDRY.COMPANYCODE AND BICUSTOMEMBELLISHMENTS.LAUNDRYCODE = BILAUNDRY.CODE` |

## Indexes

- `BILAUNDRYUID` (ABSUNIQUEID)
