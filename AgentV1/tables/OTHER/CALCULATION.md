...
- **Source**: `DB2ADMIN_DDL.sql` line 165930
...
| 1 | `QUANTITY` | DECIMAL(7,2) | NOT NULL |  |  |  |
| 2 | `PRICE` | DECIMAL(7,2) | NOT NULL |  |  |  |
| 3 | `TOTALAMOUNT` | DECIMAL(9,2) | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `CALCULATION.COMPANYCODE = COMPANY.CODE` |
