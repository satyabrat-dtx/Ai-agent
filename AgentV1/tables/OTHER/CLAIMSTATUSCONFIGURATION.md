# DB2ADMIN.CLAIMSTATUSCONFIGURATION

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `COMPANYCODE`, `STATUSTYPE`, `DEFINITIONCODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 92280
...
| 1 | `STATUSTYPE` | CHAR(2) | NOT NULL | PK | primary_key |  |
| 2 | `DEFINITIONCODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
| 3 | `DEFAULTSTATUS` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `CLAIMSTATUSCONFIGURATION.COMPANYCODE = COMPANY.CODE` |
...
- `CLAIMSTATUSCONFIGURATIONUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.CLAIMSTATUSCONFIGURATION t
