...
- **Source**: `DB2ADMIN_DDL.sql` line 23160
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COLLECTIONKEYLINK.COMPANYCODE = COMPANY.CODE` |
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COLLECTIONKEYLINK.OWNINGCOMPANYCODE = COMPANY.CODE` |
| `ITEMTYPE_ITEMTYPE` | `ITEMTYPECOMPANYCODE`, `ITEMTYPECODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `COLLECTIONKEYLINK.ITEMTYPECOMPANYCODE = ITEMTYPE.COMPANYCODE AND COLLECTIONKEYLINK.ITEMTYPECODE = ITEMTYPE.CODE` |
...
- `COLLECTIONKEYLINKUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.SUBCODE09REQUIRED,
       t.SUBCODE10REQUIRED
FROM   DB2ADMIN.COLLECTIONKEYLINK t
