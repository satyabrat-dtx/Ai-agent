...
- **Source**: `DB2ADMIN_DDL.sql` line 27436
...
|---|---|---|---|
| `COLLECTIONSTATUS_PROGRESSSTATUS` | [`COLLECTIONGROUP`](../CORE_MASTER/COLLECTIONGROUP.md) | `PROGRESSSTATUSCODE` | `COLLECTIONGROUP.PROGRESSSTATUSCODE = COLLECTIONSTATUS.CODE` |

## Indexes

- `COLLECTIONSTATUSUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.COLLECTIONSTATUS t
