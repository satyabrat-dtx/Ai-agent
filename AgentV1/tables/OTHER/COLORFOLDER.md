...
- **Source**: `DB2ADMIN_DDL.sql` line 104715
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COLORFOLDER.COMPANYCODE = COMPANY.CODE` |
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COLORFOLDER.OWNINGCOMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `COLORFOLDER_COLOR` | [`COLOR`](../OTHER/COLOR.md) | `COLORFOLDERCOMPANYCODE`, `COLORFOLDERCODE` | `COLOR.COLORFOLDERCOMPANYCODE = COLORFOLDER.COMPANYCODE AND COLOR.COLORFOLDERCODE = COLORFOLDER.CODE` |

## Indexes

- `COLORFOLDERUID` (ABSUNIQUEID)
