...
- **Source**: `DB2ADMIN_DDL.sql` line 210650
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COLORTONE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `COLORTONE_COLORTONE` | [`COLOR`](../OTHER/COLOR.md) | `COLORFOLDERCOMPANYCODE`, `COLORTONECODE` | `COLOR.COLORFOLDERCOMPANYCODE = COLORTONE.COMPANYCODE AND COLOR.COLORTONECODE = COLORTONE.CODE` |

## Indexes

- `COLORTONEUID` (ABSUNIQUEID)
