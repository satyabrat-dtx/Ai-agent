# DB2ADMIN.COMPOSITIONCOMPONENTBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 46578
...
| 18 | `TRANSLATEDLONGDESCRIPTION` | VARCHAR(200) |  |  |  |  |
| 19 | `TRANSLATEDLANGUAGECODE` | CHAR(2) |  |  |  |  |
| 20 | `TRANSLATEDSHORTDESCRIPTION` | VARCHAR(80) |  |  |  |  |
...
- `COMPOSITIONCOMPONENTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.COMPOSITIONCOMPONENTBEAN t
