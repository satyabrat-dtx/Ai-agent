# DB2ADMIN.CUSTOMERSUPPLIERDATAEXP

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 10
- **Primary key**: `ENVIRONMENTCODE`, `EXPCOMPANYCODE`, `EXPTYPE`, `EXPCODE`, `UNIQUEIDPK`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 76388
...
| 2 | `EXPTYPE` | CHAR(1) | NOT NULL | PK | primary_key |  |
...
- `CUSTOMERSUPPLIERDATAEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.CUSTOMERSUPPLIERDATAEXP t
