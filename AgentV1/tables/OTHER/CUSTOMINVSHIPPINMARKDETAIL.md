# DB2ADMIN.CUSTOMINVSHIPPINMARKDETAIL
...
- **Source**: `DB2ADMIN_DDL.sql` line 220172
...
|---|---|---|---|---|---|
| `CUSTOMINVOICE_SHIPPINGLINE` | `CUSTOMINVOICECOMPANYCODE`, `CUSTOMINVOICEDIVISIONCODE`, `CUSTOMINVOICECODE` | [`CUSTOMINVOICE`](../CORE_MASTER/CUSTOMINVOICE.md) | `COMPANYCODE`, `DIVISIONCODE`, `CODE` | RESTRICT | `CUSTOMINVSHIPPINMARKDETAIL.CUSTOMINVOICECOMPANYCODE = CUSTOMINVOICE.COMPANYCODE AND CUSTOMINVSHIPPINMARKDETAIL.CUSTOMINVOICEDIVISIONCODE = CUSTOMINVOICE.DIVISIONCODE AND CUSTOMINVSHIPPINMARKDETAIL.CUSTOMINVOICECODE = CUSTOMINVOICE.CODE` |
...
- `CUSTOMINVSHIPPINMARKDLTUID` (ABSUNIQUEID)
...
SELECT t.CUSTOMINVOICECOMPANYCODE,
       ...
       t.SHIPPINGMARK,
       t.ABSUNIQUEID
FROM   DB2ADMIN.CUSTOMINVSHIPPINMARKDETAIL t
