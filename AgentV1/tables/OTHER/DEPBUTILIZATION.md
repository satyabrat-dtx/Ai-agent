# DB2ADMIN.DEPBUTILIZATION

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 14
- **Primary key**: `COMPANYCODE`, `DIVISIONCODE`, `DEPBAPPLICATIONCODE`, `MRNDLTMRNHEADERMRNPREFIXCODE`, `MRNDETAILMRNHEADERCODE`, `MRNDETAILLINEID`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 137360
...
| 2 | `DEPBAPPLICATIONCODE` | CHAR(12) | NOT NULL | PK | primary_key |  |
...
- `DEPBUTILIZATIONUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.DEPBUTILIZATION t
