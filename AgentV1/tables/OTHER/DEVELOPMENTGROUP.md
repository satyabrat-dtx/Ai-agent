...
- **Source**: `DB2ADMIN_DDL.sql` line 207847
...
|---|---|---|---|
| `DEVELOPMENTGROUP_DEVELOPMENTGROUP` | [`DEVELOPMENTREQUEST`](../OTHER/DEVELOPMENTREQUEST.md) | `DEVELOPMENTGROUPCODE` | `DEVELOPMENTREQUEST.DEVELOPMENTGROUPCODE = DEVELOPMENTGROUP.CODE` |

## Indexes

- `DEVELOPMENTGROUPUID` (ABSUNIQUEID)
...
SELECT t.CODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.DEVELOPMENTGROUP t
