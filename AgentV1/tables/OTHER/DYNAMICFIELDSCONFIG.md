...
- **Source**: `DB2ADMIN_DDL.sql` line 94721
...
| 5 | `PAGENAME` | CHAR(50) |  | FK | foreign_key |  |
...
|---|---|---|---|---|---|
| `ADIMAGE_PAGE` | `PAGENAME` | [`ADIMAGE`](../OTHER/ADIMAGE.md) | `NAME` | RESTRICT | `DYNAMICFIELDSCONFIG.PAGENAME = ADIMAGE.NAME` |
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `DYNAMICFIELDSCONFIG.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `DYNAMICFIELDSCONFIG_DETAIL` | [`DYNAMICFIELDSCONFIGDETAIL`](../OTHER/DYNAMICFIELDSCONFIGDETAIL.md) | `DYNAMICFIELDSCONFIGCOMPANYCODE`, `DYNAMICFIELDSCONFIGCODE` | `DYNAMICFIELDSCONFIGDETAIL.DYNAMICFIELDSCONFIGCOMPANYCODE = DYNAMICFIELDSCONFIG.COMPANYCODE AND DYNAMICFIELDSCONFIGDETAIL.DYNAMICFIELDSCONFIGCODE = DYNAMICFIELDSCONFIG.CODE` |

## Indexes

- `DYNAMICFIELDSCONFIGUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.DYNAMICFIELDSCONFIG t
