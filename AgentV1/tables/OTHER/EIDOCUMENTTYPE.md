...
- **Source**: `DB2ADMIN_DDL.sql` line 236329
...
| 4 | `SELFINVOICE` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|
| `EIDOCUMENTTYPE_EIDOCUMENTTYPE` | [`SALESORDERTEMPLATE`](../SALES/SALESORDERTEMPLATE.md) | `EIDOCUMENTTYPECODE` | `SALESORDERTEMPLATE.EIDOCUMENTTYPECODE = EIDOCUMENTTYPE.CODE` |
| `EIDOCUMENTTYPE_EIDOCUMENTTYPE` | [`EINVOICEBODY`](../EINVOICING/EINVOICEBODY.md) | `EIDOCUMENTTYPECODE` | `EINVOICEBODY.EIDOCUMENTTYPECODE = EIDOCUMENTTYPE.CODE` |

## Indexes

- `EIDOCUMENTTYPEUID` (ABSUNIQUEID)
...
SELECT t.CODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.EIDOCUMENTTYPE t
