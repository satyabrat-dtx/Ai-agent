# DB2ADMIN.FACTORYVSOPERATION

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 14
- **Primary key**: `COMPANYCODE`, `FACTORYCODE`, `CODE`
- **FK degree**: referenced by 0 constraint(s), references 2 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 153147
...
| 1 | `FACTORYCOMPANYCODE` | CHAR(3) | NOT NULL | FK | foreign_key |  |
| 2 | `FACTORYCODE` | CHAR(8) | NOT NULL | PK FK | primary_key foreign_key |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `FACTORYVSOPERATION.COMPANYCODE = COMPANY.CODE` |
| `PLANT_FACTORY` | `FACTORYCOMPANYCODE`, `FACTORYCODE` | [`PLANT`](../CORE_MASTER/PLANT.md) | `COMPANYCODE`, `CODE` | RESTRICT | `FACTORYVSOPERATION.FACTORYCOMPANYCODE = PLANT.COMPANYCODE AND FACTORYVSOPERATION.FACTORYCODE = PLANT.CODE` |
...
- `FACTORYVSOPERATIONUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.FACTORYVSOPERATION t
