# DB2ADMIN.FMSUTILIZATION

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 14
- **Primary key**: `COMPANYCODE`, `DIVISIONCODE`, `FMSAPPLICATIONCODE`, `MRNDLTMRNHEADERMRNPREFIXCODE`, `MRNDETAILMRNHEADERCODE`, `MRNDETAILLINEID`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 138915
...
| 2 | `FMSAPPLICATIONCODE` | CHAR(12) | NOT NULL | PK | primary_key |  |
...
FROM   DB2ADMIN.FMSUTILIZATION t
