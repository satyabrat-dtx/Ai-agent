# DB2ADMIN.FPSUTILIZATION

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 14
- **Primary key**: `COMPANYCODE`, `DIVISIONCODE`, `FPSAPPLICATIONCODE`, `MRNDLTMRNHEADERMRNPREFIXCODE`, `MRNDETAILMRNHEADERCODE`, `MRNDETAILLINEID`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 139195
...
| 2 | `FPSAPPLICATIONCODE` | CHAR(12) | NOT NULL | PK | primary_key |  |
...
FROM   DB2ADMIN.FPSUTILIZATION t
