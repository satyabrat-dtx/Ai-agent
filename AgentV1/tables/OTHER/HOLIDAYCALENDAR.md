...
- **Source**: `DB2ADMIN_DDL.sql` line 153552
...
| 2 | `FROMDATE` | DATE |  |  |  | Inclusive start of a validity period. |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `HOLIDAYCALENDAR.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `HOLIDAYCALENDAR_HOLIDAY` | [`HOLIDAYASSN`](../OTHER/HOLIDAYASSN.md) | `COMPANYCODE`, `HOLIDAYCODE` | `HOLIDAYASSN.COMPANYCODE = HOLIDAYCALENDAR.COMPANYCODE AND HOLIDAYASSN.HOLIDAYCODE = HOLIDAYCALENDAR.CODE` |
| `HOLIDAYCALENDAR_LINE` | [`HOLIDAYCALENDARDETAIL`](../OTHER/HOLIDAYCALENDARDETAIL.md) | `HOLIDAYCALENDARCOMPANYCODE`, `HOLIDAYCALENDARCODE` | `HOLIDAYCALENDARDETAIL.HOLIDAYCALENDARCOMPANYCODE = HOLIDAYCALENDAR.COMPANYCODE AND HOLIDAYCALENDARDETAIL.HOLIDAYCALENDARCODE = HOLIDAYCALENDAR.CODE` |

## Indexes

- `HOLIDAYCALENDARUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.HOLIDAYCALENDAR t
