...
- **Source**: `DB2ADMIN_DDL.sql` line 153688
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `ICSTABLE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `ICSTABLE_ICSTABLE` | [`ICSENTITY`](../CORE_MASTER/ICSENTITY.md) | `COMPANYCODE`, `ICSTABLECODE` | `ICSENTITY.COMPANYCODE = ICSTABLE.COMPANYCODE AND ICSENTITY.ICSTABLECODE = ICSTABLE.CODE` |
| `ICSTABLE_ICSTABLE` | [`NATIONALIDMASK`](../OTHER/NATIONALIDMASK.md) | `COMPANYCODE`, `ICSTABLECODE` | `NATIONALIDMASK.COMPANYCODE = ICSTABLE.COMPANYCODE AND NATIONALIDMASK.ICSTABLECODE = ICSTABLE.CODE` |

## Indexes

- `ICSTABLEUID` (ABSUNIQUEID)
