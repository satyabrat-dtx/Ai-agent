...
- **Source**: `DB2ADMIN_DDL.sql` line 124383
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `INVOICECATEGORY.COMPANYCODE = COMPANY.CODE` |
...
- `INVOICECATEGORYUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.INVOICECATEGORY t
