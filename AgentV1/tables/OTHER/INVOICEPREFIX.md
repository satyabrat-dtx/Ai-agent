...
- **Source**: `DB2ADMIN_DDL.sql` line 124425
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `INVOICEPREFIX.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `INVOICEPREFIX_PREFIXDETAIL` | [`INVOICEPREFIXDETAIL`](../OTHER/INVOICEPREFIXDETAIL.md) | `INVOICEPREFIXCOMPANYCODE`, `INVOICEPREFIXCODE` | `INVOICEPREFIXDETAIL.INVOICEPREFIXCOMPANYCODE = INVOICEPREFIX.COMPANYCODE AND INVOICEPREFIXDETAIL.INVOICEPREFIXCODE = INVOICEPREFIX.CODE` |

## Indexes

- `INVOICEPREFIXUID` (ABSUNIQUEID)
