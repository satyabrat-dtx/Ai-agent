...
- **Source**: `DB2ADMIN_DDL.sql` line 212175
...
|---|---|---|---|
| `NOTETYPE_NOTETYPE` | [`COMMENTS`](../CORE_MASTER/COMMENTS.md) | `NOTETYPECODE` | `COMMENTS.NOTETYPECODE = NOTETYPE.CODE` |

## Indexes

- `NOTETYPEUID` (ABSUNIQUEID)
