# DB2ADMIN.NOTIFICATIONMESSAGE

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 12
- **Primary key**: `COMPANYCODE`, `MESSAGECODE`
- **FK degree**: referenced by 1 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 190496
...
| 1 | `MESSAGECODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `NOTIFICATIONMESSAGE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `NOTIFICATIONMESSAGE_NOTIFICATIONMESSAGE` | [`STATUSRULEPOLICY`](../OTHER/STATUSRULEPOLICY.md) | `COMPANYCODE`, `NOTIFICATIONMESSAGEMESSAGECODE` | `STATUSRULEPOLICY.COMPANYCODE = NOTIFICATIONMESSAGE.COMPANYCODE AND STATUSRULEPOLICY.NOTIFICATIONMESSAGEMESSAGECODE = NOTIFICATIONMESSAGE.MESSAGECODE` |

## Indexes

- `NOTIFICATIONMESSAGEUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.NOTIFICATIONMESSAGE t
