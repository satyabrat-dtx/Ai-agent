...
- **Source**: `DB2ADMIN_DDL.sql` line 238731
...
| 1 | `ALLOWEDOLDEMPLOYEE` | INTEGER | NOT NULL |  |  |  |
| 2 | `DOCUMENT` | SMALLINT | NOT NULL |  |  |  |
| 3 | `NOMINATION` | SMALLINT | NOT NULL |  |  |  |
| 4 | `MEMBERSHIP` | SMALLINT | NOT NULL |  |  |  |
| 5 | `TRAINING` | SMALLINT | NOT NULL |  |  |  |
| 6 | `LANGUAGEDETAILS` | SMALLINT | NOT NULL |  |  |  |
| 7 | `EXPERIENCE` | SMALLINT | NOT NULL |  |  |  |
| 8 | `SKILL` | SMALLINT | NOT NULL |  |  |  |
| 9 | `EDUCATION` | SMALLINT | NOT NULL |  |  |  |
| 10 | `FAMILYDETAIL` | SMALLINT | NOT NULL |  |  |  |
| 11 | `SAPPOSTFLAG` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `OLDEMPLOYEEDATARULE.COMPANYCODE = COMPANY.CODE` |
...
- `OLDEMPLOYEEDATARULEUID` (ABSUNIQUEID)

## Starter query

```sql
SELECT t.COMPANYCODE,
       t.ALLOWEDOLDEMPLOYEE,
       t.DOCUMENT,
       t.NOMINATION,
       t.MEMBERSHIP,
       t.TRAINING,
       ...
       t.FAMILYDETAIL,
       t.SAPPOSTFLAG
FROM   DB2ADMIN.OLDEMPLOYEEDATARULE t
