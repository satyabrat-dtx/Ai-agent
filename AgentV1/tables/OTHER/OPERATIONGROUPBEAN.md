...
- **Source**: `DB2ADMIN_DDL.sql` line 83227
...
| 10 | `USECREATIONUSER` | SMALLINT | NOT NULL |  |  |  |
...
- `OPERATIONGROUPBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.IMPORTAUTOCOUNTER,
       ...
       t.USECREATIONUSER,
       t.WSOPERATION
FROM   DB2ADMIN.OPERATIONGROUPBEAN t
