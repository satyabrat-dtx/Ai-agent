# DB2ADMIN.OPVSITTYPEVSGENGRP

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 16
- **Primary key**: `COMPANYCODE`, `ITEMTYPECODE`, `USERGENERICGROUPTYPECODE`, `PRODUCTGROUPCODE`, `ORDERTYPE`, `ORDPRNCUSTOMERSUPPLIERCODE`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 109486
...
| 3 | `USERGENGROUPTYPECOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 4 | `USERGENERICGROUPTYPECODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
| 5 | `PRDGRPUSERGENGRPTYPECMYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 6 | `PRODUCTGROUPCODE` | CHAR(10) | NOT NULL | PK | primary_key |  |
| 7 | `ORDERTYPE` | CHAR(1) | NOT NULL | PK | primary_key |  |
| 8 | `ORDPRNCUSTOMERSUPPLIERCODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
...
- `OPVSITTYPEVSGENGRPUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.OPVSITTYPEVSGENGRP t
