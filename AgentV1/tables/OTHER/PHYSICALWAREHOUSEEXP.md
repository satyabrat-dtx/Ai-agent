...
- **Source**: `DB2ADMIN_DDL.sql` line 76984
...
| 2 | `EXPCODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
...
- `PHYSICALWAREHOUSEEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.PHYSICALWAREHOUSEEXP t
