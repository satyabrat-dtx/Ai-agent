...
- **Source**: `DB2ADMIN_DDL.sql` line 111295
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PMBOMCOMPONENTDETAIL.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `PMBOMCOMPONENTDETAIL_DETAIL` | [`PMCOMPONENTDETAIL`](../OTHER/PMCOMPONENTDETAIL.md) | `PMBOMCOMPANYCODE`, `DETAILCODE` | `PMCOMPONENTDETAIL.PMBOMCOMPANYCODE = PMBOMCOMPONENTDETAIL.COMPANYCODE AND PMCOMPONENTDETAIL.DETAILCODE = PMBOMCOMPONENTDETAIL.CODE` |

## Indexes

- `PMBOMCOMPONENTDETAILUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.PMBOMCOMPONENTDETAIL t
