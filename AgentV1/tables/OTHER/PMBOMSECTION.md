...
- **Source**: `DB2ADMIN_DDL.sql` line 111337
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PMBOMSECTION.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `PMBOMSECTION_SECTION` | [`PMMACHINESECTION`](../OTHER/PMMACHINESECTION.md) | `PMBOMCOMPANYCODE`, `SECTIONCODE` | `PMMACHINESECTION.PMBOMCOMPANYCODE = PMBOMSECTION.COMPANYCODE AND PMMACHINESECTION.SECTIONCODE = PMBOMSECTION.CODE` |

## Indexes

- `PMBOMSECTIONUID` (ABSUNIQUEID)
