# DB2ADMIN.PMBOMSECTIONCOMPONENT
...
- **Source**: `DB2ADMIN_DDL.sql` line 111379
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PMBOMSECTIONCOMPONENT.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `PMBOMSECTIONCOMPONENT_COMPONENT` | [`PMSECTIONCOMPONENT`](../OTHER/PMSECTIONCOMPONENT.md) | `PMMACHINESECTIONPMBOMCMYCODE`, `COMPONENTCODE` | `PMSECTIONCOMPONENT.PMMACHINESECTIONPMBOMCMYCODE = PMBOMSECTIONCOMPONENT.COMPANYCODE AND PMSECTIONCOMPONENT.COMPONENTCODE = PMBOMSECTIONCOMPONENT.CODE` |

## Indexes

- `PMBOMSECTIONCOMPONENTUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.PMBOMSECTIONCOMPONENT t
