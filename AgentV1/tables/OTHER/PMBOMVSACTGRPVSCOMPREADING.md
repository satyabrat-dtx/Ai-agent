# DB2ADMIN.PMBOMVSACTGRPVSCOMPREADING
...
- **Source**: `DB2ADMIN_DDL.sql` line 88806
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PMBOMVSACTGRPVSCOMPREADING.COMPANYCODE = COMPANY.CODE` |
| `PMACTIVITYGROUP_ACTIVITYGROUP` | `COMPANYCODE`, `ACTIVITYGROUPCOUNTERCODE`, `ACTIVITYGROUPCODE` | [`PMACTIVITYGROUP`](../PLATFORM/PMACTIVITYGROUP.md) | `COMPANYCODE`, `COUNTERCODE`, `CODE` | RESTRICT | `PMBOMVSACTGRPVSCOMPREADING.COMPANYCODE = PMACTIVITYGROUP.COMPANYCODE AND PMBOMVSACTGRPVSCOMPREADING.ACTIVITYGROUPCOUNTERCODE = PMACTIVITYGROUP.COUNTERCODE AND PMBOMVSACTGRPVSCOMPREADING.ACTIVITYGROUPCODE = PMACTIVITYGROUP.CODE` |
| `PMBOM_MACHINE` | `COMPANYCODE`, `MACHINECOUNTERCODE`, `MACHINECODE` | [`PMBOM`](../CORE_MASTER/PMBOM.md) | `COMPANYCODE`, `COUNTERCODE`, `CODE` | RESTRICT | `PMBOMVSACTGRPVSCOMPREADING.COMPANYCODE = PMBOM.COMPANYCODE AND PMBOMVSACTGRPVSCOMPREADING.MACHINECOUNTERCODE = PMBOM.COUNTERCODE AND PMBOMVSACTGRPVSCOMPREADING.MACHINECODE = PMBOM.CODE` |
| `PMWORKORDER_LASTWORKORDER` | `COMPANYCODE`, `LASTWORKORDERCOUNTERCODE`, `LASTWORKORDERCODE` | [`PMWORKORDER`](../INTERNAL_ORDERS/PMWORKORDER.md) | `COMPANYCODE`, `COUNTERCODE`, `CODE` | RESTRICT | `PMBOMVSACTGRPVSCOMPREADING.COMPANYCODE = PMWORKORDER.COMPANYCODE AND PMBOMVSACTGRPVSCOMPREADING.LASTWORKORDERCOUNTERCODE = PMWORKORDER.COUNTERCODE AND PMBOMVSACTGRPVSCOMPREADING.LASTWORKORDERCODE = PMWORKORDER.CODE` |
| `USERGENERICGROUP_HALLNO` | `HALLNOUSERGENGRPTYPECMYCODE`, `HALLNOUSERGENERICGROUPTYPECODE`, `HALLNOCODE` | [`USERGENERICGROUP`](../CORE_MASTER/USERGENERICGROUP.md) | `USERGENGROUPTYPECOMPANYCODE`, `USERGENERICGROUPTYPECODE`, `CODE` | RESTRICT | `PMBOMVSACTGRPVSCOMPREADING.HALLNOUSERGENGRPTYPECMYCODE = USERGENERICGROUP.USERGENGROUPTYPECOMPANYCODE AND PMBOMVSACTGRPVSCOMPREADING.HALLNOUSERGENERICGROUPTYPECODE = USERGENERICGROUP.USERGENERICGROUPTYPECODE AND PMBOMVSACTGRPVSCOMPREADING.HALLNOCODE = USERGENERICGROUP.CODE` |
...
- `PMBOMVSACTGRPVSCOMPREADINGUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.PMBOMVSACTGRPVSCOMPREADING t
