# DB2ADMIN.PMINSPECTIONFORCOMPRESSOR
...
- **Source**: `DB2ADMIN_DDL.sql` line 88975
...
| 13 | `NUMERICFIELD11` | DECIMAL(15,5) |  |  |  |  |
| 14 | `NUMERICFIELD12` | DECIMAL(15,5) |  |  |  |  |
| 15 | `NUMERICFIELD13` | DECIMAL(15,5) |  |  |  |  |
| 16 | `NUMERICFIELD14` | DECIMAL(15,5) |  |  |  |  |
| 17 | `NUMERICFIELD15` | DECIMAL(15,5) |  |  |  |  |
| 18 | `NUMERICFIELD16` | DECIMAL(15,5) |  |  |  |  |
| 19 | `NUMERICFIELD17` | DECIMAL(15,5) |  |  |  |  |
| 20 | `NUMERICFIELD18` | DECIMAL(15,5) |  |  |  |  |
| 21 | `NUMERICFIELD19` | DECIMAL(15,5) |  |  |  |  |
| 22 | `NUMERICFIELD20` | DECIMAL(15,5) |  |  |  |  |
| 23 | `INSPECTIONTIME` | TIMESTAMP |  |  |  |  |
| 24 | `STATUS` | INTEGER | NOT NULL |  |  |  |
| 25 | `INSPECTEDBY` | CHAR(30) |  |  |  |  |
| 26 | `REMARKS` | VARCHAR(1000) |  |  |  |  |
| 27 | `SHIFT` | CHAR(3) |  |  |  |  |
| 28 | `EMPLOYEECODE` | CHAR(10) |  |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PMINSPECTIONFORCOMPRESSOR.COMPANYCODE = COMPANY.CODE` |
...
- `PMINSPECTIONFORCOMPRESSORUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.NUMERICFIELD8,
       t.NUMERICFIELD9
FROM   DB2ADMIN.PMINSPECTIONFORCOMPRESSOR t
