# DB2ADMIN.PRIMROSEFULLORDPRNV61BEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 74165
...
| 359 | `ANAEORI` | CHAR(17) |  |  |  |  |
| 360 | `ANATITOL` | CHAR(10) |  |  |  |  |
| 361 | `INTERCOMPANYDIVISIONCODE` | CHAR(3) |  |  |  |  |
| 362 | `VATTAXCODE` | CHAR(5) |  |  |  |  |
| 363 | `IMPOPERATIONUSER` | CHAR(50) |  |  |  |  |
| 364 | `FO1TPCONT` | CHAR(1) |  |  |  |  |
| 365 | `CREATIONDATETIMEUTC2` | TIMESTAMP |  |  |  |  |
| 366 | `CREATIONDATETIMECMPDIV2` | TIMESTAMP |  |  |  |  |
| 367 | `CREATIONDATETIMEUSER2` | TIMESTAMP |  |  |  |  |
| 368 | `LASTUPDATEDATETIMEUTC2` | TIMESTAMP |  |  |  |  |
| 369 | `LASTUPDATEDATETIMECMPDIV2` | TIMESTAMP |  |  |  |  |
| 370 | `LASTUPDATEDATETIMEUSER2` | TIMESTAMP |  |  |  |  |
| 371 | `ASSOCIATIONMARK` | SMALLINT | NOT NULL |  |  |  |
| 372 | `ASSOCIATIONPRNCSMSUPPLIERCODE` | CHAR(8) |  |  |  |  |
| 373 | `ASSOCIATIONMEMBER` | CHAR(20) |  |  |  |  |
| 374 | `FISCALREPRESENTATIVENUMBERID` | DECIMAL(8,0) |  |  |  |  |
| 375 | `PERMESTABLISHMENTCODE` | CHAR(8) |  |  |  |  |
| 376 | `FISCALREPRESENTATIVEUNIQUEID` | BIGINT | NOT NULL |  |  |  |
| 377 | `GENDER` | CHAR(1) |  |  |  |  |
| 378 | `DATEOFBIRTH` | DATE |  |  |  |  |
| 379 | `COUNTRYOFBIRTHCODE` | CHAR(3) |  |  |  |  |
| 380 | `DISTRICTOFBIRTH` | VARCHAR(200) |  |  |  |  |
| 381 | `PLACEOFBIRTH` | VARCHAR(200) |  |  |  |  |
| 382 | `EDATATRANSFERTYPE` | CHAR(1) |  |  |  |  |
| 383 | `EDATATRANSFERUNIQUEID` | CHAR(50) |  |  |  |  |
| 384 | `EDATATRANSFEREMAIL` | CHAR(150) |  |  |  |  |
| 385 | `INTERDIVISIONLINKCODE` | CHAR(10) |  |  |  |  |
| 386 | `RFPARTNERCUSTOMERSUPPLIERCODE` | CHAR(8) |  |  |  |  |
| 387 | `INSURANCESELFRETENTION` | DECIMAL(5,2) |  |  |  |  |
| 388 | `ACTIONBUTTON` | CHAR(20) |  |  |  |  |
| 389 | `NATIONALITY` | CHAR(20) |  |  |  |  |
| 390 | `DUEDATEEXCEPTIONCODE` | CHAR(6) |  |  |  |  |
...
- `PRIMROSEFULLORDPRNV61BEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.PRIMROSEFULLORDPRNV61BEAN t
