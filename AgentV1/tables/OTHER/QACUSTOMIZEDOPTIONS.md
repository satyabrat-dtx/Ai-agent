...
- **Source**: `DB2ADMIN_DDL.sql` line 192806
...
| 1 | `ALLOWQAINPUTPRODORDERCLOSED` | INTEGER | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `QACUSTOMIZEDOPTIONS.COMPANYCODE = COMPANY.CODE` |
...
- `QACUSTOMIZEDOPTIONSUID` (ABSUNIQUEID)

## Starter query

```sql
SELECT t.COMPANYCODE,
       t.ALLOWQAINPUTPRODORDERCLOSED,
       t.CREATIONDATETIME,
       t.CREATIONUSER,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.QACUSTOMIZEDOPTIONS t
