...
- **Source**: `DB2ADMIN_DDL.sql` line 199158
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `QUICKRULECONFIG.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `QUICKRULECONFIG_MAPPINGS` | [`QUICKRULECONFIGMAPPING`](../OTHER/QUICKRULECONFIGMAPPING.md) | `QUICKRULECONFIGCOMPANYCODE`, `QUICKRULECONFIGCODE` | `QUICKRULECONFIGMAPPING.QUICKRULECONFIGCOMPANYCODE = QUICKRULECONFIG.COMPANYCODE AND QUICKRULECONFIGMAPPING.QUICKRULECONFIGCODE = QUICKRULECONFIG.CODE` |

## Indexes

- `QUICKRULECONFIGUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.QUICKRULECONFIG t
