...
- **Source**: `DB2ADMIN_DDL.sql` line 23211
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `RESOURCECATEGORY.COMPANYCODE = COMPANY.CODE` |
...
- `RESOURCECATEGORYUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.RESOURCECATEGORY t
