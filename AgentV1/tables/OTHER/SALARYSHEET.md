...
- **Source**: `DB2ADMIN_DDL.sql` line 162565
...
| 3 | `PAYROLLCODE` | CHAR(10) | NOT NULL | PK | primary_key |  |
...
| 8 | `DIVISIONCODE` | CHAR(10) | NOT NULL | PK | primary_key | Division within a company; second-level organisational discriminator. |
| 9 | `DIVISIONDESC` | VARCHAR(200) |  |  |  |  |
| 10 | `FACTORYCODE` | CHAR(10) | NOT NULL | PK | primary_key |  |
| 11 | `FACTORYDESC` | VARCHAR(200) |  |  |  |  |
| 12 | `DEPARTMENTCODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
| 13 | `DEPARTMENTDESC` | VARCHAR(200) |  |  |  |  |
| 14 | `CATEGORYCODE` | CHAR(10) | NOT NULL | PK | primary_key |  |
| 15 | `CATEGORYDESC` | VARCHAR(200) |  |  |  |  |
| 16 | `SUBCATEGORYCODE` | CHAR(10) | NOT NULL | PK | primary_key |  |
...
| 20 | `EMPLOYEECODE` | CHAR(15) | NOT NULL | PK | primary_key |  |
