# DB2ADMIN.SCHEDULESDOWNLOADDEMANDS

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 6
- **Primary key**: `ENVIRONMENTCODE`, `COMPANYCODE`, `COUNTERCODE`, `CODE`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 47254
...
| 4 | `TEMPLATECODE` | CHAR(3) | NOT NULL |  |  |  |
...
SELECT t.COMPANYCODE,
       ...
       t.TEMPLATECODE,
       t.EVERDOWNLOADED
FROM   DB2ADMIN.SCHEDULESDOWNLOADDEMANDS t
