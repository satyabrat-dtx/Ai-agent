# DB2ADMIN.SIZESDISTRIBUTIONDETAILBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 98436
...
| 2 | `SIZECODE` | CHAR(10) |  |  |  |  |
| 3 | `DISTRIBUTION` | DECIMAL(5,2) |  |  |  |  |
| 4 | `OWNINGCOMPANYCODE` | CHAR(3) |  |  |  |  |
...
- `FATHERID` → **SIZESDISTRIBUTION**.`ABSUNIQUEID` (high confidence — name = 'SIZESDISTRIBUTION' + known child suffix 'DETAIL')
  - JOIN predicate: `SIZESDISTRIBUTIONDETAILBEAN.FATHERID = SIZESDISTRIBUTION.ABSUNIQUEID`

## Indexes

- `SIZESDISTRIBUTIONDLTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.FATHERID,
       ...
       t.IMPLASTUPDATEUSER,
       t.IMPORTDATETIME
FROM   DB2ADMIN.SIZESDISTRIBUTIONDETAILBEAN t
