...
- **Source**: `DB2ADMIN_DDL.sql` line 207064
...
|---|---|---|---|
| `SKETCHTEMPLATE_DETAIL` | [`SKETCHTEMPLATEDETAIL`](../OTHER/SKETCHTEMPLATEDETAIL.md) | `SKETCHTEMPLATECOMPANYCODE`, `SKETCHTEMPLATECODE` | `SKETCHTEMPLATEDETAIL.SKETCHTEMPLATECOMPANYCODE = SKETCHTEMPLATE.COMPANYCODE AND SKETCHTEMPLATEDETAIL.SKETCHTEMPLATECODE = SKETCHTEMPLATE.CODE` |

## Indexes

- `SKETCHTEMPLATEUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.SEARCHDESCRIPTION,
       t.ABSUNIQUEID
FROM   DB2ADMIN.SKETCHTEMPLATE t
