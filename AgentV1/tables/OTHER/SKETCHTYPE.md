...
- **Source**: `DB2ADMIN_DDL.sql` line 211539
...
|---|---|---|---|
| `SKETCHTYPE_ITEMOFCLOTHING` | [`SKETCHTYPEDETAIL`](../OTHER/SKETCHTYPEDETAIL.md) | `COMPANYCODE`, `ITEMOFCLOTHINGCODE` | `SKETCHTYPEDETAIL.COMPANYCODE = SKETCHTYPE.COMPANYCODE AND SKETCHTYPEDETAIL.ITEMOFCLOTHINGCODE = SKETCHTYPE.CODE` |

## Indexes

- `SKETCHTYPEUID` (ABSUNIQUEID)
