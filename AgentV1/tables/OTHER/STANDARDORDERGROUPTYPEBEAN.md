# DB2ADMIN.STANDARDORDERGROUPTYPEBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 208054
...
| 2 | `ORDERTYPE` | CHAR(1) |  |  |  |  |
| 3 | `CODE` | CHAR(3) |  |  |  | Business (natural) key of a master-data table, typically the last primary-key column. |
...
- `STANDARDORDERGROUPTYPEBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.IMPORTAUTOCOUNTER,
       ...
       t.WSOPERATION,
       t.IMPOPERATIONUSER
FROM   DB2ADMIN.STANDARDORDERGROUPTYPEBEAN t
