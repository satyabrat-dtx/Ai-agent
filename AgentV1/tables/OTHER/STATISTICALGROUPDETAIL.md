# DB2ADMIN.STATISTICALGROUPDETAIL

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 21
- **Primary key**: `STATISTICALGROUPCOMPANYCODE`, `STATISTICALGROUPCODE`, `ITEMTYPEAFICODE`, `SUBCODE01`, `SUBCODE02`, `SUBCODE03`, `SUBCODE04`, `SUBCODE05`, `SUBCODE06`, `SUBCODE07`, `SUBCODE08`, `SUBCODE09`, `SUBCODE10`
- **FK degree**: referenced by 0 constraint(s), references 2 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 20100

## Columns

| # | Column | Type | Null | Key | Tags | Meaning |
|---|--------|------|------|-----|------|---------|
| 0 | `STATISTICALGROUPCOMPANYCODE` | CHAR(3) | NOT NULL | PK FK | primary_key foreign_key |  |
| 1 | `STATISTICALGROUPCODE` | CHAR(6) | NOT NULL | PK FK | primary_key foreign_key |  |
...
|---|---|---|---|---|---|
| `ITEMTYPE_ITEMTYPEAFI` | `ITEMTYPEAFICOMPANYCODE`, `ITEMTYPEAFICODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `STATISTICALGROUPDETAIL.ITEMTYPEAFICOMPANYCODE = ITEMTYPE.COMPANYCODE AND STATISTICALGROUPDETAIL.ITEMTYPEAFICODE = ITEMTYPE.CODE` |
| `STATISTICALGROUP_DETAIL` | `STATISTICALGROUPCOMPANYCODE`, `STATISTICALGROUPCODE` | [`STATISTICALGROUP`](../CORE_MASTER/STATISTICALGROUP.md) | `COMPANYCODE`, `CODE` | RESTRICT | `STATISTICALGROUPDETAIL.STATISTICALGROUPCOMPANYCODE = STATISTICALGROUP.COMPANYCODE AND STATISTICALGROUPDETAIL.STATISTICALGROUPCODE = STATISTICALGROUP.CODE` |
...
- `STATISTICALGROUPDETAILUID` (ABSUNIQUEID)

## Starter query

```sql
SELECT t.STATISTICALGROUPCOMPANYCODE,
       ...
       t.SUBCODE08,
       t.SUBCODE09
FROM   DB2ADMIN.STATISTICALGROUPDETAIL t
