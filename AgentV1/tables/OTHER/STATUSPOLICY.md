...
- **Source**: `DB2ADMIN_DDL.sql` line 190655
...
| 5 | `POLICYCODECODE` | CHAR(20) |  |  |  |  |
| 6 | `HASQUANTITYLIMITS` | SMALLINT | NOT NULL |  |  |  |
| 7 | `HASTEMPLATELIMITS` | SMALLINT | NOT NULL |  |  |  |
...
| 15 | `HASDIVISIONLIMITS` | SMALLINT | NOT NULL |  |  |  |

## References (this table → parent) — 1

| Constraint | Local columns | → Table | → Columns | ON DELETE | JOIN predicate |
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `STATUSPOLICY.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `STATUSPOLICY_STATUSPOLICYCODE` | [`STATUSRULEPOLICY`](../OTHER/STATUSRULEPOLICY.md) | `COMPANYCODE`, `STATUSPOLICYCODECODE` | `STATUSRULEPOLICY.COMPANYCODE = STATUSPOLICY.COMPANYCODE AND STATUSRULEPOLICY.STATUSPOLICYCODECODE = STATUSPOLICY.CODE` |

## Indexes

- `STATUSPOLICYUID` (ABSUNIQUEID)
