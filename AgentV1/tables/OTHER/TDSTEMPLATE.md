...
- **Source**: `DB2ADMIN_DDL.sql` line 123782
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `TDSTEMPLATE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `TDSTEMPLATE_TDSTEMPLATE` | [`MRNHEADER`](../CORE_MASTER/MRNHEADER.md) | `COMPANYCODE`, `TDSTEMPLATECODE` | `MRNHEADER.COMPANYCODE = TDSTEMPLATE.COMPANYCODE AND MRNHEADER.TDSTEMPLATECODE = TDSTEMPLATE.CODE` |

## Indexes

- `TDSTEMPLATEUID` (ABSUNIQUEID)
