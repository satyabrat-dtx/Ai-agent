...
- **Source**: `DB2ADMIN_DDL.sql` line 77255
...
| 2 | `EXPCODE` | CHAR(2) | NOT NULL | PK | primary_key |  |
...
- `TERMSOFSHIPPINGEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.TERMSOFSHIPPINGEXP t
