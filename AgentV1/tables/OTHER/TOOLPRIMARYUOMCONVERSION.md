# DB2ADMIN.TOOLPRIMARYUOMCONVERSION

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 16
- **Primary key**: `TOOLCOMPANYCODE`, `TOOLITEMTYPECODE`, `TOOLSUBCODE01`, `UNITOFMEASURECODE`
- **FK degree**: referenced by 0 constraint(s), references 3 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 3355
...
|---|---|---|---|---|---|
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `TOOLPRIMARYUOMCONVERSION.OWNINGCOMPANYCODE = COMPANY.CODE` |
| `TOOL_PRIMARYCONVERSION` | `TOOLCOMPANYCODE`, `TOOLITEMTYPECODE`, `TOOLSUBCODE01` | [`TOOL`](../CORE_MASTER/TOOL.md) | `COMPANYCODE`, `ITEMTYPECODE`, `SUBCODE01` | RESTRICT | `TOOLPRIMARYUOMCONVERSION.TOOLCOMPANYCODE = TOOL.COMPANYCODE AND TOOLPRIMARYUOMCONVERSION.TOOLITEMTYPECODE = TOOL.ITEMTYPECODE AND TOOLPRIMARYUOMCONVERSION.TOOLSUBCODE01 = TOOL.SUBCODE01` |
| `UNITOFMEASURE_UNITOFMEASURE` | `UNITOFMEASURECODE` | [`UNITOFMEASURE`](../CORE_MASTER/UNITOFMEASURE.md) | `CODE` | RESTRICT | `TOOLPRIMARYUOMCONVERSION.UNITOFMEASURECODE = UNITOFMEASURE.CODE` |
...
- `TOOLPRIMARYUOMCONVERSIONUID` (ABSUNIQUEID)
...
SELECT t.TOOLCOMPANYCODE,
       ...
       t.LASTUPDATEUSER
FROM   DB2ADMIN.TOOLPRIMARYUOMCONVERSION t
