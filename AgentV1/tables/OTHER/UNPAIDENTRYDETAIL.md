# DB2ADMIN.UNPAIDENTRYDETAIL

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `ABSUNIQUEID`, `COMPANYCODE`, `SERIALNO`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 169485
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `UNPAIDENTRYDETAIL.COMPANYCODE = COMPANY.CODE` |
...
- `UNPAIDENTRYDETAILUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.UNPAIDENTRYDETAIL t
