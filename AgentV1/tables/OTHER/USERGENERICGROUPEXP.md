# DB2ADMIN.USERGENERICGROUPEXP

- **Module**: `OTHER` (none confidence — no known prefix matched)
- **Roles**: `business_data`
- **Columns**: 10
- **Primary key**: `ENVIRONMENTCODE`, `EXPCOMPANYCODE`, `EXPGROUPTYPECODE`, `EXPCODE`, `UNIQUEIDPK`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 77296
...
| 2 | `EXPGROUPTYPECODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
| 3 | `EXPCODE` | CHAR(10) | NOT NULL | PK | primary_key |  |
...
- `USERGENERICGROUPEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.USERGENERICGROUPEXP t
