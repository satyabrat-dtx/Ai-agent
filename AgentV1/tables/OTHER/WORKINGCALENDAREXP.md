...
- **Source**: `DB2ADMIN_DDL.sql` line 90323
...
| 1 | `EXPCODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
...
- `WORKINGCALENDAREXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.WORKINGCALENDAREXP t
