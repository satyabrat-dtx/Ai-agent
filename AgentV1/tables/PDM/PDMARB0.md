...
- **Roles**: `business_data`
- **Columns**: 17
- **Primary key**: `COMPANYCODE`, `ITEMTYPECODE`, `SUBCODE01`, `SUBCODE02`, `SUBCODE03`, `SUBCODE04`, `SUBCODE05`, `SUBCODE06`, `SUBCODE07`, `SUBCODE08`, `SUBCODE09`, `SUBCODE10`, `COUNTER`
- **FK degree**: referenced by 0 constraint(s), references 2 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 46009
...
| 12 | `COUNTER` | INTEGER | NOT NULL | PK | primary_key |  |
| 13 | `BARTYPECODE` | CHAR(2) |  | FK | foreign_key |  |
| 14 | `BARCODE` | VARCHAR(50) |  |  |  |  |
| 15 | `ITEMTYPECOMPANYCODE` | CHAR(3) | NOT NULL | FK | foreign_key |  |
...
|---|---|---|---|---|---|
| `BARCODETYPE_BARTYPE` | `BARTYPECODE` | [`BARCODETYPE`](../CORE_MASTER/BARCODETYPE.md) | `CODE` | RESTRICT | `PDMARB0.BARTYPECODE = BARCODETYPE.CODE` |
| `ITEMTYPE_ITEMTYPE` | `ITEMTYPECOMPANYCODE`, `ITEMTYPECODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `PDMARB0.ITEMTYPECOMPANYCODE = ITEMTYPE.COMPANYCODE AND PDMARB0.ITEMTYPECODE = ITEMTYPE.CODE` |
