# DB2ADMIN.ABSCALENDAREVENTATTENDEE

- **Module**: `PLATFORM` (high confidence — table name starts with 'ABS')
- **Roles**: `business_data`
- **Columns**: 8
- **Primary key**: `ABSCALENDAREVENTINVUUID`, `ADDRESSTYPE`, `ATTENDEE`, `ATTENDEEINTERNALUSERID`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 117648
...
|---|---|---|---|---|---|
| `ABSCALENDAREVENT_ATTENDEES` | `ABSCALENDAREVENTINVUUID` | [`ABSCALENDAREVENT`](../PLATFORM/ABSCALENDAREVENT.md) | `INVUUID` | RESTRICT | `ABSCALENDAREVENTATTENDEE.ABSCALENDAREVENTINVUUID = ABSCALENDAREVENT.INVUUID` |
...
- `ABSCALENDAREVENTATTENDEEUID` (ABSUNIQUEID)
...
SELECT t.ABSCALENDAREVENTINVUUID,
       ...
       t.VALIDSENTADDRESS,
       t.ABSUNIQUEID
FROM   DB2ADMIN.ABSCALENDAREVENTATTENDEE t
