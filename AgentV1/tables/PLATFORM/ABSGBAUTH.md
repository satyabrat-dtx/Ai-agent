...
- **Roles**: `business_data`
- **Columns**: 13
- **Primary key**: `ABSGBABSUIXMLPATH`, `ABSGBABSUIXMLNAME`, `ABSGBCODE`, `USERUSERID`, `COMPANYCODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 15855

## Columns

| # | Column | Type | Null | Key | Tags | Meaning |
|---|--------|------|------|-----|------|---------|
| 0 | `ABSGBABSUIXMLPATH` | VARCHAR(50) | NOT NULL | PK FK | primary_key foreign_key |  |
| 1 | `ABSGBABSUIXMLNAME` | VARCHAR(54) | NOT NULL | PK FK | primary_key foreign_key |  |
| 2 | `ABSGBCODE` | CHAR(30) | NOT NULL | PK FK | primary_key foreign_key |  |
...
|---|---|---|---|---|---|
| `ABSGB_AUTHORIZATIONS` | `ABSGBABSUIXMLPATH`, `ABSGBABSUIXMLNAME`, `ABSGBCODE` | [`ABSGB`](../PLATFORM/ABSGB.md) | `ABSUIXMLPATH`, `ABSUIXMLNAME`, `CODE` | RESTRICT | `ABSGBAUTH.ABSGBABSUIXMLPATH = ABSGB.ABSUIXMLPATH AND ABSGBAUTH.ABSGBABSUIXMLNAME = ABSGB.ABSUIXMLNAME AND ABSGBAUTH.ABSGBCODE = ABSGB.CODE` |
...
- `ABSGBAUTHUID` (ABSUNIQUEID)

## Starter query

```sql
SELECT t.ABSGBABSUIXMLPATH,
       t.ABSGBABSUIXMLNAME,
       t.ABSGBCODE,
       t.USERUSERID,
       t.COMPANYCODE,
