# DB2ADMIN.ABSREPORTDEFAUTH

- **Module**: `PLATFORM` (high confidence — table name starts with 'ABS')
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `ABSREPORTDEFCODE`, `USERUSERID`, `COMPANYCODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 23402
...
| 3 | `PRINTALLOWED` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `ABSREPORTDEF_AUTHORIZATIONS` | `ABSREPORTDEFCODE` | [`ABSREPORTDEF`](../PLATFORM/ABSREPORTDEF.md) | `CODE` | RESTRICT | `ABSREPORTDEFAUTH.ABSREPORTDEFCODE = ABSREPORTDEF.CODE` |
...
- `ABSREPORTDEFAUTHUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.ABSREPORTDEFAUTH t
