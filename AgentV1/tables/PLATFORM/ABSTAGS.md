...
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `COMPANYCODE`, `TAGCATEGORY`, `TAGKEY`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 214042
...
| 1 | `TAGCATEGORY` | VARCHAR(255) | NOT NULL | PK | primary_key |  |
| 2 | `TAGKEY` | VARCHAR(255) | NOT NULL | PK | primary_key |  |
| 3 | `TAGVALUE` | VARCHAR(255) | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `ABSCOMPANY_COMPANY` | `COMPANYCODE` | [`ABSCOMPANY`](../PLATFORM/ABSCOMPANY.md) | `CODE` | RESTRICT | `ABSTAGS.COMPANYCODE = ABSCOMPANY.CODE` |
...
- child `ABSTAGSLANGUAGE`.`FATHERID` → this table's `ABSUNIQUEID` (high confidence)

## Indexes

- `ABSTAGSUID` (ABSUNIQUEID)
