...
- **Source**: `DB2ADMIN_DDL.sql` line 112397
...
| 5 | `STATEMENT` | CLOB(1000000) | NOT NULL |  |  |  |
| 6 | `CONNECTIONNAME` | CHAR(100) |  |  |  |  |
...
| 14 | `LIMITUSAGETOUSERS` | SMALLINT | NOT NULL |  |  |  |
| 15 | `AUTHORIZEDUSERS` | VARCHAR(3000) |  |  |  |  |

## References (this table → parent) — 1

| Constraint | Local columns | → Table | → Columns | ON DELETE | JOIN predicate |
|---|---|---|---|---|---|
| `ABSCOMPANY_COMPANY` | `COMPANYCODE` | [`ABSCOMPANY`](../PLATFORM/ABSCOMPANY.md) | `CODE` | RESTRICT | `SAVEDSTATEMENT.COMPANYCODE = ABSCOMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `SAVEDSTATEMENT_ANCHORS` | [`STATEMENTANCHORS`](../PLATFORM/STATEMENTANCHORS.md) | `SAVEDSTATEMENTCOMPANYCODE`, `SAVEDSTATEMENTCODE` | `STATEMENTANCHORS.SAVEDSTATEMENTCOMPANYCODE = SAVEDSTATEMENT.COMPANYCODE AND STATEMENTANCHORS.SAVEDSTATEMENTCODE = SAVEDSTATEMENT.CODE` |

## Indexes

- `SAVEDSTATEMENTUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.LASTUPDATEUSER,
       t.ABSUNIQUEID
FROM   DB2ADMIN.SAVEDSTATEMENT t
