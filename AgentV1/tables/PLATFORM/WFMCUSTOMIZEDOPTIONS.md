...
- **Source**: `DB2ADMIN_DDL.sql` line 96882
...
| 7 | `WFMOAUTHBASEURI` | VARCHAR(250) | NOT NULL |  |  |  |
| 8 | `DONOTSYNCEMAILTOWFM` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `ABSCOMPANY_COMPANY` | `COMPANYCODE` | [`ABSCOMPANY`](../PLATFORM/ABSCOMPANY.md) | `CODE` | RESTRICT | `WFMCUSTOMIZEDOPTIONS.COMPANYCODE = ABSCOMPANY.CODE` |
...
- `WFMCUSTOMIZEDOPTIONSUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.WFMHISTORYBASEURI,
       t.WFMOAUTHBASEURI,
       t.DONOTSYNCEMAILTOWFM,
       t.CREATIONDATETIME,
       t.CREATIONUSER,
       t.LASTUPDATEDATETIME
FROM   DB2ADMIN.WFMCUSTOMIZEDOPTIONS t
