...
- **Source**: `DB2ADMIN_DDL.sql` line 24051
...
| 5 | `PESSIMISTICVIEW` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COLUMNGROUP.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `COLUMNGROUP_COLUMNLABEL` | [`COLUMNLABEL`](../PRODUCTION/COLUMNLABEL.md) | `COLUMNGROUPCOMPANYCODE`, `COLUMNGROUPCODE` | `COLUMNLABEL.COLUMNGROUPCOMPANYCODE = COLUMNGROUP.COMPANYCODE AND COLUMNLABEL.COLUMNGROUPCODE = COLUMNGROUP.CODE` |

## Indexes

- `COLUMNGROUPUID` (ABSUNIQUEID)
