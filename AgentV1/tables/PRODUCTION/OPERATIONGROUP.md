...
- **Source**: `DB2ADMIN_DDL.sql` line 25234
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `OPERATIONGROUP.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `OPERATIONGROUP_OPERATIONGROUP` | [`OPERATION`](../PRODUCTION/OPERATION.md) | `COMPANYCODE`, `OPERATIONGROUPCODE` | `OPERATION.COMPANYCODE = OPERATIONGROUP.COMPANYCODE AND OPERATION.OPERATIONGROUPCODE = OPERATIONGROUP.CODE` |

## Indexes

- `OPERATIONGROUPUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.OPERATIONGROUP t
