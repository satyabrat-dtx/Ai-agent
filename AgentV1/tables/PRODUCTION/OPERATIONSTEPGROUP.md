...
- **Source**: `DB2ADMIN_DDL.sql` line 31268
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `OPERATIONSTEPGROUP.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `OPERATIONSTEPGROUP_OPSTEPGROUP` | [`WORKCENTERANDOPERATTRIBUTES`](../PRODUCTION/WORKCENTERANDOPERATTRIBUTES.md) | `COMPANYCODE`, `OPSTEPGROUPCODE` | `WORKCENTERANDOPERATTRIBUTES.COMPANYCODE = OPERATIONSTEPGROUP.COMPANYCODE AND WORKCENTERANDOPERATTRIBUTES.OPSTEPGROUPCODE = OPERATIONSTEPGROUP.CODE` |

## Indexes

- `OPERATIONSTEPGROUPUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.OPERATIONSTEPGROUP t
