# DB2ADMIN.PERIODRESERVATIONCREATIONTYPE
...
- **Source**: `DB2ADMIN_DDL.sql` line 1307
...
| 5 | `TIMEFORCALCULATERESDATE` | CHAR(2) | NOT NULL |  |  |  |
| 6 | `TYPE` | CHAR(2) | NOT NULL |  |  |  |
| 7 | `NUMBERDAYSFIRSTPERIOD` | DECIMAL(3,0) | NOT NULL |  |  |  |
| 8 | `NUMBERDAYSNEXTPERIOD` | DECIMAL(3,0) | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PERIODRESERVATIONCREATIONTYPE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `PERIODRESERVATIONCREATIONTYPE_PERIODRESCREATIONTYPE` | [`PRODUCTIONRESERVATIONGROUP`](../PRODUCTION/PRODUCTIONRESERVATIONGROUP.md) | `COMPANYCODE`, `PERIODRESCREATIONTYPECODE` | `PRODUCTIONRESERVATIONGROUP.COMPANYCODE = PERIODRESERVATIONCREATIONTYPE.COMPANYCODE AND PRODUCTIONRESERVATIONGROUP.PERIODRESCREATIONTYPECODE = PERIODRESERVATIONCREATIONTYPE.CODE` |

## Indexes

- `PERRESERVATIONCREATIONTYPEUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.SHORTDESCRIPTION,
       t.SEARCHDESCRIPTION,
       t.TIMEFORCALCULATERESDATE,
       t.TYPE,
       t.NUMBERDAYSFIRSTPERIOD,
       t.NUMBERDAYSNEXTPERIOD,
       t.CREATIONDATETIME,
       t.CREATIONUSER,
       t.LASTUPDATEDATETIME
FROM   DB2ADMIN.PERIODRESERVATIONCREATIONTYPE t
