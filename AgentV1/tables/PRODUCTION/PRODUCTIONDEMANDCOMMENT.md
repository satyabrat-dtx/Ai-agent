# DB2ADMIN.PRODUCTIONDEMANDCOMMENT

- **Module**: `PRODUCTION` (high confidence — table name starts with 'PRODUCTION')
- **Roles**: `business_data`
- **Columns**: 16
- **Primary key**: `PRODUCTIONDEMANDCOMPANYCODE`, `PRODUCTIONDEMANDCOUNTERCODE`, `PRODUCTIONDEMANDCODE`, `ORIGIN`, `CODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 13740
...
|---|---|---|---|---|---|
| `PRODUCTIONDEMAND_COMMENTS` | `PRODUCTIONDEMANDCOMPANYCODE`, `PRODUCTIONDEMANDCOUNTERCODE`, `PRODUCTIONDEMANDCODE` | [`PRODUCTIONDEMAND`](../PRODUCTION/PRODUCTIONDEMAND.md) | `COMPANYCODE`, `COUNTERCODE`, `CODE` | RESTRICT | `PRODUCTIONDEMANDCOMMENT.PRODUCTIONDEMANDCOMPANYCODE = PRODUCTIONDEMAND.COMPANYCODE AND PRODUCTIONDEMANDCOMMENT.PRODUCTIONDEMANDCOUNTERCODE = PRODUCTIONDEMAND.COUNTERCODE AND PRODUCTIONDEMANDCOMMENT.PRODUCTIONDEMANDCODE = PRODUCTIONDEMAND.CODE` |
...
- `PRODUCTIONDEMANDCOMMENTUID` (ABSUNIQUEID)
...
SELECT t.PRODUCTIONDEMANDCOMPANYCODE,
       ...
       t.CREATIONDATETIME,
       t.CREATIONUSER
FROM   DB2ADMIN.PRODUCTIONDEMANDCOMMENT t
