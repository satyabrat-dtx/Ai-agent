# DB2ADMIN.PRODUCTIONDEMANDCOMMENTBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 91637
...
- `FATHERID` → **PRODUCTIONDEMAND**.`ABSUNIQUEID` (high confidence — name = 'PRODUCTIONDEMAND' + known child suffix 'COMMENT')
  - JOIN predicate: `PRODUCTIONDEMANDCOMMENTBEAN.FATHERID = PRODUCTIONDEMAND.ABSUNIQUEID`

## Indexes

- `PRODEMANDCOMMENTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.REPORTTYPE,
       ...
       t.IMPCREATIONUSER
FROM   DB2ADMIN.PRODUCTIONDEMANDCOMMENTBEAN t
