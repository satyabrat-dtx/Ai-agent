# DB2ADMIN.PRODUCTIONDEMANDSTEPEXP

- **Module**: `PRODUCTION` (high confidence — table name starts with 'PRODUCTION')
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `ENVIRONMENTCODE`, `EXPPRODUCTIONDEMANDCOMPANYCODE`, `EXPPRODUCTIONDEMANDCOUNTERCODE`, `EXPPRODUCTIONDEMANDCODE`, `EXPSTEPNUMBER`, `UNIQUEIDPK`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 77800
...
- `PRODUCTIONDEMANDSTEPEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.PRODUCTIONDEMANDSTEPEXP t
