...
- **Source**: `DB2ADMIN_DDL.sql` line 28700
...
| 2 | `BLOCKINSTALLED` | SMALLINT | NOT NULL |  |  |  |
| 3 | `ALLOCATIONINSTALLED` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PRODUCTIONTAILORING.COMPANYCODE = COMPANY.CODE` |
...
- `PRODUCTIONTAILORINGUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.PRODUCTIONTAILORING t
