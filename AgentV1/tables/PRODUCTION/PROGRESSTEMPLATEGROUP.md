# DB2ADMIN.PROGRESSTEMPLATEGROUP
...
- **Source**: `DB2ADMIN_DDL.sql` line 44552
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PROGRESSTEMPLATEGROUP.COMPANYCODE = COMPANY.CODE` |
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PROGRESSTEMPLATEGROUP.OWNINGCOMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `PROGRESSTEMPLATEGROUP_PROGRESSTEMPLATEGROUP` | [`PRODUCTIONPROGRESSTEMPLATE`](../PRODUCTION/PRODUCTIONPROGRESSTEMPLATE.md) | `PROGRESSTMPGROUPCOMPANYCODE`, `PROGRESSTEMPLATEGROUPCODE` | `PRODUCTIONPROGRESSTEMPLATE.PROGRESSTMPGROUPCOMPANYCODE = PROGRESSTEMPLATEGROUP.COMPANYCODE AND PRODUCTIONPROGRESSTEMPLATE.PROGRESSTEMPLATEGROUPCODE = PROGRESSTEMPLATEGROUP.CODE` |

## Indexes

- `PROGRESSTEMPLATEGROUPUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.PROGRESSTEMPLATEGROUP t
