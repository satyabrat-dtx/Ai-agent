...
- **Source**: `DB2ADMIN_DDL.sql` line 20196
...
| 10 | `RESOURCETYPE` | CHAR(1) | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `RESOURCEGROUP.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `RESOURCEGROUP_DETAIL` | [`RESOURCEGROUPDETAIL`](../PRODUCTION/RESOURCEGROUPDETAIL.md) | `RESOURCEGROUPCOMPANYCODE`, `RESOURCEGROUPCODE` | `RESOURCEGROUPDETAIL.RESOURCEGROUPCOMPANYCODE = RESOURCEGROUP.COMPANYCODE AND RESOURCEGROUPDETAIL.RESOURCEGROUPCODE = RESOURCEGROUP.CODE` |

## Indexes

- `RESOURCEGROUPUID` (ABSUNIQUEID)
