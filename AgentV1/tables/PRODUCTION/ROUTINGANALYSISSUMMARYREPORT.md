# DB2ADMIN.ROUTINGANALYSISSUMMARYREPORT
...
- **Source**: `DB2ADMIN_DDL.sql` line 27476
...
| 30 | `PRODUCTIONROUTINGMANAGEMENT` | SMALLINT | NOT NULL |  |  |  |
| 31 | `COSTCLCROUTINGMANAGEMENT` | SMALLINT | NOT NULL |  |  |  |
| 32 | `GENERICREFERENCE` | CHAR(20) |  |  |  |  |
| 33 | `PLANTCODE` | CHAR(8) |  | FK | foreign_key |  |
| 34 | `COSTGROUPCODE` | CHAR(3) |  | FK | foreign_key |  |
| 35 | `ROUTINGUOMTYPE` | CHAR(2) |  |  |  |  |
| 36 | `ROUTINGUOMCODE` | CHAR(3) |  | FK | foreign_key |  |
| 37 | `STDPRODUCTIONBATCH` | DECIMAL(15,5) |  |  |  |  |
| 38 | `ROUTINGINCIDENCE` | DECIMAL(5,2) |  |  |  |  |
| 39 | `STATUS` | CHAR(1) |  |  |  |  |
| 40 | `APPROVALDATE` | DATE |  |  |  |  |
| 41 | `APPROVALUSER` | CHAR(50) |  |  |  |  |
| 42 | `RELEASEDATE` | DATE |  |  |  |  |
| 43 | `RELEASEUSER` | CHAR(50) |  |  |  |  |
| 44 | `ITEMTYPECOMPANYCODE` | CHAR(3) |  | FK | foreign_key |  |
| 45 | `PLANTCOMPANYCODE` | CHAR(3) |  | FK | foreign_key |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `ROUTINGANALYSISSUMMARYREPORT.COMPANYCODE = COMPANY.CODE` |
| `COSTGROUP_COSTGROUP` | `COMPANYCODE`, `COSTGROUPCODE` | [`COSTGROUP`](../COSTING/COSTGROUP.md) | `COMPANYCODE`, `CODE` | RESTRICT | `ROUTINGANALYSISSUMMARYREPORT.COMPANYCODE = COSTGROUP.COMPANYCODE AND ROUTINGANALYSISSUMMARYREPORT.COSTGROUPCODE = COSTGROUP.CODE` |
| `ITEMTYPE_ITEMTYPE` | `ITEMTYPECOMPANYCODE`, `ITEMTYPECODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `ROUTINGANALYSISSUMMARYREPORT.ITEMTYPECOMPANYCODE = ITEMTYPE.COMPANYCODE AND ROUTINGANALYSISSUMMARYREPORT.ITEMTYPECODE = ITEMTYPE.CODE` |
| `PLANT_PLANT` | `PLANTCOMPANYCODE`, `PLANTCODE` | [`PLANT`](../CORE_MASTER/PLANT.md) | `COMPANYCODE`, `CODE` | RESTRICT | `ROUTINGANALYSISSUMMARYREPORT.PLANTCOMPANYCODE = PLANT.COMPANYCODE AND ROUTINGANALYSISSUMMARYREPORT.PLANTCODE = PLANT.CODE` |
| `UNITOFMEASURE_ROUTINGUOM` | `ROUTINGUOMCODE` | [`UNITOFMEASURE`](../CORE_MASTER/UNITOFMEASURE.md) | `CODE` | RESTRICT | `ROUTINGANALYSISSUMMARYREPORT.ROUTINGUOMCODE = UNITOFMEASURE.CODE` |
...
- `RTGANALYSISSUMMARYREPORTUID` (ABSUNIQUEID)
...
SELECT t.IDENTIFIER,
       ...
       t.SUBCODE06,
       t.SUBCODE07
FROM   DB2ADMIN.ROUTINGANALYSISSUMMARYREPORT t
