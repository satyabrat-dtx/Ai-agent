# DB2ADMIN.ROUTINGITEMSUBCODETEMPLATE
...
- **Source**: `DB2ADMIN_DDL.sql` line 28394
...
|---|---|---|---|---|---|
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `ROUTINGITEMSUBCODETEMPLATE.OWNINGCOMPANYCODE = COMPANY.CODE` |
| `ITEMSUBCODECHECKTYPE_CHECK` | `CHECKCODE` | [`ITEMSUBCODECHECKTYPE`](../ITEM_MASTER/ITEMSUBCODECHECKTYPE.md) | `CODE` | RESTRICT | `ROUTINGITEMSUBCODETEMPLATE.CHECKCODE = ITEMSUBCODECHECKTYPE.CODE` |
| `ITEMTYPE_ROUTINGITEMSUBCODETEMPLATE` | `ITEMTYPECOMPANYCODE`, `ITEMTYPECODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `ROUTINGITEMSUBCODETEMPLATE.ITEMTYPECOMPANYCODE = ITEMTYPE.COMPANYCODE AND ROUTINGITEMSUBCODETEMPLATE.ITEMTYPECODE = ITEMTYPE.CODE` |
...
- `ROUTINGITEMSUBCODETEMPLATEUID` (ABSUNIQUEID)
...
SELECT t.ITEMTYPECOMPANYCODE,
       ...
       t.LONGDESCRIPTION,
       t.SHORTDESCRIPTION
FROM   DB2ADMIN.ROUTINGITEMSUBCODETEMPLATE t
