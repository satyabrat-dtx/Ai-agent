...
- **Source**: `DB2ADMIN_DDL.sql` line 3604
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `THERMALROUTING.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `THERMALROUTING_THERMALROUTING` | [`WORKCENTERANDOPERCOSTS`](../PRODUCTION/WORKCENTERANDOPERCOSTS.md) | `COMPANYCODE`, `THERMALROUTINGCODE` | `WORKCENTERANDOPERCOSTS.COMPANYCODE = THERMALROUTING.COMPANYCODE AND WORKCENTERANDOPERCOSTS.THERMALROUTINGCODE = THERMALROUTING.CODE` |
| `THERMALROUTING_THERMALROUTING` | [`ROUTINGSTEPCOSTANDCONSUMPTION`](../PRODUCTION/ROUTINGSTEPCOSTANDCONSUMPTION.md) | `ROUTINGSTEPROUTINGCOMPANYCODE`, `THERMALROUTINGCODE` | `ROUTINGSTEPCOSTANDCONSUMPTION.ROUTINGSTEPROUTINGCOMPANYCODE = THERMALROUTING.COMPANYCODE AND ROUTINGSTEPCOSTANDCONSUMPTION.THERMALROUTINGCODE = THERMALROUTING.CODE` |

## Indexes

- `THERMALROUTINGUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.THERMALROUTING t
