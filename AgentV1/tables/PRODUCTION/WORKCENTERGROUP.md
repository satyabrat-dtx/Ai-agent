...
- **Source**: `DB2ADMIN_DDL.sql` line 8904
...
| 5 | `ROUTINGMANAGMENT` | SMALLINT | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `WORKCENTERGROUP.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `WORKCENTERGROUP_WORKCENTERGROUP` | [`WORKCENTER`](../PRODUCTION/WORKCENTER.md) | `COMPANYCODE`, `WORKCENTERGROUPCODE` | `WORKCENTER.COMPANYCODE = WORKCENTERGROUP.COMPANYCODE AND WORKCENTER.WORKCENTERGROUPCODE = WORKCENTERGROUP.CODE` |

## Indexes

- `WORKCENTERGROUPUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.WORKCENTERGROUP t
