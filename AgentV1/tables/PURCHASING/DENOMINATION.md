...
- **Source**: `DB2ADMIN_DDL.sql` line 121537
...
|---|---|---|---|---|---|
| `CURRENCY_CURRENCY` | `CURRENCYCODE` | [`CURRENCY`](../CORE_MASTER/CURRENCY.md) | `CODE` | RESTRICT | `DENOMINATION.CURRENCYCODE = CURRENCY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `DENOMINATION_CIDENOMINATION` | [`EPCGAPPLICATION`](../PURCHASING/EPCGAPPLICATION.md) | `CIDENOMINATIONCURRENCYCODE` | `EPCGAPPLICATION.CIDENOMINATIONCURRENCYCODE = DENOMINATION.CURRENCYCODE` |

## Indexes

- `DENOMINATIONUID` (ABSUNIQUEID)
