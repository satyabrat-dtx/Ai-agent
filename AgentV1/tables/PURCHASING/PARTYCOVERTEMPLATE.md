...
- **Source**: `DB2ADMIN_DDL.sql` line 129710
...
|---|---|---|---|
| `PARTYCOVERTEMPLATE_PARTYCOVERINGTEMPLATE` | [`LCDETAIL`](../PURCHASING/LCDETAIL.md) | `COMPANYCODE`, `PARTYCOVERINGTEMPLATESLNO`, `PARTYCOVERINGTEMPLATECODE` | `LCDETAIL.COMPANYCODE = PARTYCOVERTEMPLATE.COMPANYCODE AND LCDETAIL.PARTYCOVERINGTEMPLATESLNO = PARTYCOVERTEMPLATE.SLNO AND LCDETAIL.PARTYCOVERINGTEMPLATECODE = PARTYCOVERTEMPLATE.CODE` |

## Indexes

- `PARTYCOVERTEMPLATEUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.PARTYCOVERTEMPLATE t
