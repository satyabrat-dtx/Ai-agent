...
- **Source**: `DB2ADMIN_DDL.sql` line 28292
...
| 18 | `PAYMENTMETHODCOMPANYCODE` | CHAR(3) |  | FK | foreign_key |  |
...
|---|---|---|---|---|---|
| `CURRENCY_CHARGECURRENCY` | `CHARGECURRENCYCODE` | [`CURRENCY`](../CORE_MASTER/CURRENCY.md) | `CODE` | RESTRICT | `PURCHASECHARGEHEADER.CHARGECURRENCYCODE = CURRENCY.CODE` |
| `ITEMTYPE_ITEMTYPE` | `ITEMTYPECOMPANYCODE`, `ITEMTYPECODE` | [`ITEMTYPE`](../CORE_MASTER/ITEMTYPE.md) | `COMPANYCODE`, `CODE` | RESTRICT | `PURCHASECHARGEHEADER.ITEMTYPECOMPANYCODE = ITEMTYPE.COMPANYCODE AND PURCHASECHARGEHEADER.ITEMTYPECODE = ITEMTYPE.CODE` |
| `PAYMENTMETHOD_PAYMENTMETHOD` | `PAYMENTMETHODCOMPANYCODE`, `PAYMENTMETHODCODE` | [`PAYMENTMETHOD`](../CORE_MASTER/PAYMENTMETHOD.md) | `COMPANYCODE`, `CODE` | RESTRICT | `PURCHASECHARGEHEADER.PAYMENTMETHODCOMPANYCODE = PAYMENTMETHOD.COMPANYCODE AND PURCHASECHARGEHEADER.PAYMENTMETHODCODE = PAYMENTMETHOD.CODE` |
| `PURCHASEPRICELIST_CHARGEHEADER` | `PURCHASEPRICELISTCOMPANYCODE`, `PURCHASEPRICELISTCODE` | [`PURCHASEPRICELIST`](../PURCHASING/PURCHASEPRICELIST.md) | `COMPANYCODE`, `CODE` | RESTRICT | `PURCHASECHARGEHEADER.PURCHASEPRICELISTCOMPANYCODE = PURCHASEPRICELIST.COMPANYCODE AND PURCHASECHARGEHEADER.PURCHASEPRICELISTCODE = PURCHASEPRICELIST.CODE` |
...
- `PURCHASECHARGEHEADERUID` (ABSUNIQUEID)
...
SELECT t.PURCHASEPRICELISTCOMPANYCODE,
       ...
       t.SIGN
FROM   DB2ADMIN.PURCHASECHARGEHEADER t
