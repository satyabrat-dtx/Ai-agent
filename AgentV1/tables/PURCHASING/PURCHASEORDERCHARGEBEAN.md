# DB2ADMIN.PURCHASEORDERCHARGEBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 59176
...
| 27 | `PRECEDINGAMOUNT` | DECIMAL(18,5) |  |  |  |  |
...
- `FATHERID` → **PURCHASEORDER**.`ABSUNIQUEID` (high confidence — name = 'PURCHASEORDER' + known child suffix 'CHARGE')
  - JOIN predicate: `PURCHASEORDERCHARGEBEAN.FATHERID = PURCHASEORDER.ABSUNIQUEID`

## Indexes

- `PURCHASEORDERCHARGEBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.PURCHASEORDERCHARGEBEAN t
