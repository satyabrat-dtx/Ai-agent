# DB2ADMIN.PURCHASEORDERCOMMENTBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 59236
...
- `FATHERID` → **PURCHASEORDER**.`ABSUNIQUEID` (high confidence — name = 'PURCHASEORDER' + known child suffix 'COMMENT')
  - JOIN predicate: `PURCHASEORDERCOMMENTBEAN.FATHERID = PURCHASEORDER.ABSUNIQUEID`

## Indexes

- `PURCHASEORDERCOMMENTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.REPORTTYPE,
       ...
       t.IMPCREATIONUSER
FROM   DB2ADMIN.PURCHASEORDERCOMMENTBEAN t
