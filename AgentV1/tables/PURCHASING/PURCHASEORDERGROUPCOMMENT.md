# DB2ADMIN.PURCHASEORDERGROUPCOMMENT

- **Module**: `PURCHASING` (high confidence — table name starts with 'PURCHASE')
- **Roles**: `business_data`
- **Columns**: 17
- **Primary key**: `PURCHASEORDERCOMPANYCODE`, `PURCHASEORDERCOUNTERCODE`, `PURCHASEORDERCODE`, `LINEGROUP`, `ORIGIN`, `CODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 22496
...
|---|---|---|---|---|---|
| `PURCHASEORDER_GROUPCOMMENT` | `PURCHASEORDERCOMPANYCODE`, `PURCHASEORDERCOUNTERCODE`, `PURCHASEORDERCODE` | [`PURCHASEORDER`](../PURCHASING/PURCHASEORDER.md) | `COMPANYCODE`, `COUNTERCODE`, `CODE` | RESTRICT | `PURCHASEORDERGROUPCOMMENT.PURCHASEORDERCOMPANYCODE = PURCHASEORDER.COMPANYCODE AND PURCHASEORDERGROUPCOMMENT.PURCHASEORDERCOUNTERCODE = PURCHASEORDER.COUNTERCODE AND PURCHASEORDERGROUPCOMMENT.PURCHASEORDERCODE = PURCHASEORDER.CODE` |
...
- `PURCHASEORDERGROUPCOMMENTUID` (ABSUNIQUEID)
...
SELECT t.PURCHASEORDERCOMPANYCODE,
       ...
       t.ABSUNIQUEID,
       t.CREATIONDATETIME
FROM   DB2ADMIN.PURCHASEORDERGROUPCOMMENT t
