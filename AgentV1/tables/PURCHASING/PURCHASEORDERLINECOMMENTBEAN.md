# DB2ADMIN.PURCHASEORDERLINECOMMENTBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 59820
...
| 23 | `USECREATIONUSER` | SMALLINT | NOT NULL |  |  |  |
...
- `FATHERID` → **PURCHASEORDERLINE**.`ABSUNIQUEID` (high confidence — name = 'PURCHASEORDERLINE' + known child suffix 'COMMENT')
  - JOIN predicate: `PURCHASEORDERLINECOMMENTBEAN.FATHERID = PURCHASEORDERLINE.ABSUNIQUEID`

## Indexes

- `PURORDERLINECOMMENTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.REPORTTYPE,
       ...
       t.IMPCREATIONUSER
FROM   DB2ADMIN.PURCHASEORDERLINECOMMENTBEAN t
