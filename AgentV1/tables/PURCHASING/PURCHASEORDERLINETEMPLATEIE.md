# DB2ADMIN.PURCHASEORDERLINETEMPLATEIE
...
- **Source**: `DB2ADMIN_DDL.sql` line 129754
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PURCHASEORDERLINETEMPLATEIE.COMPANYCODE = COMPANY.CODE` |
...
- `PURORDERLINETEMPLATEIEUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.PURCHASEORDERLINETEMPLATEIE t
