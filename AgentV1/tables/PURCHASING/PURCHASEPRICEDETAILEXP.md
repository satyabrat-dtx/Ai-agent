# DB2ADMIN.PURCHASEPRICEDETAILEXP

- **Module**: `PURCHASING` (high confidence — table name starts with 'PURCHASE')
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `ENVIRONMENTCODE`, `EXPCOMPANYCODE`, `EXPLISTCODE`, `EXPLINEID`, `EXPNUMBERLINEID`, `UNIQUEIDPK`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 78170
...
| 2 | `EXPLISTCODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
| 3 | `EXPLINEID` | DECIMAL(5,0) | NOT NULL | PK | primary_key |  |
| 4 | `EXPNUMBERLINEID` | DECIMAL(3,0) | NOT NULL | PK | primary_key |  |
...
- `PURCHASEPRICEDETAILEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.PURCHASEPRICEDETAILEXP t
