# DB2ADMIN.PURPRCLISTDEFINITIONCOMMENT

- **Module**: `PURCHASING` (medium confidence — table name starts with 'PUR')
- **Roles**: `business_data`
- **Columns**: 15
- **Primary key**: `PURCHASEPRICELISTCOMPANYCODE`, `PURCHASEPRICELISTCODE`, `ORIGIN`, `CODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 39648
...
|---|---|---|---|---|---|
| `PURCHASEPRICELIST_COMMENT` | `PURCHASEPRICELISTCOMPANYCODE`, `PURCHASEPRICELISTCODE` | [`PURCHASEPRICELIST`](../PURCHASING/PURCHASEPRICELIST.md) | `COMPANYCODE`, `CODE` | RESTRICT | `PURPRCLISTDEFINITIONCOMMENT.PURCHASEPRICELISTCOMPANYCODE = PURCHASEPRICELIST.COMPANYCODE AND PURPRCLISTDEFINITIONCOMMENT.PURCHASEPRICELISTCODE = PURCHASEPRICELIST.CODE` |
...
- `PURPRCLISTDEFCOMMENTUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.PURPRCLISTDEFINITIONCOMMENT t
