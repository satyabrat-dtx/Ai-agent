# DB2ADMIN.REFERENCECOVERTEMPLATE
...
- **Source**: `DB2ADMIN_DDL.sql` line 129848
...
|---|---|---|---|
| `REFERENCECOVERTEMPLATE_REFCOVERINGTEMPLATE` | [`LCDETAIL`](../PURCHASING/LCDETAIL.md) | `COMPANYCODE`, `REFCOVERINGTEMPLATESLNO`, `REFCOVERINGTEMPLATECODE` | `LCDETAIL.COMPANYCODE = REFERENCECOVERTEMPLATE.COMPANYCODE AND LCDETAIL.REFCOVERINGTEMPLATESLNO = REFERENCECOVERTEMPLATE.SLNO AND LCDETAIL.REFCOVERINGTEMPLATECODE = REFERENCECOVERTEMPLATE.CODE` |

## Indexes

- `REFERENCECOVERTEMPLATEUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.REFERENCECOVERTEMPLATE t
