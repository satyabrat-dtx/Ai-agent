# DB2ADMIN.TEMPLATEREQUISITIONRESULT
...
- **Source**: `DB2ADMIN_DDL.sql` line 19751
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `TEMPLATEREQUISITIONRESULT.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `TEMPLATEREQUISITIONRESULT_TEMPLATEREQUISITIONRESULT` | [`REPLENISHMENTREQUISITION`](../PURCHASING/REPLENISHMENTREQUISITION.md) | `COMPANYCODE`, `TEMPLATEREQUISITIONRESULTCODE` | `REPLENISHMENTREQUISITION.COMPANYCODE = TEMPLATEREQUISITIONRESULT.COMPANYCODE AND REPLENISHMENTREQUISITION.TEMPLATEREQUISITIONRESULTCODE = TEMPLATEREQUISITIONRESULT.CODE` |

## Indexes

- `TEMPLATEREQUISITIONRESULTUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.TEMPLATEREQUISITIONRESULT t
