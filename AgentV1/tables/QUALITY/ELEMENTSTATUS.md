...
- **Source**: `DB2ADMIN_DDL.sql` line 11998
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `ELEMENTSTATUS.COMPANYCODE = COMPANY.CODE` |
| `COMPANY_OWNINGCOMPANY` | `OWNINGCOMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `ELEMENTSTATUS.OWNINGCOMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `ELEMENTSTATUS_ELEMENTSTATUS` | [`STOCKTRANSACTIONTEMPLATE`](../INVENTORY/STOCKTRANSACTIONTEMPLATE.md) | `ELEMENTSTATUSCOMPANYCODE`, `ELEMENTSTATUSCODE` | `STOCKTRANSACTIONTEMPLATE.ELEMENTSTATUSCOMPANYCODE = ELEMENTSTATUS.COMPANYCODE AND STOCKTRANSACTIONTEMPLATE.ELEMENTSTATUSCODE = ELEMENTSTATUS.CODE` |
| `ELEMENTSTATUS_STATUS` | [`ELEMENTS`](../QUALITY/ELEMENTS.md) | `STATUSCOMPANYCODE`, `STATUSCODE` | `ELEMENTS.STATUSCOMPANYCODE = ELEMENTSTATUS.COMPANYCODE AND ELEMENTS.STATUSCODE = ELEMENTSTATUS.CODE` |

## Indexes

- `ELEMENTSTATUSUID` (ABSUNIQUEID)
