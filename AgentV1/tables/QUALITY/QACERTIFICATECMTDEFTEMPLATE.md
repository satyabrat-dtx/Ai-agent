# DB2ADMIN.QACERTIFICATECMTDEFTEMPLATE
...
- **Source**: `DB2ADMIN_DDL.sql` line 192618
...
| 5 | `QUALITYCERTIFICATETMPREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 6 | `ITEMREQUIRED` | CHAR(2) | NOT NULL |  |  |  |
| 7 | `ITEMTYPEREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `QACERTIFICATECMTDEFTEMPLATE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `QACERTIFICATECMTDEFTEMPLATE_COMMENTDEFINITIONTEMPLATE` | [`QACERTIFICATECMTDEFINITION`](../QUALITY/QACERTIFICATECMTDEFINITION.md) | `COMPANYCODE`, `COMMENTDEFINITIONTEMPLATECODE` | `QACERTIFICATECMTDEFINITION.COMPANYCODE = QACERTIFICATECMTDEFTEMPLATE.COMPANYCODE AND QACERTIFICATECMTDEFINITION.COMMENTDEFINITIONTEMPLATECODE = QACERTIFICATECMTDEFTEMPLATE.CODE` |

## Indexes

- `QACERTIFICATECMTDEFTMPUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.SHORTDESCRIPTION,
       t.SEARCHDESCRIPTION,
       t.QUALITYCERTIFICATETMPREQUIRED,
       t.ITEMREQUIRED,
       t.ITEMTYPEREQUIRED,
...
FROM   DB2ADMIN.QACERTIFICATECMTDEFTEMPLATE t
