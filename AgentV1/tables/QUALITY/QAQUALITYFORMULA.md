...
- **Source**: `DB2ADMIN_DDL.sql` line 192844
...
| 11 | `CALCULATEFORMULACODE` | CHAR(20) |  |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `QAQUALITYFORMULA.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `QAQUALITYFORMULA_FORMULA` | [`QUALITYCHARACTERISTICTYPE`](../QUALITY/QUALITYCHARACTERISTICTYPE.md) | `COMPANYCODE`, `FORMULACODE` | `QUALITYCHARACTERISTICTYPE.COMPANYCODE = QAQUALITYFORMULA.COMPANYCODE AND QUALITYCHARACTERISTICTYPE.FORMULACODE = QAQUALITYFORMULA.CODE` |
| `QAQUALITYFORMULA_LINE` | [`QAQUALITYFORMULADETAIL`](../QUALITY/QAQUALITYFORMULADETAIL.md) | `QAQUALITYFORMULACOMPANYCODE`, `QAQUALITYFORMULACODE` | `QAQUALITYFORMULADETAIL.QAQUALITYFORMULACOMPANYCODE = QAQUALITYFORMULA.COMPANYCODE AND QAQUALITYFORMULADETAIL.QAQUALITYFORMULACODE = QAQUALITYFORMULA.CODE` |

## Indexes

- `QAQUALITYFORMULAUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.CALCULATEFORMULACODE
FROM   DB2ADMIN.QAQUALITYFORMULA t
