# DB2ADMIN.QUALITYCHARACTERISTICTYPEEXP

- **Module**: `QUALITY` (high confidence — table name starts with 'QUALITY')
- **Roles**: `business_data`
- **Columns**: 9
- **Primary key**: `ENVIRONMENTCODE`, `EXPCOMPANYCODE`, `EXPCODE`, `UNIQUEIDPK`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 117232
...
| 2 | `EXPCODE` | CHAR(10) | NOT NULL | PK | primary_key |  |
...
- `LITYCHARACTERISTICTYPEEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.EVENTEXPDATETIME,
       t.ABSUNIQUEID
FROM   DB2ADMIN.QUALITYCHARACTERISTICTYPEEXP t
