# DB2ADMIN.QUALITYSAMPLEINSTRUCTION
...
- **Source**: `DB2ADMIN_DDL.sql` line 111596
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `QUALITYSAMPLEINSTRUCTION.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `QUALITYSAMPLEINSTRUCTION_SAMPLEINSTRUCTION` | [`QUALITYDOCUMENT`](../QUALITY/QUALITYDOCUMENT.md) | `COMPANYCODE`, `SAMPLEINSTRUCTIONCODE` | `QUALITYDOCUMENT.COMPANYCODE = QUALITYSAMPLEINSTRUCTION.COMPANYCODE AND QUALITYDOCUMENT.SAMPLEINSTRUCTIONCODE = QUALITYSAMPLEINSTRUCTION.CODE` |
| `QUALITYSAMPLEINSTRUCTION_SAMPLEINSTRUCTION` | [`QUALITYHEADER`](../QUALITY/QUALITYHEADER.md) | `COMPANYCODE`, `SAMPLEINSTRUCTIONCODE` | `QUALITYHEADER.COMPANYCODE = QUALITYSAMPLEINSTRUCTION.COMPANYCODE AND QUALITYHEADER.SAMPLEINSTRUCTIONCODE = QUALITYSAMPLEINSTRUCTION.CODE` |

## Indexes

- `QUALITYSAMPLEINSTRUCTIONUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.QUALITYSAMPLEINSTRUCTION t
