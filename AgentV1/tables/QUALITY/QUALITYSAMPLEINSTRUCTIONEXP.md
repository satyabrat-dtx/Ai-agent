# DB2ADMIN.QUALITYSAMPLEINSTRUCTIONEXP
...
- **Source**: `DB2ADMIN_DDL.sql` line 117445
...
| 2 | `EXPCODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
...
- `LITYSAMPLEINSTRUCTIONEXPUID` (ABSUNIQUEID)
...
SELECT t.ENVIRONMENTCODE,
       ...
       t.EVENTEXPDATETIME,
       t.ABSUNIQUEID
FROM   DB2ADMIN.QUALITYSAMPLEINSTRUCTIONEXP t
