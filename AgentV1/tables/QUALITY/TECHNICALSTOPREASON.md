...
- **Source**: `DB2ADMIN_DDL.sql` line 105797
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `TECHNICALSTOPREASON.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `TECHNICALSTOPREASON_TECHNICALSTOPREASON` | [`CUTTINGPROGRESS`](../PRODUCTION/CUTTINGPROGRESS.md) | `COMPANYCODE`, `TECHNICALSTOPREASONCODE` | `CUTTINGPROGRESS.COMPANYCODE = TECHNICALSTOPREASON.COMPANYCODE AND CUTTINGPROGRESS.TECHNICALSTOPREASONCODE = TECHNICALSTOPREASON.CODE` |
| `TECHNICALSTOPREASON_TECHNICALSTOPREASON` | [`LAYDOWNPROGRESS`](../QUALITY/LAYDOWNPROGRESS.md) | `COMPANYCODE`, `TECHNICALSTOPREASONCODE` | `LAYDOWNPROGRESS.COMPANYCODE = TECHNICALSTOPREASON.COMPANYCODE AND LAYDOWNPROGRESS.TECHNICALSTOPREASONCODE = TECHNICALSTOPREASON.CODE` |

## Indexes

- `TECHNICALSTOPREASONUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.TECHNICALSTOPREASON t
