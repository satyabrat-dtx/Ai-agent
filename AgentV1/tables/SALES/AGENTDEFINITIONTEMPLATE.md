# DB2ADMIN.AGENTDEFINITIONTEMPLATE
...
- **Source**: `DB2ADMIN_DDL.sql` line 20900
...
| 7 | `AGENTGROUPREQUIRED` | SMALLINT | NOT NULL |  |  |  |
| 8 | `DIVISIONREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 9 | `ORDERPARTNERREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 10 | `ORDERPARTNERGROUPREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 11 | `FINANCIALORDERPARTNERREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 12 | `ORDERCATEGORYREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 13 | `AREAREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 14 | `STATISTICALGROUPREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 15 | `ORDERTEMPLATECODEREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 16 | `PAYMENTMETHODREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 17 | `ITEMTYPEREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 18 | `ORDERITEMREQUIRED` | CHAR(2) | NOT NULL |  |  |  |
| 19 | `ORDERITEMGROUPREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 20 | `QUALITYLEVELREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 21 | `LINEUSERVALUEREQUIRED` | CHAR(1) |  |  |  |  |
...
| 29 | `REFERENCEPARTNERREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
| 30 | `REFERENCEPARTNERGROUPREQUIRED` | CHAR(1) | NOT NULL |  |  |  |

## References (this table → parent) — 1

| Constraint | Local columns | → Table | → Columns | ON DELETE | JOIN predicate |
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `AGENTDEFINITIONTEMPLATE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `AGENTDEFINITIONTEMPLATE_TEMPLATE` | [`SALESAGENTDEFINITION`](../SALES/SALESAGENTDEFINITION.md) | `COMPANYCODE`, `ORDERTYPE`, `TYPE`, `TEMPLATECODE` | `SALESAGENTDEFINITION.COMPANYCODE = AGENTDEFINITIONTEMPLATE.COMPANYCODE AND SALESAGENTDEFINITION.ORDERTYPE = AGENTDEFINITIONTEMPLATE.ORDERTYPE AND SALESAGENTDEFINITION.TYPE = AGENTDEFINITIONTEMPLATE.DEFINITIONTYPE AND SALESAGENTDEFINITION.TEMPLATECODE = AGENTDEFINITIONTEMPLATE.CODE` |

## Indexes

- `AGENTDEFINITIONTEMPLATEUID` (ABSUNIQUEID)
