...
- **Source**: `DB2ADMIN_DDL.sql` line 19709
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `AGENTSGROUP.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `AGENTSGROUP_AGENTSGROUP` | [`SALESAGENTDEFINITION`](../SALES/SALESAGENTDEFINITION.md) | `COMPANYCODE`, `AGENTSGROUPCODE` | `SALESAGENTDEFINITION.COMPANYCODE = AGENTSGROUP.COMPANYCODE AND SALESAGENTDEFINITION.AGENTSGROUPCODE = AGENTSGROUP.CODE` |
| `AGENTSGROUP_AGENTSGROUPDETAIL` | [`AGENTSGROUPDETAIL`](../SALES/AGENTSGROUPDETAIL.md) | `AGENTSGROUPCOMPANYCODE`, `AGENTSGROUPCODE` | `AGENTSGROUPDETAIL.AGENTSGROUPCOMPANYCODE = AGENTSGROUP.COMPANYCODE AND AGENTSGROUPDETAIL.AGENTSGROUPCODE = AGENTSGROUP.CODE` |

## Indexes

- `AGENTSGROUPUID` (ABSUNIQUEID)
