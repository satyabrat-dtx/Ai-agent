# DB2ADMIN.CHARGESDEFINITIONTEMPLATE
...
- **Source**: `DB2ADMIN_DDL.sql` line 9703
...
| 16 | `TERMSOFSHIPPINGREQUIRED` | CHAR(1) | NOT NULL |  |  |  |
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `CHARGESDEFINITIONTEMPLATE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `CHARGESDEFINITIONTEMPLATE_TEMPLATE` | [`SALESCHARGESDEFINITION`](../SALES/SALESCHARGESDEFINITION.md) | `COMPANYCODE`, `ORDERTYPE`, `TYPE`, `TEMPLATECODE` | `SALESCHARGESDEFINITION.COMPANYCODE = CHARGESDEFINITIONTEMPLATE.COMPANYCODE AND SALESCHARGESDEFINITION.ORDERTYPE = CHARGESDEFINITIONTEMPLATE.ORDERTYPE AND SALESCHARGESDEFINITION.TYPE = CHARGESDEFINITIONTEMPLATE.DEFINITIONTYPE AND SALESCHARGESDEFINITION.TEMPLATECODE = CHARGESDEFINITIONTEMPLATE.CODE` |

## Indexes

- `CHARGESDEFINITIONTEMPLATEUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.CHARGESDEFINITIONTEMPLATE t
