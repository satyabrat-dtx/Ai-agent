# DB2ADMIN.CLAIMSTATUSDEFINITION
...
- **Source**: `DB2ADMIN_DDL.sql` line 92322
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `CLAIMSTATUSDEFINITION.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `CLAIMSTATUSDEFINITION_CLAIMPROGRESSSTATUS` | [`SALESCLAIMLINE`](../SALES/SALESCLAIMLINE.md) | `COMPANYCODE`, `CLAIMPROGRESSSTATUSCODE` | `SALESCLAIMLINE.COMPANYCODE = CLAIMSTATUSDEFINITION.COMPANYCODE AND SALESCLAIMLINE.CLAIMPROGRESSSTATUSCODE = CLAIMSTATUSDEFINITION.CODE` |
| `CLAIMSTATUSDEFINITION_CLAIMPROGRESSSTATUS` | [`SALESCLAIMSTATUSANNOTATION`](../SALES/SALESCLAIMSTATUSANNOTATION.md) | `COMPANYCODE`, `CLAIMPROGRESSSTATUSCODE` | `SALESCLAIMSTATUSANNOTATION.COMPANYCODE = CLAIMSTATUSDEFINITION.COMPANYCODE AND SALESCLAIMSTATUSANNOTATION.CLAIMPROGRESSSTATUSCODE = CLAIMSTATUSDEFINITION.CODE` |

## Indexes

- `CLAIMSTATUSDEFINITIONUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.CLAIMSTATUSDEFINITION t
