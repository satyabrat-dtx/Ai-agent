...
- **Source**: `DB2ADMIN_DDL.sql` line 5551
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `CLAIMTYPE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `CLAIMTYPE_CLAIMTYPE` | [`SALESCLAIMLINE`](../SALES/SALESCLAIMLINE.md) | `COMPANYCODE`, `CLAIMTYPECODE` | `SALESCLAIMLINE.COMPANYCODE = CLAIMTYPE.COMPANYCODE AND SALESCLAIMLINE.CLAIMTYPECODE = CLAIMTYPE.CODE` |

## Indexes

- `CLAIMTYPEUID` (ABSUNIQUEID)
