# DB2ADMIN.COMMISSIONDEFINITIONTEMPLATE
...
- **Source**: `DB2ADMIN_DDL.sql` line 38542
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COMMISSIONDEFINITIONTEMPLATE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `COMMISSIONDEFINITIONTEMPLATE_TEMPLATE` | [`SALESCOMMISSIONDEFINITION`](../SALES/SALESCOMMISSIONDEFINITION.md) | `COMPANYCODE`, `ORDERTYPE`, `TYPE`, `TEMPLATECODE` | `SALESCOMMISSIONDEFINITION.COMPANYCODE = COMMISSIONDEFINITIONTEMPLATE.COMPANYCODE AND SALESCOMMISSIONDEFINITION.ORDERTYPE = COMMISSIONDEFINITIONTEMPLATE.ORDERTYPE AND SALESCOMMISSIONDEFINITION.TYPE = COMMISSIONDEFINITIONTEMPLATE.DEFINITIONTYPE AND SALESCOMMISSIONDEFINITION.TEMPLATECODE = COMMISSIONDEFINITIONTEMPLATE.CODE` |

## Indexes

- `CMSDEFINITIONTEMPLATEUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.COMMISSIONDEFINITIONTEMPLATE t
