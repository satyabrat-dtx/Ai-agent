...
- **Source**: `DB2ADMIN_DDL.sql` line 19423
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `COMPOUNDPRICETYPE.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `COMPOUNDPRICETYPE_COMPOUNDPRICETYPE` | [`SALESPRICEDEFINITIONDETAIL`](../SALES/SALESPRICEDEFINITIONDETAIL.md) | `SALPRICEDEFINITIONCOMPANYCODE`, `COMPOUNDPRICETYPECODE` | `SALESPRICEDEFINITIONDETAIL.SALPRICEDEFINITIONCOMPANYCODE = COMPOUNDPRICETYPE.COMPANYCODE AND SALESPRICEDEFINITIONDETAIL.COMPOUNDPRICETYPECODE = COMPOUNDPRICETYPE.CODE` |
| `COMPOUNDPRICETYPE_COMPOUNDPRICETYPE` | [`SALESORDERLINEPRICE`](../SALES/SALESORDERLINEPRICE.md) | `SALORDLINESALORDERCOMPANYCODE`, `COMPOUNDPRICETYPECODE` | `SALESORDERLINEPRICE.SALORDLINESALORDERCOMPANYCODE = COMPOUNDPRICETYPE.COMPANYCODE AND SALESORDERLINEPRICE.COMPOUNDPRICETYPECODE = COMPOUNDPRICETYPE.CODE` |

## Indexes

- `COMPOUNDPRICETYPEUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.COMPOUNDPRICETYPE t
