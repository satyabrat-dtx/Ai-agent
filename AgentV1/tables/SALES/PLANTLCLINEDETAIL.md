# DB2ADMIN.PLANTLCLINEDETAIL

- **Module**: `SALES` (low confidence — FK neighbourhood: 1 of 1 related tables are SALES)
- **Roles**: `business_data`
- **Columns**: 16
- **Primary key**: `COMPANYCODE`, `PIPLANTINVOICEDIVISIONCODE`, `PIPLANTINVOICECODE`, `PIINVOICELINENO`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 141804
...
| 1 | `PIPLANTINVOICEDIVISIONCODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
| 2 | `PIPLANTINVOICECODE` | CHAR(15) | NOT NULL | PK | primary_key |  |
| 3 | `PIINVOICELINENO` | DECIMAL(3,0) | NOT NULL | PK | primary_key |  |
...
- `PLANTLCLINEDETAILUID` (ABSUNIQUEID)

## Starter query

```sql
SELECT t.COMPANYCODE,
       t.PIPLANTINVOICEDIVISIONCODE,
       t.PIPLANTINVOICECODE,
       t.PIINVOICELINENO,
       t.LCORDERLINENO,
...
FROM   DB2ADMIN.PLANTLCLINEDETAIL t
