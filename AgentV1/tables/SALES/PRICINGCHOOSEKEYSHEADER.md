# DB2ADMIN.PRICINGCHOOSEKEYSHEADER
...
- **Source**: `DB2ADMIN_DDL.sql` line 104811
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `PRICINGCHOOSEKEYSHEADER.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 2

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `PRICINGCHOOSEKEYSHEADER_PRICINGCHOOSEKEYS` | [`SALESORDERLINETEMPLATE`](../SALES/SALESORDERLINETEMPLATE.md) | `COMPANYCODE`, `PRICINGCHOOSEKEYSCODE` | `SALESORDERLINETEMPLATE.COMPANYCODE = PRICINGCHOOSEKEYSHEADER.COMPANYCODE AND SALESORDERLINETEMPLATE.PRICINGCHOOSEKEYSCODE = PRICINGCHOOSEKEYSHEADER.CODE` |
| `PRICINGCHOOSEKEYSHEADER_PRICINGCHOOSEKEYS` | [`PRICINGCHOOSEKEYS`](../SALES/PRICINGCHOOSEKEYS.md) | `PRICINGCHSKEYSHDRCOMPANYCODE`, `PRICINGCHOOSEKEYSHEADERCODE` | `PRICINGCHOOSEKEYS.PRICINGCHSKEYSHDRCOMPANYCODE = PRICINGCHOOSEKEYSHEADER.COMPANYCODE AND PRICINGCHOOSEKEYS.PRICINGCHOOSEKEYSHEADERCODE = PRICINGCHOOSEKEYSHEADER.CODE` |

## Indexes

- `PRICINGCHOOSEKEYSHEADERUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.PRICINGCHOOSEKEYSHEADER t
