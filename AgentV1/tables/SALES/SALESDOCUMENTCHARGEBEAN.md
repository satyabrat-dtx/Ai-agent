# DB2ADMIN.SALESDOCUMENTCHARGEBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 95688
...
| 15 | `SALESDOCUMENTLINEORDERLINE` | DECIMAL(7,0) |  |  |  |  |
| 16 | `SALESDOCUMENTLINEORDERSUBLINE` | DECIMAL(3,0) |  |  |  |  |
| 17 | `SALDOCLINECOMPONENTORDERLINE` | DECIMAL(3,0) |  |  |  |  |
...
- `FATHERID` → **SALESDOCUMENT**.`ABSUNIQUEID` (high confidence — name = 'SALESDOCUMENT' + known child suffix 'CHARGE')
  - JOIN predicate: `SALESDOCUMENTCHARGEBEAN.FATHERID = SALESDOCUMENT.ABSUNIQUEID`

## Indexes

- `SALESDOCUMENTCHARGEBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.SALESDOCUMENTCHARGEBEAN t
