# DB2ADMIN.SALESDOCUMENTCOMMISSIONBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 95818
...
- `FATHERID` → **SALESDOCUMENT**.`ABSUNIQUEID` (medium confidence — name = 'SALESDOCUMENT' + recurring fragment 'COMMISSION' (seen in 11 tables))
  - JOIN predicate: `SALESDOCUMENTCOMMISSIONBEAN.FATHERID = SALESDOCUMENT.ABSUNIQUEID`

## Indexes

- `SALDOCUMENTCOMMISSIONBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.SALESDOCUMENTCOMMISSIONBEAN t
