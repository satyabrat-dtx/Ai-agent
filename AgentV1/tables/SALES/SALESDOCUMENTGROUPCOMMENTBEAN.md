# DB2ADMIN.SALESDOCUMENTGROUPCOMMENTBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 95944
...
- `FATHERID` → **SALESDOCUMENT**.`ABSUNIQUEID` (medium confidence — name = 'SALESDOCUMENT' + recurring fragment 'GROUPCOMMENT' (seen in 6 tables))
  - JOIN predicate: `SALESDOCUMENTGROUPCOMMENTBEAN.FATHERID = SALESDOCUMENT.ABSUNIQUEID`

## Indexes

- `SALDOCGROUPCOMMENTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.REPORTTYPE,
       ...
       t.CANCELED,
       t.WSOPERATION
FROM   DB2ADMIN.SALESDOCUMENTGROUPCOMMENTBEAN t
