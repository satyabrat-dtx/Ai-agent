# DB2ADMIN.SALESDOCUMENTLINEBLOCKSBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 96218
...
- `FATHERID` → **SALESDOCUMENTLINE**.`ABSUNIQUEID` (high confidence — name = 'SALESDOCUMENTLINE' + known child suffix 'BLOCKS')
  - JOIN predicate: `SALESDOCUMENTLINEBLOCKSBEAN.FATHERID = SALESDOCUMENTLINE.ABSUNIQUEID`

## Indexes

- `SALDOCUMENTLINEBLOCKSBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.FATHERID,
       ...
       t.UNBLOCKINGTYPE
FROM   DB2ADMIN.SALESDOCUMENTLINEBLOCKSBEAN t
