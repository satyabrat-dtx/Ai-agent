...
- **Source**: `DB2ADMIN_DDL.sql` line 60021
...
- `FATHERID` → **SALESORDER**.`ABSUNIQUEID` (high confidence — name = 'SALESORDER' + known child suffix 'BLOCKS')
  - JOIN predicate: `SALESORDERBLOCKSBEAN.FATHERID = SALESORDER.ABSUNIQUEID`

## Indexes

- `SALESORDERBLOCKSBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.FATHERID,
       ...
       t.UNBLOCKINGTYPE
FROM   DB2ADMIN.SALESORDERBLOCKSBEAN t
