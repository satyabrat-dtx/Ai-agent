# DB2ADMIN.SALESORDERCOMMENT

- **Module**: `SALES` (high confidence — table name starts with 'SALESORDER')
- **Roles**: `business_data`
- **Columns**: 16
- **Primary key**: `SALESORDERCOMPANYCODE`, `SALESORDERCOUNTERCODE`, `SALESORDERCODE`, `ORIGIN`, `CODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 10371
...
|---|---|---|---|---|---|
| `SALESORDER_COMMENT` | `SALESORDERCOMPANYCODE`, `SALESORDERCOUNTERCODE`, `SALESORDERCODE` | [`SALESORDER`](../SALES/SALESORDER.md) | `COMPANYCODE`, `COUNTERCODE`, `CODE` | RESTRICT | `SALESORDERCOMMENT.SALESORDERCOMPANYCODE = SALESORDER.COMPANYCODE AND SALESORDERCOMMENT.SALESORDERCOUNTERCODE = SALESORDER.COUNTERCODE AND SALESORDERCOMMENT.SALESORDERCODE = SALESORDER.CODE` |
...
- `SALESORDERCOMMENTUID` (ABSUNIQUEID)
...
SELECT t.SALESORDERCOMPANYCODE,
       ...
       t.CREATIONDATETIME,
       t.CREATIONUSER
FROM   DB2ADMIN.SALESORDERCOMMENT t
