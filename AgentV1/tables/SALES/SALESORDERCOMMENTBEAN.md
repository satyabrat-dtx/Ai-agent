# DB2ADMIN.SALESORDERCOMMENTBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 60145
...
- `FATHERID` → **SALESORDER**.`ABSUNIQUEID` (high confidence — name = 'SALESORDER' + known child suffix 'COMMENT')
  - JOIN predicate: `SALESORDERCOMMENTBEAN.FATHERID = SALESORDER.ABSUNIQUEID`

## Indexes

- `SALESORDERCOMMENTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.REPORTTYPE,
       ...
       t.IMPCREATIONUSER
FROM   DB2ADMIN.SALESORDERCOMMENTBEAN t
