# DB2ADMIN.SALESORDERGROUPCOMMENTBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 60457
...
- `FATHERID` → **SALESORDER**.`ABSUNIQUEID` (medium confidence — name = 'SALESORDER' + recurring fragment 'GROUPCOMMENT' (seen in 6 tables))
  - JOIN predicate: `SALESORDERGROUPCOMMENTBEAN.FATHERID = SALESORDER.ABSUNIQUEID`

## Indexes

- `SALESORDERGROUPCOMMENTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.SALESORDERGROUPCOMMENTBEAN t
