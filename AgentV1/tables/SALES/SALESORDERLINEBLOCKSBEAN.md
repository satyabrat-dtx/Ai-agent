# DB2ADMIN.SALESORDERLINEBLOCKSBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 60520
...
- `FATHERID` → **SALESORDERLINE**.`ABSUNIQUEID` (high confidence — name = 'SALESORDERLINE' + known child suffix 'BLOCKS')
  - JOIN predicate: `SALESORDERLINEBLOCKSBEAN.FATHERID = SALESORDERLINE.ABSUNIQUEID`

## Indexes

- `SALESORDERLINEBLOCKSBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.FATHERID,
       ...
       t.UNBLOCKINGTYPE
FROM   DB2ADMIN.SALESORDERLINEBLOCKSBEAN t
