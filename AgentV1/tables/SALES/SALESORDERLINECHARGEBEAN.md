# DB2ADMIN.SALESORDERLINECHARGEBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 60581
...
- `FATHERID` → **SALESORDERLINE**.`ABSUNIQUEID` (high confidence — name = 'SALESORDERLINE' + known child suffix 'CHARGE')
  - JOIN predicate: `SALESORDERLINECHARGEBEAN.FATHERID = SALESORDERLINE.ABSUNIQUEID`

## Indexes

- `SALESORDERLINECHARGEBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.SALESORDERLINECHARGEBEAN t
