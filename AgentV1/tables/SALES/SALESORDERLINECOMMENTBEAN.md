# DB2ADMIN.SALESORDERLINECOMMENTBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 60642
...
- `FATHERID` → **SALESORDERLINE**.`ABSUNIQUEID` (high confidence — name = 'SALESORDERLINE' + known child suffix 'COMMENT')
  - JOIN predicate: `SALESORDERLINECOMMENTBEAN.FATHERID = SALESORDERLINE.ABSUNIQUEID`

## Indexes

- `SALESORDERLINECOMMENTBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
SELECT t.REPORTTYPE,
       ...
       t.IMPCREATIONUSER
FROM   DB2ADMIN.SALESORDERLINECOMMENTBEAN t
