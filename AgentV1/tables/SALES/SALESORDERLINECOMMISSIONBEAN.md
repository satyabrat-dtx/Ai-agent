# DB2ADMIN.SALESORDERLINECOMMISSIONBEAN
...
- **Source**: `DB2ADMIN_DDL.sql` line 60705
...
- `FATHERID` → **SALESORDERLINE**.`ABSUNIQUEID` (medium confidence — name = 'SALESORDERLINE' + recurring fragment 'COMMISSION' (seen in 11 tables))
  - JOIN predicate: `SALESORDERLINECOMMISSIONBEAN.FATHERID = SALESORDERLINE.ABSUNIQUEID`

## Indexes

- `SALORDLINECOMMISSIONBEANXMT` (IMPORTSTATUS, RETRYNR, IMPORTAUTOCOUNTER, NEXTRETRY)
...
FROM   DB2ADMIN.SALESORDERLINECOMMISSIONBEAN t
