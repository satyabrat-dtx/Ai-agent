# DB2ADMIN.SALESORDERLINETEMPLATEIE
...
- **Source**: `DB2ADMIN_DDL.sql` line 129970
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `SALESORDERLINETEMPLATEIE.COMPANYCODE = COMPANY.CODE` |
...
- `SALESORDERLINETEMPLATEIEUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.ABSUNIQUEID
FROM   DB2ADMIN.SALESORDERLINETEMPLATEIE t
