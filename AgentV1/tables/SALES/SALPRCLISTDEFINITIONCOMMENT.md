# DB2ADMIN.SALPRCLISTDEFINITIONCOMMENT

- **Module**: `SALES` (low confidence — FK neighbourhood: 1 of 1 related tables are SALES)
- **Roles**: `business_data`
- **Columns**: 15
- **Primary key**: `SALPRCLISTDEFCOMPANYCODE`, `SALPRCLISTDEFINITIONNUMBERID`, `ORIGIN`, `CODE`
- **FK degree**: referenced by 0 constraint(s), references 1 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 40759

## Columns

| # | Column | Type | Null | Key | Tags | Meaning |
|---|--------|------|------|-----|------|---------|
| 0 | `SALPRCLISTDEFCOMPANYCODE` | CHAR(3) | NOT NULL | PK FK | primary_key foreign_key |  |
| 1 | `SALPRCLISTDEFINITIONNUMBERID` | DECIMAL(11,0) | NOT NULL | PK FK | primary_key foreign_key |  |
...
|---|---|---|---|---|---|
| `SALESPRICELISTDEFINITION_COMMENT` | `SALPRCLISTDEFCOMPANYCODE`, `SALPRCLISTDEFINITIONNUMBERID` | [`SALESPRICELISTDEFINITION`](../SALES/SALESPRICELISTDEFINITION.md) | `COMPANYCODE`, `NUMBERID` | RESTRICT | `SALPRCLISTDEFINITIONCOMMENT.SALPRCLISTDEFCOMPANYCODE = SALESPRICELISTDEFINITION.COMPANYCODE AND SALPRCLISTDEFINITIONCOMMENT.SALPRCLISTDEFINITIONNUMBERID = SALESPRICELISTDEFINITION.NUMBERID` |
...
- `SALPRCLISTDEFCOMMENTUID` (ABSUNIQUEID)

## Starter query

```sql
SELECT t.SALPRCLISTDEFCOMPANYCODE,
...
FROM   DB2ADMIN.SALPRCLISTDEFINITIONCOMMENT t
