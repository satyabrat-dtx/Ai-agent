# DB2ADMIN.SCDA_ALTERNATIVEWAREHOUSE
...
- **Source**: `DB2ADMIN_DDL.sql` line 185336
...
| 4 | `ISSUE_ITEM_TYPE` | VARCHAR(3) | NOT NULL | PK | primary_key |  |
| 5 | `ALTERN_NET_GROUP_CODE` | VARCHAR(16) |  |  |  |  |
...
FROM   DB2ADMIN.SCDA_ALTERNATIVEWAREHOUSE t
