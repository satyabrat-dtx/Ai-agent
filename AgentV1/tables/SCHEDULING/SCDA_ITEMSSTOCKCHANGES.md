# DB2ADMIN.SCDA_ITEMSSTOCKCHANGES
...
- **Source**: `DB2ADMIN_DDL.sql` line 185214
...
| 2 | `ITC_NET_GROUP_CODE` | VARCHAR(10) | NOT NULL | PK | primary_key |  |
...
| 7 | `ITC_STOCKDIFFERENCE` | DECIMAL(9,2) |  |  |  |  |
...
FROM   DB2ADMIN.SCDA_ITEMSSTOCKCHANGES t
