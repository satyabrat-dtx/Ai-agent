...
- **Source**: `DB2ADMIN_DDL.sql` line 183973
...
| 17 | `RS_LINE_WITHIN_PLANT` | VARCHAR(3) |  |  |  |  |
| 18 | `RS_RSC_PLAN_TYPE` | CHAR(1) |  |  |  |  |
| 19 | `RS_OPTIMUMMAXMULTIPLIER` | VARCHAR(5) |  |  |  |  |
| 20 | `RS_FORCE_OUTSIDE_LIMIT_QTY` | CHAR(1) |  |  |  |  |
| 21 | `RS_FORCE_OCC_TO_RES_CASE_99` | CHAR(1) |  |  |  |  |
| 22 | `RS_ONE_BATCH_MACHINE_GRP_TYPE` | CHAR(1) |  |  |  |  |
