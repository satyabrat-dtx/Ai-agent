...
- **Source**: `DB2ADMIN_DDL.sql` line 184106
...
| 11 | `OO_RULE_CONST` | VARCHAR(20) |  |  |  |  |
| 12 | `OO_OPERAND` | VARCHAR(2) |  |  |  |  |
| 13 | `OO_CASE` | VARCHAR(2) |  |  |  |  |
| 14 | `OO_SETUP_TYPE` | CHAR(1) |  |  |  |  |
| 15 | `OO_SETUP_TIME` | DECIMAL(9,2) |  |  |  |  |
| 16 | `OO_SETUP_OVERLAPPING_TIME` | DECIMAL(9,2) |  |  |  |  |
| 17 | `OO_SETUP_TIME_MULT` | DECIMAL(9,4) |  |  |  |  |
| 18 | `OO_OVERLAPPING_TIME_MULT` | DECIMAL(9,4) |  |  |  |  |
| 19 | `OO_CAN_BE_SAME_GROUP` | CHAR(1) |  |  |  |  |
| 20 | `OO_FROM_POS` | SMALLINT | NOT NULL |  |  |  |
| 21 | `OO_LENGTH` | SMALLINT | NOT NULL |  |  |  |
| 22 | `OO_PARTIAL_PROP_VAL` | CHAR(1) |  |  |  |  |
| 23 | `OO_NEXT_SEQ_WHEN_OK` | SMALLINT | NOT NULL |  |  |  |
| 24 | `OO_NUM_OF_DEC` | SMALLINT | NOT NULL |  |  |  |
| 25 | `OO_LEARNING_CURVE_CODE` | VARCHAR(6) |  |  |  |  |
| 26 | `OO_USR_NAMECR` | VARCHAR(10) |  |  |  |  |
| 27 | `OO_USR_TIMECR` | TIMESTAMP |  |  |  |  |
| 28 | `OO_USR_NAMECG` | VARCHAR(10) |  |  |  |  |
| 29 | `OO_USR_TIMECG` | TIMESTAMP |  |  |  |  |
| 30 | `OO_TEORETIC_WC` | VARCHAR(8) |  |  |  |  |
| 31 | `OO_DURATION` | DECIMAL(9,2) |  |  |  |  |
| 32 | `OO_LEAD_TIME` | DECIMAL(9,2) |  |  |  |  |
...
SELECT t.OO_IDENTIFIER,
       ...
       t.OO_DEP_VALUE,
       t.OO_RULE_CONST
FROM   DB2ADMIN.SCDA_RULE_OCC_TO_OCC t
