...
- **Source**: `DB2ADMIN_DDL.sql` line 187881
...
- `SCDM_BALANCE_DETAIL` (BD_TYPE_PROD, BD_PRODUCT_CODE, BD_NET_GROUP_CODE, BD_OCCUPY_CODE, BD_DUE_DATE)
...
SELECT t.BD_IDENTIFIER,
       ...
       t.BD_USR_NAMECG,
       t.BD_USR_TIMECG
FROM   DB2ADMIN.SCDM_BALANCE_DETAIL t
