# DB2ADMIN.SCDM_MACHINE_SETUP_CODE
...
- **Source**: `DB2ADMIN_DDL.sql` line 187552
...
| 4 | `MS_RSC_CODE` | VARCHAR(8) | NOT NULL | PK | primary_key |  |
| 5 | `MS_DESCRIPTION` | VARCHAR(120) |  |  |  |  |
...
SELECT t.MS_IDENTIFIER,
       ...
       t.MS_USR_NAMECG,
       t.MS_USR_TIMECG
FROM   DB2ADMIN.SCDM_MACHINE_SETUP_CODE t
