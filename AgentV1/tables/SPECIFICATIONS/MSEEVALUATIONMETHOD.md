...
- **Source**: `DB2ADMIN_DDL.sql` line 92452
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `MSEEVALUATIONMETHOD.COMPANYCODE = COMPANY.CODE` |
...
- `MSEEVALUATIONMETHODUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.LASTUPDATEUSER,
       t.ABSUNIQUEID
FROM   DB2ADMIN.MSEEVALUATIONMETHOD t
