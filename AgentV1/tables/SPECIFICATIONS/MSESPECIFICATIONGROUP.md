# DB2ADMIN.MSESPECIFICATIONGROUP
...
- **Source**: `DB2ADMIN_DDL.sql` line 92496
...
|---|---|---|---|---|---|
| `COMPANY_COMPANY` | `COMPANYCODE` | [`COMPANY`](../CORE_MASTER/COMPANY.md) | `CODE` | RESTRICT | `MSESPECIFICATIONGROUP.COMPANYCODE = COMPANY.CODE` |

## Referenced by (child → this table) — 1

| Constraint | Child table | Child columns | JOIN predicate |
|---|---|---|---|
| `MSESPECIFICATIONGROUP_SPECIFICATIONGROUP` | [`MSESPECIFICATIONHEADER`](../SPECIFICATIONS/MSESPECIFICATIONHEADER.md) | `COMPANYCODE`, `SPECIFICATIONGROUPCODE` | `MSESPECIFICATIONHEADER.COMPANYCODE = MSESPECIFICATIONGROUP.COMPANYCODE AND MSESPECIFICATIONHEADER.SPECIFICATIONGROUPCODE = MSESPECIFICATIONGROUP.CODE` |

## Indexes

- `MSESPECIFICATIONGROUPUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.MSESPECIFICATIONGROUP t
