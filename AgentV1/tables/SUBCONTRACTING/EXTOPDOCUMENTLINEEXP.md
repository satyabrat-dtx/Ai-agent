# DB2ADMIN.EXTOPDOCUMENTLINEEXP

- **Module**: `SUBCONTRACTING` (medium confidence — table name starts with 'EXTOP')
- **Roles**: `business_data`
- **Columns**: 11
- **Primary key**: `ENVIRONMENTCODE`, `EXPEXTOPDOCUMENTCOMPANYCODE`, `EXPEXTOPDOCPROVCOUNTERCODE`, `EXPEXTOPDOCPROVISIONALCODE`, `EXPORDERLINE`, `UNIQUEIDPK`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 92407
...
| 1 | `EXPEXTOPDOCUMENTCOMPANYCODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
| 2 | `EXPEXTOPDOCPROVCOUNTERCODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
| 3 | `EXPEXTOPDOCPROVISIONALCODE` | CHAR(15) | NOT NULL | PK | primary_key |  |
...
- `EXTOPDOCUMENTLINEEXPUID` (ABSUNIQUEID)

## Starter query

```sql
SELECT t.ENVIRONMENTCODE,
       t.EXPEXTOPDOCUMENTCOMPANYCODE,
       t.EXPEXTOPDOCPROVCOUNTERCODE,
       t.EXPEXTOPDOCPROVISIONALCODE,
       t.EXPORDERLINE,
       t.OPERATIONTYPE,
       t.STATUS,
       t.UNIQUEIDPK,
       ...
       t.FATHERABSUNIQUEID,
       t.EVENTEXPDATETIME
FROM   DB2ADMIN.EXTOPDOCUMENTLINEEXP t
