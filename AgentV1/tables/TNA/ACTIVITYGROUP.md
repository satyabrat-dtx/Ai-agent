...
- **Source**: `DB2ADMIN_DDL.sql` line 118324
...
|---|---|---|---|
| `ACTIVITYGROUP_ACTIVITYGROUP` | [`ACTIVITY`](../TNA/ACTIVITY.md) | `ACTIVITYGROUPCODE` | `ACTIVITY.ACTIVITYGROUPCODE = ACTIVITYGROUP.CODE` |
| `ACTIVITYGROUP_ACTIVITYGROUP` | [`TNAACTIVITYDETAIL`](../TNA/TNAACTIVITYDETAIL.md) | `ACTIVITYGROUPCODE` | `TNAACTIVITYDETAIL.ACTIVITYGROUPCODE = ACTIVITYGROUP.CODE` |

## Indexes

- `ACTIVITYGROUPUID` (ABSUNIQUEID)
