# DB2ADMIN.WRKACCOUNTTRANSACTION
...
- **Source**: `DB2ADMIN_DDL.sql` line 44513
...
| 4 | `DOCUMENTCOUNTERCODE` | CHAR(8) |  |  |  |  |
| 5 | `DOCUMENTCODE` | CHAR(15) |  |  |  |  |
| 6 | `ACCTRNHEADERTRANSACTIONNUMBER` | CHAR(15) |  |  |  |  |
...
| 8 | `DOCUMENTCOUNTERCOMPANYCODE` | CHAR(3) |  |  |  |  |
...
- `WRKACCOUNTTRANSACTIONUID` (ABSUNIQUEID)
...
SELECT t.CREATIONTIMESTAMP,
       ...
       t.LINE,
       t.COMPANYCODE,
       t.DOCUMENTCOUNTERCODE,
       t.DOCUMENTCODE,
       t.ACCTRNHEADERTRANSACTIONNUMBER,
       t.ABSUNIQUEID,
       t.DOCUMENTCOUNTERCOMPANYCODE
FROM   DB2ADMIN.WRKACCOUNTTRANSACTION t
