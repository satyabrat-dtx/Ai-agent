# DB2ADMIN.WRKBOMCOMPONENTCOLORSIZE
...
- **Source**: `DB2ADMIN_DDL.sql` line 193892
...
| 28 | `USERGENERICGROUPTYPECODE` | CHAR(10) |  |  |  |  |
| 29 | `COMPCOLORCODE` | CHAR(10) |  |  |  |  |
| 30 | `SIZECODE1` | CHAR(10) |  |  |  |  |
| 31 | `SIZEUGGROUPTYPECOMPANYCODE` | CHAR(3) |  |  |  |  |
| 32 | `SIZEUGGROUPTYPECODE` | CHAR(3) |  |  |  |  |
| 33 | `COMPSIZESIZESTYPECOMPANYCODE` | CHAR(3) |  |  |  |  |
| 34 | `COMPSIZECODE` | CHAR(10) |  |  |  |  |
| 35 | `CONSUMPTION` | DECIMAL(9,5) |  |  |  |  |
| 36 | `SKIPBOM` | SMALLINT | NOT NULL |  |  |  |
| 37 | `WASTAGE` | DECIMAL(11,2) |  |  |  |  |
...
- `WRKBOMCOMPONENTCOLORSIZEUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.WRKBOMCOMPONENTCOLORSIZE t
