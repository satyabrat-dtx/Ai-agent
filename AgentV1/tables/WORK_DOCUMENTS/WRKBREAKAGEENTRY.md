...
- **Source**: `DB2ADMIN_DDL.sql` line 130761
...
| 8 | `POSTINGDATE` | DATE | NOT NULL | PK | primary_key |  |
| 9 | `PLANTCOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
| 10 | `PLANTCODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
| 11 | `WORKCENTERCODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
| 12 | `PRODUCTIONORDERCODE` | CHAR(15) |  |  |  |  |
| 13 | `PRODUCTIONDEMANDCOUNTERCODE` | CHAR(8) |  |  |  |  |
| 14 | `PRODUCTIONDEMANDCODE` | CHAR(15) |  |  |  |  |
| 15 | `TEMPLATECODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
| 16 | `WSTCOUNT` | BIGINT | NOT NULL |  |  |  |
| 17 | `FSTCOUNT` | BIGINT | NOT NULL |  |  |  |
| 18 | `OSTCOUNT` | BIGINT | NOT NULL |  |  |  |
| 19 | `CREATIONUSER` | CHAR(50) | NOT NULL | PK | primary_key audit | User who created the row (audit). |
| 20 | `CREATIONTIMESTAMP` | BIGINT | NOT NULL | PK | primary_key audit |  |
| 21 | `REMOVE1` | INTEGER | NOT NULL |  |  |  |
...
| 23 | `TEMPLATECOMPANYCODE` | CHAR(3) | NOT NULL |  |  |  |
...
- `WRKBREAKAGEENTRYUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.PLANTCODE,
       t.WORKCENTERCODE
FROM   DB2ADMIN.WRKBREAKAGEENTRY t
