# DB2ADMIN.WRKERRORLOG

- **Module**: `WORK_DOCUMENTS` (medium confidence — table name starts with 'WRK')
- **Roles**: `business_data`
- **Columns**: 7
- **Primary key**: `COMPANYCODE`, `CREATIONTIMESTAMP`, `JOBID`, `SNO`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 169596
...
| 2 | `JOBID` | CHAR(4) | NOT NULL | PK | primary_key |  |
| 3 | `SNO` | INTEGER | NOT NULL | PK | primary_key |  |
| 4 | `ERRORAT` | CHAR(100) |  |  |  |  |
| 5 | `REMARKS` | VARCHAR(960) |  |  |  |  |
