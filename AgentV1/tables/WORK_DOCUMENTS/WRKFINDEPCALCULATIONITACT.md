# DB2ADMIN.WRKFINDEPCALCULATIONITACT
...
- **Source**: `DB2ADMIN_DDL.sql` line 230429

## Columns

| # | Column | Type | Null | Key | Tags | Meaning |
|---|--------|------|------|-----|------|---------|
| 0 | `LINENUMBER` | DECIMAL(7,0) | NOT NULL | PK | primary_key |  |
...
- `WRKFINDEPCALCULATIONITACTUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.WRKFINDEPCALCULATIONITACT t
