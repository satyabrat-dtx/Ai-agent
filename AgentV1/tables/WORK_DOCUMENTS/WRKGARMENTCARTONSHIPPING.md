# DB2ADMIN.WRKGARMENTCARTONSHIPPING

- **Module**: `WORK_DOCUMENTS` (medium confidence — table name starts with 'WRK')
- **Roles**: `business_data`
- **Columns**: 21
- **Primary key**: `COMPANYCODE`, `CREATIONTIMESTAMP`, `CARTONITEMTYPECODE`, `CARTONSUBCODE01`, `CARTONCODE`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 197242
...
| 3 | `CARTONCODE` | CHAR(15) | NOT NULL | PK | primary_key |  |
...
- `WRKGARMENTCARTONSHIPPINGUID` (ABSUNIQUEID)
...
SELECT t.CREATIONTIMESTAMP,
       ...
       t.CARTONQUANTITY
FROM   DB2ADMIN.WRKGARMENTCARTONSHIPPING t
