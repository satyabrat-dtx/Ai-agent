# DB2ADMIN.WRKGARMENTORDERPACKING
...
- **Source**: `DB2ADMIN_DDL.sql` line 221268
...
| 4 | `ORDPACKINGORDERLINE` | DECIMAL(7,0) | NOT NULL | PK | primary_key |  |
...
| 33 | `GROSSWEIGHT` | DECIMAL(15,5) |  |  |  |  |
| 34 | `WIDTH` | DECIMAL(7,2) |  |  |  |  |
| 35 | `FLAG` | CHAR(1) |  |  |  |  |
| 36 | `PACKEDCARTON` | INTEGER | NOT NULL |  |  |  |
| 37 | `PACKEDQTY` | INTEGER | NOT NULL |  |  |  |
| 38 | `PRIORITY` | DECIMAL(3,0) |  |  |  |  |
| 39 | `NETWEIGHTQTY` | DECIMAL(15,5) |  |  |  |  |
| 40 | `HEIGHT` | DECIMAL(7,2) |  |  |  |  |
| 41 | `TOBECREATED` | INTEGER | NOT NULL |  |  |  |
| 42 | `YOURREFERENCE` | VARCHAR(200) |  |  |  |  |
| 43 | `SELECTED` | INTEGER | NOT NULL |  |  |  |
...
| 48 | `PROGRAMMENAME` | INTEGER | NOT NULL |  |  |  |
...
SELECT t.CREATIONTIMESTAMP,
       ...
       t.SUBCODE01,
       t.SUBCODE02
FROM   DB2ADMIN.WRKGARMENTORDERPACKING t
