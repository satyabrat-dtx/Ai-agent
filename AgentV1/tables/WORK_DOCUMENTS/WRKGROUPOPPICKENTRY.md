...
- **Source**: `DB2ADMIN_DDL.sql` line 130960
...
- `WRKGROUPOPPICKENTRYUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.PLANTCOMPANYCODE,
       t.PLANTCODE
FROM   DB2ADMIN.WRKGROUPOPPICKENTRY t
