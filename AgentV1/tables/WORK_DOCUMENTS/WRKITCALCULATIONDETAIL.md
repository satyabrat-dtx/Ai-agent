# DB2ADMIN.WRKITCALCULATIONDETAIL
...
- **Source**: `DB2ADMIN_DDL.sql` line 170984
...
| 4 | `FINANCEMONTH` | CHAR(4) | NOT NULL |  |  |  |
...
- `WRKITCALCULATIONDETAILUID` (ABSUNIQUEID)
...
SELECT t.CREATIONUSER,
       ...
       t.CATEGORYCODE,
       t.SUBCATEGORYCODE
FROM   DB2ADMIN.WRKITCALCULATIONDETAIL t
