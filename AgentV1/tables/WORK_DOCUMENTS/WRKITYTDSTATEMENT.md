...
- **Source**: `DB2ADMIN_DDL.sql` line 171055
...
| 35 | `GROUPCODE` | CHAR(10) |  |  |  |  |
| 36 | `PAYELEMENTTYPE` | CHAR(1) |  |  |  |  |
| 37 | `LINENO` | INTEGER | NOT NULL | PK | primary_key |  |
...
- `WRKITYTDSTATEMENTUID` (ABSUNIQUEID)
...
SELECT t.CREATIONUSER,
       ...
       t.CATEGORYCODE,
       t.SUBCATEGORYCODE
FROM   DB2ADMIN.WRKITYTDSTATEMENT t
