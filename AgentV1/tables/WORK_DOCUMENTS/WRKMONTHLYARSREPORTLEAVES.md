# DB2ADMIN.WRKMONTHLYARSREPORTLEAVES

- **Module**: `WORK_DOCUMENTS` (medium confidence — table name starts with 'WRK')
- **Roles**: `business_data`
- **Columns**: 8
- **Primary key**: `CREATIONTIMESTAMP`, `COMPANYCODE`, `ATTENDANCEDATE`, `EMPLOYEECODE`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 163238
...
- `WRKMONTHLYARSREPORTLEAVESUID` (ABSUNIQUEID)
...
SELECT t.CREATIONTIMESTAMP,
       ...
       t.ATTENDANCEDATE,
       t.EMPLOYEECODE,
       t.COSTCENTERBADLICODE,
       t.SHIFTCODE,
       t.LEAVECODE,
       t.ABSUNIQUEID
FROM   DB2ADMIN.WRKMONTHLYARSREPORTLEAVES t
