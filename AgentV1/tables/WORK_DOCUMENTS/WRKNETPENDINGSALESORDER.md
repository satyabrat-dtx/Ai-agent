# DB2ADMIN.WRKNETPENDINGSALESORDER
...
- **Source**: `DB2ADMIN_DDL.sql` line 240381
...
| 4 | `CUSTOMERCODE` | CHAR(8) |  |  |  |  |
| 5 | `CUSTOMERNAME` | VARCHAR(270) |  |  |  |  |
| 6 | `ORDERDATE` | DATE |  |  |  |  |
...
| 25 | `SOLINEUSERPRIMARYQUANTITY` | DECIMAL(15,5) |  |  |  |  |
| 26 | `GROSSVALUEEXT` | DECIMAL(18,5) |  |  |  |  |
| 27 | `SHIPPEDQUANTITY` | DECIMAL(15,5) |  |  |  |  |
| 28 | `CLAIMQUANTITY` | DECIMAL(15,5) |  |  |  |  |
| 29 | `DELIVERYSALESORDERCODE` | CHAR(15) |  |  |  |  |
| 30 | `DELIVERYSALESORDERLINE` | DECIMAL(7,0) |  |  |  |  |
| 31 | `DELIVERYLINE` | DECIMAL(3,0) |  |  |  |  |
| 32 | `STATISTICALGRPCODE` | CHAR(6) |  |  |  |  |
| 33 | `SOPROGRESSSTATUS` | CHAR(2) |  |  |  |  |
| 34 | `SODELIVERYPROGRESSSTATUS` | CHAR(2) |  |  |  |  |
| 35 | `STATISTICALDESC` | VARCHAR(200) |  |  |  |  |
| 36 | `SOLINEITEMDESC` | VARCHAR(200) |  |  |  |  |
...
SELECT t.CREATIONTIMESTAMP,
       ...
       t.SUBCODE03,
       t.SUBCODE04
FROM   DB2ADMIN.WRKNETPENDINGSALESORDER t
