...
- **Source**: `DB2ADMIN_DDL.sql` line 201042
...
| 14 | `PARTYADDRESS` | VARCHAR(200) |  |  |  |  |
| 15 | `PARTYADDRESSBUYER` | VARCHAR(200) |  |  |  |  |
...
| 94 | `RATEFC` | DECIMAL(10,5) |  |  |  |  |
| 95 | `EXCHANGERATE` | DECIMAL(28,15) |  |  |  |  |
| 96 | `INRRATE` | DECIMAL(10,5) |  |  |  |  |
...
SELECT t.COMPANYCODE,
       ...
       t.LOCATIONGSTNO,
       t.CUSTOMERCODE
FROM   DB2ADMIN.WRKNETSALESINVOICE t
