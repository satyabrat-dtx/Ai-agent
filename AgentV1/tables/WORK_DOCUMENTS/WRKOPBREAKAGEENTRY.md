...
- **Source**: `DB2ADMIN_DDL.sql` line 131291
...
| 17 | `WSTCOUNT` | BIGINT | NOT NULL |  |  |  |
| 18 | `FSTCOUNT` | BIGINT | NOT NULL |  |  |  |
| 19 | `OSTCOUNT` | BIGINT | NOT NULL |  |  |  |
...
- `WRKOPBREAKAGEENTRYUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.PLANTCODE,
       t.WORKCENTERCODE
FROM   DB2ADMIN.WRKOPBREAKAGEENTRY t
