# DB2ADMIN.WRKPAYROLLPROCESSERROR

- **Module**: `WORK_DOCUMENTS` (medium confidence — table name starts with 'WRK')
- **Roles**: `business_data`
- **Columns**: 8
- **Primary key**: `COMPANYCODE`, `PAYROLLTYPECODE`, `PROCESSPERIOD`, `EMPLOYEECODE`, `SNO`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 169672
...
| 1 | `PAYROLLTYPECODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
| 2 | `PROCESSPERIOD` | INTEGER | NOT NULL | PK | primary_key |  |
| 3 | `EMPLOYEECODE` | CHAR(9) | NOT NULL | PK | primary_key |  |
| 4 | `SNO` | INTEGER | NOT NULL | PK | primary_key |  |
| 5 | `ERRORAT` | CHAR(100) |  |  |  |  |
| 6 | `REMARKS` | VARCHAR(250) |  |  |  |  |
...
- `WRKPAYROLLPROCESSERRORUID` (ABSUNIQUEID)
...
SELECT t.COMPANYCODE,
       ...
       t.REMARKS,
       t.ABSUNIQUEID
FROM   DB2ADMIN.WRKPAYROLLPROCESSERROR t
