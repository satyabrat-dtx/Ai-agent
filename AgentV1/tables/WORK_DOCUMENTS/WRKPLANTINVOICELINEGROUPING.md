# DB2ADMIN.WRKPLANTINVOICELINEGROUPING
...
- **Source**: `DB2ADMIN_DDL.sql` line 145313
...
| 58 | `PRIMUMDESC` | VARCHAR(200) |  |  |  |  |
| 59 | `PKGUMDESC` | VARCHAR(200) |  |  |  |  |
...
- `PLANTINVOICELINEGROUPINGUID` (ABSUNIQUEID)
...
SELECT t.CREATIONTIMESTAMP,
       ...
       t.SUBCODE5,
       t.SUBCODE6
FROM   DB2ADMIN.WRKPLANTINVOICELINEGROUPING t
