...
- **Source**: `DB2ADMIN_DDL.sql` line 22058
...
| 5 | `ORDERCOUNTERCODE` | CHAR(8) | NOT NULL |  |  |  |
| 6 | `ORDERCODE` | CHAR(15) | NOT NULL |  |  |  |
...
SELECT t.CREATIONTIMESTAMP,
       ...
       t.ORDERSUBLINE,
       t.ABSUNIQUEID
FROM   DB2ADMIN.WRKPRODRESERVATION t
