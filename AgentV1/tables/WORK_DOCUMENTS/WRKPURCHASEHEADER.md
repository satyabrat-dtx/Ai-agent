# DB2ADMIN.WRKPURCHASEHEADER

- **Module**: `WORK_DOCUMENTS` (medium confidence — table name starts with 'WRK')
- **Roles**: `business_data`
- **Columns**: 34
- **Primary key**: `CREATIONTIMESTAMP`, `LINE`, `PURCHASEORDERCOMPANYCODE`, `PURCHASEORDERCOUNTERCODE`, `PURCHASEORDERCODE`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 35178
...
| 3 | `PURCHASEORDERCOMPANYCODE` | CHAR(3) | NOT NULL | PK | primary_key |  |
| 4 | `PURCHASEORDERCOUNTERCODE` | CHAR(8) | NOT NULL | PK | primary_key |  |
| 5 | `PURCHASEORDERCODE` | CHAR(15) | NOT NULL | PK | primary_key |  |
...
| 10 | `ORDERPARTNERLEGALNAME1` | VARCHAR(200) | NOT NULL |  |  |  |
| 11 | `ORDERPARTNERLEGALNAME2` | VARCHAR(200) |  |  |  |  |
| 12 | `ORDERPARTNERADDRESSLINE1` | VARCHAR(200) | NOT NULL |  |  |  |
...
| 32 | `PAYMENTMETHODLONGDESCRIPTION` | VARCHAR(200) |  |  |  |  |
| 33 | `CURRENCYLONGDESCRIPTION` | VARCHAR(200) |  |  |  |  |
...
FROM   DB2ADMIN.WRKPURCHASEHEADER t
