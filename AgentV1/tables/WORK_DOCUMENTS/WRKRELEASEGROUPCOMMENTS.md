# DB2ADMIN.WRKRELEASEGROUPCOMMENTS

- **Module**: `WORK_DOCUMENTS` (medium confidence — table name starts with 'WRK')
- **Roles**: `business_data`
- **Columns**: 8
- **Primary key**: `CREATIONTIMESTAMP`, `SALESRELEASELINECOMPANYCODE`, `SALESRELEASELINECODE`, `LINEGROUP`, `ORIGIN`, `CODE`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 120481
...
SELECT t.CREATIONTIMESTAMP,
       ...
       t.COMMENTTEXT,
       t.COMMENTTYPE
FROM   DB2ADMIN.WRKRELEASEGROUPCOMMENTS t
