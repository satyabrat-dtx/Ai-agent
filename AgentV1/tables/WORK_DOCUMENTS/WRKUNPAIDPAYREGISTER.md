# DB2ADMIN.WRKUNPAIDPAYREGISTER

- **Module**: `WORK_DOCUMENTS` (medium confidence — table name starts with 'WRK')
- **Roles**: `business_data`
- **Columns**: 26
- **Primary key**: `COMPANYCODE`, `CREATIONTIMESTAMP`, `EMPLOYEEIDCODE`, `UNPAIDTYPEICSTABLECODE`, `UNPAIDTYPECODE`, `LINENO`
- **FK degree**: referenced by 0 constraint(s), references 0 constraint(s)
- **Source**: `DB2ADMIN_DDL.sql` line 164496
...
| 22 | `PAIDAMOUNT` | DECIMAL(17,2) |  |  |  |  |
| 23 | `PAIDDATE` | DATE |  |  |  |  |
| 24 | `LINENO` | BIGINT | NOT NULL | PK | primary_key |  |
...
- `WRKUNPAIDPAYREGISTERUID` (ABSUNIQUEID)
...
FROM   DB2ADMIN.WRKUNPAIDPAYREGISTER t
